...
function initial(){
	show_menu();
	$("option4").innerHTML = '<img style="margin-left:10px;" border="0" width="50px" height="50px" src="images/New_ui/icon_index_4.png"><div style="margin-top:-30px; margin-left:65px">USB Extension</div>';
...
<table width="760px" border="0" cellpadding="5" cellspacing="0" class="FormTitle" id="FormTitle">
	...
	<tr>
		  ...
		  <div>&nbsp;</div>
		  <div class="formfonttitle"><#menu5_4#> - <#menu5_4_3#>	
				<img onclick="go_setting('/APP_Installation.asp')" align="right" style="cursor:pointer;margin-right:10px;margin-top:-15px; *margin-top:-35px;" title="Back to USB Extension" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
			</div>
		  <div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
		  <div class="formfontdesc"><#USB_moredetail_desc#></div>
                        ...
                        <table width="98%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
                                ...
                                <tr>
                                        ...
                                        <td>
                                                <input type="text" name="computer_name" id="computer_name" class="input_15_table" maxlength="15" value="<% nvram_get("computer_name"); %>" onblur="valid_string_domain(this, 1)">
                                        </td>
                                </tr>
