...
{
	struct echo_info1 *object = (struct echo_info1 *)py_talloc_get_ptr(obj);
	PyObject *py_v;
...
{
	struct echo_info1 *object = (struct echo_info1 *)py_talloc_get_ptr(py_obj);
...
{
	return py_talloc_new(struct echo_info1, type);
}
...
static PyObject *py_echo_info1_ndr_pack(PyObject *py_obj)
{
	...
	err = ndr_push_struct_blob(&blob, py_talloc_get_mem_ctx(py_obj), object, (ndr_push_flags_fn_t)ndr_push_echo_info1);
...
static PyObject *py_echo_info1_ndr_unpack(PyObject *py_obj, PyObject *args)
{
	struct echo_info1 *object = (struct echo_info1 *)py_talloc_get_ptr(py_obj);
	DATA_BLOB blob;
	enum ndr_err_code err;
	...
	err = ndr_pull_struct_blob_all(&blob, py_talloc_get_mem_ctx(py_obj), object, (ndr_pull_flags_fn_t)ndr_pull_echo_info1);
	if (err != NDR_ERR_SUCCESS) {
		PyErr_SetNdrError(err);
		return NULL;
	}
...
static PyObject *py_echo_info1_ndr_print(PyObject *py_obj)
{
	...
	retstr = ndr_print_struct_string(py_talloc_get_mem_ctx(py_obj), (ndr_print_fn_t)ndr_print_echo_info1, "echo_info1", object);
...
static PyMethodDef py_echo_info1_methods[] = {
	...
	{ "__ndr_unpack__", (PyCFunction)py_echo_info1_ndr_unpack, METH_VARARGS, "S.ndr_unpack(class, blob) -> None\nNDR unpack" },
...
{
	struct echo_info2 *object = (struct echo_info2 *)py_talloc_get_ptr(obj);
	PyObject *py_v;
	py_v = PyInt_FromLong(object->v);
	return py_v;
}
...
{
	struct echo_info2 *object = (struct echo_info2 *)py_talloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyInt_Type, value, return -1;);
	object->v = PyInt_AsLong(value);
	return 0;
}
...
{
	return py_talloc_new(struct echo_info2, type);
}
...
{
	struct echo_info3 *object = (struct echo_info3 *)py_talloc_get_ptr(obj);
	PyObject *py_v;
	py_v = PyInt_FromLong(object->v);
	return py_v;
}
...
{
	struct echo_info3 *object = (struct echo_info3 *)py_talloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyInt_Type, value, return -1;);
	object->v = PyInt_AsLong(value);
	return 0;
}
...
{
	return py_talloc_new(struct echo_info3, type);
}
...
{
	struct echo_info4 *object = (struct echo_info4 *)py_talloc_get_ptr(obj);
	PyObject *py_v;
...
{
	struct echo_info4 *object = (struct echo_info4 *)py_talloc_get_ptr(py_obj);
...
{
	return py_talloc_new(struct echo_info4, type);
}
...
{
	struct echo_info5 *object = (struct echo_info5 *)py_talloc_get_ptr(obj);
	PyObject *py_v1;
...
{
	struct echo_info5 *object = (struct echo_info5 *)py_talloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyInt_Type, value, return -1;);
...
{
	return py_talloc_new(struct echo_info5, type);
}
...
{
	struct echo_info6 *object = (struct echo_info6 *)py_talloc_get_ptr(obj);
	PyObject *py_v1;
	py_v1 = PyInt_FromLong(object->v1);
	return py_v1;
}
...
{
	struct echo_info6 *object = (struct echo_info6 *)py_talloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyInt_Type, value, return -1;);
	object->v1 = PyInt_AsLong(value);
	return 0;
}
...
static PyObject *py_echo_info6_get_info1(PyObject *obj, void *closure)
{
	struct echo_info6 *object = (struct echo_info6 *)py_talloc_get_ptr(obj);
	PyObject *py_info1;
	py_info1 = py_talloc_reference_ex(&echo_info1_Type, py_talloc_get_mem_ctx(obj), &object->info1);
	return py_info1;
}
...
static int py_echo_info6_set_info1(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	object->info1 = *(struct echo_info1 *)py_talloc_get_ptr(value);
	return 0;
}
...
{
	return py_talloc_new(struct echo_info6, type);
}
...
{
	struct echo_info7 *object = (struct echo_info7 *)py_talloc_get_ptr(obj);
	PyObject *py_v1;
	py_v1 = PyInt_FromLong(object->v1);
	return py_v1;
}
...
{
	struct echo_info7 *object = (struct echo_info7 *)py_talloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyInt_Type, value, return -1;);
	object->v1 = PyInt_AsLong(value);
	return 0;
}
...
static PyObject *py_echo_info7_get_info4(PyObject *obj, void *closure)
{
	struct echo_info7 *object = (struct echo_info7 *)py_talloc_get_ptr(obj);
	PyObject *py_info4;
	py_info4 = py_talloc_reference_ex(&echo_info4_Type, py_talloc_get_mem_ctx(obj), &object->info4);
	return py_info4;
}
...
static int py_echo_info7_set_info4(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	object->info4 = *(struct echo_info4 *)py_talloc_get_ptr(value);
	return 0;
}
...
{
	return py_talloc_new(struct echo_info7, type);
}
...
PyObject *py_import_echo_Info(TALLOC_CTX *mem_ctx, int level, union echo_Info *in)
{
	...
	switch (level) {
		case 1:
			ret = py_talloc_reference_ex(&echo_info1_Type, mem_ctx, &in->info1);
			return ret;

		case 2:
			ret = py_talloc_reference_ex(&echo_info2_Type, mem_ctx, &in->info2);
			return ret;

		case 3:
			ret = py_talloc_reference_ex(&echo_info3_Type, mem_ctx, &in->info3);
			return ret;

		case 4:
			ret = py_talloc_reference_ex(&echo_info4_Type, mem_ctx, &in->info4);
			return ret;

		case 5:
			ret = py_talloc_reference_ex(&echo_info5_Type, mem_ctx, &in->info5);
			return ret;

		case 6:
			ret = py_talloc_reference_ex(&echo_info6_Type, mem_ctx, &in->info6);
			return ret;

		case 7:
			ret = py_talloc_reference_ex(&echo_info7_Type, mem_ctx, &in->info7);
			return ret;
...
union echo_Info *py_export_echo_Info(TALLOC_CTX *mem_ctx, int level, PyObject *in)
{
	...
	switch (level) {
		case 1:
			...
			ret->info1 = *(struct echo_info1 *)py_talloc_get_ptr(in);
			break;
		...
		case 2:
			...
			ret->info2 = *(struct echo_info2 *)py_talloc_get_ptr(in);
			break;
		...
		case 3:
			...
			ret->info3 = *(struct echo_info3 *)py_talloc_get_ptr(in);
			break;
		...
		case 4:
			...
			ret->info4 = *(struct echo_info4 *)py_talloc_get_ptr(in);
			break;
		...
		case 5:
			...
			ret->info5 = *(struct echo_info5 *)py_talloc_get_ptr(in);
			break;
		...
		case 6:
			...
			ret->info6 = *(struct echo_info6 *)py_talloc_get_ptr(in);
			break;
		...
		case 7:
			...
			ret->info7 = *(struct echo_info7 *)py_talloc_get_ptr(in);
			break;
...
{
	struct echo_Enum2 *object = (struct echo_Enum2 *)py_talloc_get_ptr(obj);
	PyObject *py_e1;
...
{
	struct echo_Enum2 *object = (struct echo_Enum2 *)py_talloc_get_ptr(py_obj);
	if (PyLong_Check(value)) {
...
{
	return py_talloc_new(struct echo_Enum2, type);
}
...
PyObject *py_import_echo_Enum3(TALLOC_CTX *mem_ctx, int level, union echo_Enum3 *in)
{
	...
	switch (level) {
		...
		case ECHO_ENUM2:
			ret = py_talloc_reference_ex(&echo_Enum2_Type, mem_ctx, &in->e2);
			return ret;
...
union echo_Enum3 *py_export_echo_Enum3(TALLOC_CTX *mem_ctx, int level, PyObject *in)
{
	...
	switch (level) {
		...
		case ECHO_ENUM2:
			...
			ret->e2 = *(struct echo_Enum2 *)py_talloc_get_ptr(in);
			break;
...
{
	struct echo_Surrounding *object = (struct echo_Surrounding *)py_talloc_get_ptr(obj);
	PyObject *py_x;
...
{
	struct echo_Surrounding *object = (struct echo_Surrounding *)py_talloc_get_ptr(py_obj);
	PY_CHECK_TYPE(&PyInt_Type, value, return -1;);
...
static int py_echo_Surrounding_set_surrounding(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	{
		int surrounding_cntr_0;
		object->surrounding = talloc_array_ptrtype(py_talloc_get_mem_ctx(py_obj), object->surrounding, PyList_GET_SIZE(value));
...
{
	return py_talloc_new(struct echo_Surrounding, type);
}
...
static bool pack_py_echo_TestEnum_args_in(PyObject *args, PyObject *kwargs, struct echo_TestEnum *r)
{
	...
	if (talloc_reference(r, py_talloc_get_mem_ctx(py_foo2)) == NULL) {
		PyErr_NoMemory();
		return false;
	}
	r->in.foo2 = (struct echo_Enum2 *)py_talloc_get_ptr(py_foo2);
...
static PyObject *unpack_py_echo_TestEnum_args_out(struct echo_TestEnum *r)
{
	...
	py_foo2 = py_talloc_reference_ex(&echo_Enum2_Type, r->out.foo2, r->out.foo2);
...
static bool pack_py_echo_TestSurrounding_args_in(PyObject *args, PyObject *kwargs, struct echo_TestSurrounding *r)
{
	...
	if (talloc_reference(r, py_talloc_get_mem_ctx(py_data)) == NULL) {
		PyErr_NoMemory();
		return false;
	}
	r->in.data = (struct echo_Surrounding *)py_talloc_get_ptr(py_data);
	return true;
}
...
static PyObject *unpack_py_echo_TestSurrounding_args_out(struct echo_TestSurrounding *r)
{
	PyObject *result;
	PyObject *py_data;
	py_data = py_talloc_reference_ex(&echo_Surrounding_Type, r->out.data, r->out.data);
	result = py_data;
	return result;
}
