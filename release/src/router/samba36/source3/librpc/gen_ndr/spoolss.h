...
struct spoolss_PrinterInfo2 {
	...
	struct spoolss_DeviceMode *devmode;/* [flag(LIBNDR_FLAG_ALIGN4),subcontext(0),relative] */
...
struct spoolss_DevmodeContainer {
	...
	struct spoolss_DeviceMode *devmode;/* [subcontext(4),unique,subcontext_size(_ndr_size)] */
};
...
}/* [relative_base,nodiscriminant,public,flag(LIBNDR_FLAG_RELATIVE_REVERSE),gensize] */;
...
}/* [public,flag(LIBNDR_FLAG_RELATIVE_REVERSE),gensize,relative_base,nodiscriminant] */;
...
}/* [gensize,flag(LIBNDR_FLAG_RELATIVE_REVERSE),public,nodiscriminant,relative_base] */;
...
}/* [flag(LIBNDR_FLAG_RELATIVE_REVERSE),gensize,public,relative_base,nodiscriminant] */;
...
}/* [public,flag(LIBNDR_FLAG_RELATIVE_REVERSE),nodiscriminant,relative_base] */;
...
}/* [flag(LIBNDR_FLAG_RELATIVE_REVERSE),public,nodiscriminant,relative_base] */;
...
struct spoolss_NotifyOptionType {
	...
	uint32_t u3;
	uint32_t count;
	union spoolss_Field *fields;/* [size_is(count),unique,switch_is(type)] */
};
...
struct spoolss_NotifyString {
	uint32_t size;
	const char *string;/* [unique,size_is(size/2),charset(UTF16)] */
};
...
struct spoolss_PrinterEnumValues {
	...
	DATA_BLOB *data;/* [subcontext_size(data_length),relative,subcontext(0),flag(LIBNDR_FLAG_REMAINING|ndr_spoolss_PrinterEnumValues_align(r->type))] */
...
struct spoolss_GetJob {
	...
	struct {
		union spoolss_JobInfo *info;/* [subcontext(4),unique,switch_is(level),subcontext_size(offered)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinter {
	...
	struct {
		union spoolss_PrinterInfo *info;/* [unique,switch_is(level),subcontext_size(offered),subcontext(4)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriverDirectory {
	...
	struct {
		union spoolss_DriverDirectoryInfo *info;/* [subcontext_size(offered),switch_is(level),unique,subcontext(4)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrintProcessorDirectory {
	...
	struct {
		union spoolss_PrintProcessorDirectoryInfo *info;/* [subcontext_size(offered),switch_is(level),unique,subcontext(4)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetForm {
	...
	struct {
		union spoolss_FormInfo *info;/* [subcontext_size(offered),switch_is(level),unique,subcontext(4)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumPorts {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_PortInfo **info;/* [switch_is(level),size_is(,*count),ref] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumPrintProcDataTypes {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_PrintProcDataTypesInfo **info;/* [size_is(,*count),switch_is(level),ref] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriver2 {
	...
	struct {
		union spoolss_DriverInfo *info;/* [subcontext_size(offered),switch_is(level),unique,subcontext(4)] */
		uint32_t *needed;/* [ref] */
...
struct spoolss_EnumPrinterData {
	...
	struct {
		...
		enum winreg_Type *type;/* [ref] */
		uint8_t *data;/* [size_is(data_offered),ref,flag(LIBNDR_PRINT_ARRAY_HEX)] */
...
struct spoolss_EnumPrinterKey {
	...
	struct {
		...
		union spoolss_KeyNames *key_buffer;/* [subcontext_size(*_ndr_size*2),switch_is(*_ndr_size),ref,subcontext(0)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriverPackagePath {
	struct {
		...
		const char *driver_package_cab;/* [size_is(driver_package_cab_size),charset(UTF16),unique] */
	} in;
