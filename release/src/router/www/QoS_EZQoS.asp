...
function validForm(){
	...
	if(document.form.qos_enable.value == 1){
		if(document.form.qos_type.value != 2){	//not Bandwidth Limiter
			...
			if( ((document.form.qos_type.value == 1 && document.form.bw_setting_name[1].checked == true ) || document.form.qos_type.value == 0) && !validator.rangeFloat(document.form.obw, 0, 9999999999, 1)){
				return false;
			}
			...
			if( ((document.form.qos_type.value == 1 && document.form.bw_setting_name[1].checked == true ) || document.form.qos_type.value == 0) && !validator.rangeFloat(document.form.ibw, 0, 9999999999, 1)){
				return false;
			}
