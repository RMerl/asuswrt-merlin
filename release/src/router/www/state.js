...
tabtitle[5] = new Array("", "<#BOP_isp_heart_item#>", "<#vpn_Adv#>", "OpenVPN Server Settings", "OpenVPN Server Keys.asp", "OpenVPN Client Settings", "OpenVPN Client Keys", "VPN Status");
...
tablink[5] = new Array("", "Advanced_PPTP_Content.asp", "Advanced_PPTPAdvanced_Content.asp", "Advanced_OpenVPNServer_Content.asp", "Advanced_OpenVPNServer_Keys.asp", "Advanced_OpenVPNClient_Content.asp", "Advanced_OpenVPNClient_Keys", "Advanced_VPNStatus.asp");
