...
tabtitle[5] = new Array("", "<#BOP_isp_heart_item#>", "<#vpn_Adv#>", "OpenVPN Client Settings", "OpenVPN Keys", "VPN Client", "VPN Status");
...
tablink[5] = new Array("", "Advanced_VPN_Content.asp", "Advanced_VPNAdvanced_Content.asp",  "Advanced_OpenVPNClient_Content.asp", "Advanced_OpenVPN_Keys.asp", "Advanced_VPNClient_Content.asp", "Advanced_VPNStatus.asp" , "Main_Ping_Content.asp", "Main_Netstat_Content.asp", "Main_Traceroute_Content.asp");
