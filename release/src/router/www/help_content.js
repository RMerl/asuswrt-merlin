...
helpcontent[50] = new Array("",
				...
				"The JFFS partition is a portion of the router flash memory which contains data such as OpenVPN key/cers and user created scripts.  It's strongly recommended to keep a backup of it before updating your firmware.",
				"Disabled: Actively block the port used by the protocol<br>Enabled: Allow NAT traffic through the protocol's port<br>Enabled+NAT Helper: Allow NAT traffic, and use a Netfilter module to help handle NAT forwarding for that protocol's traffic");
