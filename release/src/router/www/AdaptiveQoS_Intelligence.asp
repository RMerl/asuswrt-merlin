...
var category_title = ["", "Games", "Streaming Media","Online Chat & Communication", "Web Surfing","File Transfer", "Others"];					 
...
<input type="hidden" name="current_page" value="/AdaptiveQoS_Intelligence.asp">
<input type="hidden" name="next_page" value="/AdaptiveQoS_Intelligence.asp">
