            ...
            <table width="760px" border="0" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTitle" id="FormTitle">
				...
				<table width="100%" id="page3" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
					...
					<tr>
						<th>Static Key</th>
						<td>
							<textarea rows="8" class="textarea_ssh_table" name="vpn_crt_server1_static" cols="65" maxlength="4096"><% nvram_get("vpn_crt_server1_static"); %></textarea>
						</td>
					</tr>
					<tr>
						<th>Certificate Authority</th>
						<td>
							<textarea rows="8" class="textarea_ssh_table" name="vpn_crt_server1_ca" cols="65" maxlength="4096"><% nvram_get("vpn_crt_server1_ca"); %></textarea>
						</td>
					</tr>
					<tr>
						<th>Server Certificate</th>
						<td>
							<textarea rows="8" class="textarea_ssh_table" name="vpn_crt_server1_crt" cols="65" maxlength="4096"><% nvram_get("vpn_crt_server1_crt"); %></textarea>
						</td>
					</tr>
					<tr>
						<th>Server Key</th>
						<td>
							<textarea rows="8" class="textarea_ssh_table" name="vpn_crt_server1_key" cols="65" maxlength="4096"><% nvram_get("vpn_crt_server1_key"); %></textarea>
						</td>
					</tr>
					<tr>
						<th>Diffie Hellman parameters</th>
						<td>
							<textarea rows="8" class="textarea_ssh_table" name="vpn_crt_server1_dh" cols="65" maxlength="4096"><% nvram_get("vpn_crt_server1_dh"); %></textarea>
						</td>
					</tr>
				</table>
				...
				<table width="100%" id="page4" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
					...
					<tr>
						<th>Static Key</th>
						<td>
							<textarea rows="8" class="textarea_ssh_table" name="vpn_crt_server2_static" cols="65" maxlength="4096"><% nvram_get("vpn_crt_server2_static"); %></textarea>
						</td>
					</tr>
					<tr>
						<th>Certificate Authority</th>
						<td>
							<textarea rows="8" class="textarea_ssh_table" name="vpn_crt_server2_ca" cols="65" maxlength="4096"><% nvram_get("vpn_crt_server2_ca"); %></textarea>
						</td>
					</tr>
					<tr>
						<th>Server Certificate</th>
						<td>
							<textarea rows="8" class="textarea_ssh_table" name="vpn_crt_server2_crt" cols="65" maxlength="4096"><% nvram_get("vpn_crt_server2_crt"); %></textarea>
						</td>
					</tr>
					<tr>
						<th>Server Key</th>
						<td>
							<textarea rows="8" class="textarea_ssh_table" name="vpn_crt_server2_key" cols="65" maxlength="4096"><% nvram_get("vpn_crt_server2_key"); %></textarea>
						</td>
					</tr>
					<tr>
						<th>Diffie Hellman parameters</th>
