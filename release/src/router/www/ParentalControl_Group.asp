...
<input type="hidden" name="current_page" value="ParentalControl_Group.asp">
		...
		<div>
			<table width="730px">
				<tr>
					...
					<td>
						<img onclick="go_setting('/Home_Security.asp')" align="right" style="cursor:pointer;position:absolute;margin-left:-20px;margin-top:-30px;" title="AiProtection" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
					</td>
				</tr>
			</table>
		</div>
