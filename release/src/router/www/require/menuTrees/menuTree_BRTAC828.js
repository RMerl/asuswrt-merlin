		...
		list: [
			...
			*/
			...
			},
			{
				...
				index: "menu_Index",
				tab: [
					{url: "index.asp", tabName: "__HIDE__"},
					{url: "NULL", tabName: "__INHERIT__"}
				]
			}, 
			{
				menuName: "<#Permission_Management#>",
				index: "menu_PermissionManagement",
				tab: [
					{url: "PermissionManagement_Users.asp", tabName: "<#Permission_Management_Users#>"},
					{url: "PermissionManagement_UserGroups.asp", tabName: "<#Permission_Management_Groups#>"},
					{url: "PermissionManagement_Devices.asp", tabName: "<#Permission_Management_Devices#>"},
					{url: "PermissionManagement_DeviceGroups.asp", tabName: "<#Permission_Management_DGroups#>"},
					{url: "PermissionManagement_RADIUS.asp", tabName: "<#Permission_Management_RADIUS#>"},
					{url: "NULL", tabName: "__INHERIT__"}
				] 
			},
			{
				menuName: "<#Access_Control_title#>",
				index: "menu_AccessControl", 
				tab: [
					//{url: "AiProtection_WebProtector.asp", tabName: "__HIDE__"},
			...
			},
			{
				...
				tab: [
					{url: "AiProtection_HomeProtection.asp", tabName: "<#AiProtection_title#>"},
			...
			{
				menuName: "3G / 4G dongle",
				index: "menu_WAN",
				tab: [
					{url: "Advanced_Modem_Content.asp", tabName: "__HIDE__"},
					{url: "Advanced_MobileBroadband_Content.asp", tabName: "__HIDE__"},
					{url: "NULL", tabName: "__INHERIT__"}
				] 
			},
			{
			...
			},
			{
				...
				index: "menu_VLAN",
				tab: [
					{url: "Advanced_TagBasedVLAN_Content.asp", tabName: "VLAN"},
					{url: "NULL", tabName: "__INHERIT__"}
				]
			},
			{
				menuName: "<#File_Sharing#>",
				index: "menu_APP",
				tab: [
