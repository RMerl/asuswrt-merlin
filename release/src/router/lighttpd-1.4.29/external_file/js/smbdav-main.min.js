...
function openLoginWindow(a){var b=$("div#modalWindow"),c=b.css("display"),e=function(){var e=$("#table_login input#username").val(),b=$("#table_login input#password").val(),e="Basic "+Base64.encode(e+":"+b);closeJqmWindow(0);doLOGIN(a,e)};g_modal_url="";g_modal_window_width=380;g_modal_window_height=120;if(a=="/")$("#jqmTitleText").text(m.getString("title_login")+" - AiCloud");else{var f=mydecodeURI(a);$("#jqmTitleText").text(m.getString("title_login")+" - "+f.substring(0,35))}c=="block"&&$("#jqmMsgText").text(m.getString("msg_passerror"));
$("#jqmMsg").css("display",c);c="";c+='<table id="table_login" width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="overflow:hidden;table-layout: fixed;">';c+="<tr>";c+="<td>";c+='<div id="main">';c+="<table>";c+="<tr>";c+='<td><label id="username">'+m.getString("title_username")+'</label></td><td><input name="username" class="dialog_text_input" type="text" id="username" autocapitalize="off" maxlength="20" style="width:290px"></td>';c+="</tr>";c+="<tr>";c+='<td><label id="password">'+
m.getString("title_password")+'</label></td><td><input name="password" class="dialog_text_input" type="password" id="password" maxlength="16" style="width:290px"></td>';c+="</tr>";c+="</table>";c+="</div>";c+="</td>";c+="</tr>";c+='<tr style="height:10px"></tr>';c+="<tr>";c+="<td>";c+='<div class="table_block_footer" style="text-align:right">';c+='<button id="ok" class="btnStyle">'+m.getString("btn_ok")+"</button>";c+='<button id="cancel" class="btnStyle">'+m.getString("btn_cancel")+"</button>";c+=
"</div>";c+="</td>";c+="</tr>";c+="</table>";$("#jqmContent").empty();$(c).appendTo($("#jqmContent"));$("#table_login input#password").keydown(function(a){a.keyCode==13&&e()});$("#table_login #ok").click(function(){e()});$("#table_login #cancel").click(function(){closeJqmWindow(0)});b&&b.jqmShow()}
...
function doRENAME(a,b,c){var e=0,f=addPathSlash(g_storage.get("openurl")),j=f+b;$(".wcb").each(function(){b==myencodeURI($(this).attr("data-name"))&&(e=1,$(this).attr("isdir")=="1"?alert(m.getString("folder_already_exist_msg")):alert(m.getString("file_already_exist_msg")))});e==1?c&&c():g_webdav_client.LOCK(a,"",function(e,b,g){if(e!="201")alert(m.getString("msg_already_lock")),c&&c();else{var n=getLockToken(g);g_webdav_client.MOVE(a,j,function(e){e[0]==2?(doPROPFIND(f),closeJqmWindow(0)):(alert(m.getString(e)),
c&&c());g_webdav_client.UNLOCK(a,n,function(a){a!=204&&alert("Unlock error: "+a);c&&c()})},null,!1,n)}},null)}
function doCOPYMOVE(a,b,c,e,f){g_webdav_client.LOCK(b,"",function(j,d,h){if(j!="201")alert(m.getString("msg_already_lock")),f&&f(j);else{var g=getLockToken(h);a=="copy"?g_webdav_client.COPY(b,c,function(a){g_webdav_client.UNLOCK(b,g,function(a){a!=204&&alert("Unlock error: "+a)});f&&f(a)},null,e==!0?"T":"F",g):a=="move"?g_webdav_client.MOVE(b,c,function(a){g_webdav_client.UNLOCK(b,g,function(a){a!=204&&alert("Unlock error: "+a)});f&&f(a)},null,e==!0?"T":"F",g):alert("Invalid action specified!")}},
null)}function getFileViewHeight(){return $("#fileview").height()-20}function closeJqmWindow(a){g_reload_page=a;a=$("div#modalWindow");$("iframe",a).attr("src","");a&&a.jqmHide();showHideLoadStatus(!1)}function resizeJqmWindow(a,b){var c=$(".jqmWindow");c&&(c.css("width",a+"px"),c.css("height",b+"px"))}function fullscreenJqmWindow(){var a=$("div#modalWindow");a&&(a.css("left","0px"),a.css("top","0px"),a.css("width",window.width+"px"),a.css("height",window.height+"px"))}
function doLOGOUT(){doPROPFIND("/",function(){addPathSlash(g_storage.get("openurl"));g_webdav_client.LOGOUT("/",function(a){a[0]==2&&(g_storage.set("openhostuid","0"),window.location.reload())})},0)}function resetTimer(){clearInterval(timer_idle);g_time_count=0;timer_idle=setInterval(function(){g_storage.get("stopLogoutTimer")=="1"||g_show_modal==1?g_time_count=0:(g_time_count++,g_time_count*1E3>g_time_out&&(g_time_count=0,doLOGOUT()))},1E3)}
function doPROPFINDMEDIALIST(a,b,c,e,f,j,d,h,g,n){if(g_webdav_client!=null){showHideLoadStatus(!0);showHideEditUIRegion(!1);try{g_webdav_client.PROPFINDMEDIALIST(a,function(f,j,o){if(f){if(f==207){showHideSelectModeUI(!1);closeUploadPanel();var n=content2XMLDOM(o),o=1,k=f=0,j="Idle";b||(g_folder_array=null,g_folder_array=[],g_file_array=null,g_file_array=[]);n&&(o=1,f=parseInt(n.documentElement.getAttribute("qcount")),parseInt(n.documentElement.getAttribute("qstart")),k=parseInt(n.documentElement.getAttribute("qend")),
j=n.documentElement.getAttribute("scan_status"),parserPropfindXML(n,a,b));n="";g_ui_mode.get()==1||g_ui_mode.get()==2||g_ui_mode.get()==3?o=0:g_ui_mode.get()==6?(o=0,n="goto:music_album"):g_ui_mode.get()==7&&(o=0,n="goto:music_artist");var l=g_list_view.get()==1?"listview":"thumbview";create_ui_view(l,$("#main_right_container #fileview"),o,n,g_folder_array,g_file_array,onMouseDownListDIVHandler);f>k&&(o=k+1,k=o+50,k>f&&(k=f),n="<div class='nextDiv' start='"+o+"' end='"+k+"'><span>",l=m.getString("title_next_query"),
l=l.replace("%s",o+"-"+k),l=l.replace("%s",f),n+=l,n+="</span></div>",$("#main_right_container #fileview").append(n),$(".nextDiv").click(function(){doPROPFINDMEDIALIST(a,!0,null,e,$(this).attr("start"),$(this).attr("end"),d,h,g)}));j=="Scanning"?($("#main_right_container #hintbar").text(m.getString("msg_dms_scanning")),$("#main_right_container #hintbar").show()):$("#main_right_container #hintbar").hide();g_storage.set("aimode",e);$("div#btnUpload").css("display","none");$("div#btnNewDir").css("display",
...
f==401?setTimeout(function(){openLoginWindow(a)},2E3):alert(m.getString(f));showHideLoadStatus(!1)}},null,e,f,j,d,h,g,n),resetTimer()}catch(o){alert("catch error: "+o)}}}
function parserPropfindXML(a,b,c){if(a){c==!1&&(g_file_array=g_folder_array=null);g_folder_array==null&&(g_folder_array=[]);g_file_array==null&&(g_file_array=[]);for(var e,f,j,d=a.documentElement.childNodes,a=0;a<d.length;a++){var h="",g="",n="",o="",r="",w="",y="",s="",k="",l="",u="",z="",v="",t;j="";for(var x="0",B="",C="0",D=d[a].childNodes,c=0;c<D.length;c++)if(D[c].nodeType==1&&D[c].nodeName=="D:propstat"){var q=D[c].childNodes;for(e=0;e<q.length;e++)if(q[e].nodeName=="D:prop"){var p=q[e].childNodes;
for(f=0;f<p.length;f++)if(!(p[f].childNodes.length<=0))if(p[f].nodeName=="D:getcontenttype")g=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getuniqueid")n=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getonline")w=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getlastmodified")y=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getcontentlength")s=String(size_format(parseInt(p[f].childNodes[0].nodeValue)));else if(p[f].nodeName=="D:getmac")l=
String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getip")k=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:gettype")u=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getattr"){var E=p[f].childNodes;for(j=0;j<E.length;j++)if(E[j].nodeName=="D:readonly")z=E[j].childNodes[0].nodeValue;else if(E[j].nodeName=="D:hidden")v=E[j].childNodes[0].nodeValue}else if(p[f].nodeName=="D:getuseragent")j=String(p[f].childNodes[0].nodeValue),g_storage.set("user_agent",j);else if(p[f].nodeName==
"D:getroutersync")x=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getmetadata"){E=p[f].childNodes;for(j=0;j<E.length;j++)if(E[j].nodeName=="D:title")B=E[j].childNodes[0].nodeValue;else if(E[j].nodeName=="D:thumb")C=E[j].childNodes[0].nodeValue}}}else D[c].nodeType==1&&D[c].nodeName=="D:href"&&(h=String(D[c].childNodes[0].nodeValue),e="",h.match(/^http/)&&(e=window.location.protocol+"//"+window.location.host),f=e+addPathSlash(b),h!=f?(h=h.replace(e,""),o=h.substring(h.lastIndexOf("/")+
1,h.length),o!=""?(t=o,r=o=mydecodeURI(o)):h=""):h="");h!=""&&(g=="httpd/unix-directory"?g_folder_array.push({contenttype:g,href:h,name:o,uname:t,shortname:r,online:w,time:y,size:s,ip:k,mac:l,uid:n,type:u,freadonly:z,fhidden:v,routersyncfolder:x,matadatatitle:B,thumb:C}):g_file_array.push({contenttype:g,href:h,name:o,uname:t,shortname:r,online:w,time:y,size:s,ip:k,mac:l,uid:n,type:u,freadonly:z,fhidden:v,routersyncfolder:x,matadatatitle:B,thumb:C}))}}}
...
function doPROPFIND(a,b,c){if(g_webdav_client!=null){showHideLoadStatus(!0);try{g_webdav_client.PROPFIND(a,c,function(e,c,d){if(e){if(e==207){showHideSelectModeUI(!1);closeUploadPanel();var h=content2XMLDOM(d);if(h){e=h.documentElement.getAttribute("qtype");h.documentElement.getAttribute("readonly");c=h.documentElement.getAttribute("ruser");h.documentElement.getAttribute("computername");d=h.documentElement.getAttribute("isusb");parserPropfindXML(h,a,!1);g_folder_array.sort(sortByName);g_file_array.sort(sortByName);
for(h=0;h<g_folder_array.length;h++)g_folder_array[h].type=="usbdisk"&&arraymove(g_folder_array,h,0);h=addPathSlash(a);h!="/"&&(h=h.substring(0,h.length-1),h=h.substring(0,h.lastIndexOf("/")),h==""&&(h="/"));a=="/"&&createHostList(e,g_folder_array);var g=g_list_view.get()==1?"listview":"thumbview";create_ui_view(g,$("#main_right_container #fileview"),e,h,g_folder_array,g_file_array,onMouseDownListDIVHandler);g_thumb_loader.init($("#main_right_container #fileview"));g_thumb_loader.start();showHideAiButton(d==
...
g_upload_mode==1?"block":"none");$("#btnChangeUser").css("display",e==1&&d==0?"block":"none");a=="/"&&$("span#username").text(c);g_storage.set("isAidisk",d);g_storage.set("openurl",a);$("div#hostview").scrollTop(g_storage.get("hostviewscrollTop"));$("div#fileview").scrollLeft(g_storage.get("contentscrollLeft"));$("div#fileview").scrollTop(g_storage.get("contentscrollTop"));$("#main_right_container #hintbar").hide();adjustLayout();closeJqmWindow(0);b!=void 0&&b();if(g_storage.get("openhostuid")==void 0||
g_storage.get("openhostuid")==0)e="<div id='help_1'>",e+="<div id='help_content'>",e+=m.getString("msg_help"),e+="</div>",e+="<div id='help_image'>",e+="</div>",e+="</div>",$("div#fileview").append(e)}}else e==501?doPROPFIND(a):e==401?setTimeout(function(){openLoginWindow(a)},2E3):alert(m.getString(e));showHideLoadStatus(!1)}},null,1),resetTimer()}catch(e){alert("catch error: "+e)}}}
...
function refreshHostList(){if(g_webdav_client!=null)try{g_webdav_client.PROPFIND("/",null,function(a,c,e){if(a&&a==207){var f,a=[];if(window.DOMParser)c=new DOMParser,f=c.parseFromString(e,"text/xml");else if(f=new ActiveXObject("Microsoft.XMLDOM"),f.async="false",f.loadXML(e),!f.documentElement){alert("Fail to load xml!");showHideLoadStatus(!1);return}var j,d,h,g,c=f.documentElement.childNodes,e=f.documentElement.getAttribute("qtype");f.documentElement.getAttribute("readonly");f.documentElement.getAttribute("ruser");
f.documentElement.getAttribute("computername");f.documentElement.getAttribute("isusb");for(f=0;f<c.length;f++){var n="",o="",r="",w="",y="",s="",k="",l="",u="",z="",v="",t="",x="",B,C=c[f].childNodes;for(j=0;j<C.length;j++)if(C[j].nodeType==1&&C[j].nodeName=="D:propstat"){var D=C[j].childNodes;for(d=0;d<D.length;d++)if(D[d].nodeName=="D:prop"){var q=D[d].childNodes;for(h=0;h<q.length;h++)if(!(q[h].childNodes.length<=0))if(q[h].nodeName=="D:getcontenttype")o=String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName==
"D:getuniqueid")r=String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName=="D:getonline")s=String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName=="D:getlastmodified")k=String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName=="D:getcontentlength")l=String(size_format(parseInt(q[h].childNodes[0].nodeValue)));else if(q[h].nodeName=="D:getmac")z=String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName=="D:getip")u=String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName=="D:gettype")v=
String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName=="D:getattr"){var p=q[h].childNodes;for(g=0;g<p.length;g++)if(p[g].nodeName=="D:readonly")t=p[g].childNodes[0].nodeValue;else if(p[g].nodeName=="D:hidden")x=p[g].childNodes[0].nodeValue}}}else C[j].nodeType==1&&C[j].nodeName=="D:href"&&(n=String(C[j].childNodes[0].nodeValue),d="",n.match(/^http/)&&(d=window.location.protocol+"//"+window.location.host),h=d+addPathSlash("/"),n!=h?(n=n.replace(d,""),w=n.substring(n.lastIndexOf("/")+1,n.length),
w!=""?(B=w,y=w=mydecodeURI(w),d=g_list_view.get()==0?12:45,y.length>d&&(y=y.substring(0,d)+"...")):n=""):n="");n!=""&&o=="httpd/unix-directory"&&a.push({contenttype:o,href:n,name:w,uname:B,shortname:y,online:s,time:k,size:l,ip:u,mac:z,uid:r,type:v,freadonly:t,fhidden:x})}a.sort(sortByName);for(B=0;B<a.length;B++)a[B].type=="usbdisk"&&arraymove(a,B,0);createHostList(e,a)}},null,1)}catch(a){alert("catch error: "+a)}}
...
function openSelItem(a){var b=a.attr("uhref")==void 0?"":a.attr("uhref"),c=a.attr("qtype")==void 0?0:a.attr("qtype"),e=a.attr("isdir")==void 0?0:a.attr("isdir"),f=a.attr("isusb")==void 0?0:a.attr("isusb"),j=b,d=a.attr("data-name")==void 0?"":a.attr("data-name");g_storage.set("opentype",f);if(b=="goto:music_album")g_webdav_client!=null&&(showHideLoadStatus(!0),b=g_storage.get("openurl")==void 0?"/":g_storage.get("openurl"),g_webdav_client.GETMUSICCLASSIFICATION(b,"album",function(a,e,b){a==200?createClassificationView(b,
"album"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)}));else if(b=="goto:music_artist")g_webdav_client!=null&&(showHideLoadStatus(!0),b=g_storage.get("openurl")==void 0?"/":g_storage.get("openurl"),g_webdav_client.GETMUSICCLASSIFICATION(b,"artist",function(a,e,b){a==200?createClassificationView(b,"artist"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)}));else if(c==2&&a.attr("online")==0)confirm(m.getString("wol_msg"))==!0&&(b=a.attr("mac"),g_webdav_client.WOL("/",b,function(a){a==
200?alert(m.getString("wol_ok_msg")):alert(m.getString("wol_fail_msg"))}));else if(e=="1")doPROPFIND(b,null,null);else{c=getFileExt(b);e=g_storage.get("webdav_mode");if(c=="mp4"||c=="m4v"||c=="wmv"||c=="avi"||c=="rmvb"||c=="rm"||c=="mpg"||c=="mpeg"||c=="mkv"||c=="mov"||c=="flv")if((e==0||e==2)&&isWinOS()){if(isIE()&&getInternetExplorerVersion()<=8)alert(m.getString("msg_vlcsupport"));else{var h=$("div#modalWindow"),d=myencodeURI(d);this_url=j.substring(0,j.lastIndexOf("/"));var g=window.location.host;
g.indexOf(":")!=-1&&(g=g.substring(0,g.indexOf(":")));var g="http://"+g+":"+g_storage.get("http_port")+"/",n=a.attr("matadatatitle");g_webdav_client.GSL(this_url,this_url,d,0,0,function(a,e,b){a==200&&(a=parseXml(b),a=$(a).find("sharelink").text(),e="",e="/smb/css/vlc_video.html?v="+g+a+"&u="+this_url,e+="&t="+n,e+="&showbutton=1",g_modal_url=e,g_modal_window_width=655,g_modal_window_height=580,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_videoplayer")),h&&h.jqmShow())})}return}if(c==
"mp3")openAudioPlayer(b);else{if(c=="doc"||c=="docx"||c=="ppt"||c=="pptx"||c=="xls"||c=="xlsx"||c=="pdf")if((isWinOS()||isMacOS())&&!isPrivateIP()){d=myencodeURI(d);this_url=j.substring(0,j.lastIndexOf("/"));g_webdav_client.GSL(this_url,this_url,d,0,0,function(a,e,b){a==200&&(a=parseXml(b),a=$(a).find("sharelink").text(),e="",a=window.location.protocol+"//"+window.location.host+"/"+a,window.open("https://docs.google.com/viewer?url="+a))});return}c=="jpg"||c=="jpeg"||c=="png"||c=="gif"?(a=getPageSize(),
g_image_player.show(b,a[0],a[1],g_file_array)):window.open(b)}}}
function addtoFavorite(){var a=g_storage.get("ddns_host_name"),b="https://"+a,c=isIE();if(a=="")b=window.location.href;if(typeof window.sidebar=="object"&&typeof window.sidebar.addPanel=="function")return window.sidebar.addPanel("AiCloud",b,""),!1;else if(c&&typeof window.external=="object")return window.external.AddFavorite(b,"AiCloud"),!1;else{window.location=b;var a=navigator.userAgent.toLowerCase(),b="",c=a.indexOf("webkit")!=-1,e=a.indexOf("mac")!=-1;if(a.indexOf("konqueror")!=-1)b="CTRL + B";
else if(window.home||c||e)b=(e?"Command/Cmd":"CTRL")+" + D";b=b?m.getString("msg_add_favorite1")+b+m.getString("msg_add_favorite2"):b;alert(b)}}var IE=document.all?!0:!1;IE||document.captureEvents(Event.MOUSEMOVE);
...
$(document).ready(function(){function a(e){e&&e[0]!=2?alert(m.getString(e)+" : "+decodeURIComponent(g_selected_files[0])):(g_selected_files.splice(0,1),g_selected_files.length<=0?(e=addPathSlash(g_storage.get("openurl")),doPROPFIND(e)):g_webdav_client.DELETE(g_selected_files[0],a))}if(navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPod/i)||navigator.userAgent.match(/Android/i)&&navigator.userAgent.match(/Mobile/i)){var b=window.location.href,b=b.substr(b.lastIndexOf("?")+1,b.length);
if(b.indexOf("desktop=1")!=0){b=window.location.href;b=b.substr(0,b.lastIndexOf("?"));window.location=b+"?mobile=1";return}}document.oncontextmenu=function(){return!1};document.onmousedown=function(){resetTimer()};document.onmousemove=function(a){getMouseXY(a);resetTimer()};$(document).keydown(function(a){a.keyCode==27&&(g_select_mode==1?showHideSelectModeUI(!1):g_upload_mode==1&&closeUploadPanel(),closeJqmWindow());g_image_player&&g_image_player.keydown(a)});g_storage.set("stopLogoutTimer","0");
g_storage.set("isOpenModalWindow","0");g_storage.set("isOnUploadFile","0");createLayout();showHideLoadStatus(!1);adjustLayout();(function(){var a=g_storage.get("openurl");g_webdav_client.GETROUTERINFO(a==void 0?"/":a,function(a,e,b){a==200&&(a=parseXml(b),a=$(a),g_storage.set("webdav_mode",a.find("webdav_mode").text()),g_storage.set("http_port",a.find("http_port").text()),g_storage.set("https_port",a.find("https_port").text()),g_storage.set("http_enable",a.find("http_enable").text()),g_storage.set("misc_http_enable",
a.find("misc_http_enable").text()),g_storage.set("misc_http_port",String(a.find("misc_http_port").text()).replace("\n","")),g_storage.set("misc_https_port",String(a.find("misc_https_port").text()).replace("\n","")),g_storage.set("last_login_info",a.find("last_login_info").text()),g_storage.set("ddns_host_name",a.find("ddns_host_name").text()),g_storage.set("router_version",a.find("version").text()),g_storage.set("aicloud_version",a.find("aicloud_version").text()),g_storage.set("smartsync_version",
a.find("smartsync_version").text()),g_storage.set("wan_ip",a.find("wan_ip").text()),g_storage.set("modalname",a.find("modalname").text()),g_storage.set("usbdiskname",a.find("usbdiskname").text()),g_storage.set("dms_enable",a.find("dms_enable").text()),g_storage.set("app_installation_url",a.find("app_installation_url").text()),g_storage.set("https_crt_cn",a.find("https_crt_cn").text()),g_storage.set("max_sharelink",a.find("max_sharelink").text()),a=g_storage.get("last_login_info"),a!=""&&a!=void 0&&
a!=null&&(a=String(a).split(">"),a=m.getString("title_logininfo")+a[1]+", "+m.getString("title_ip")+a[2],$("#login_info").text(a)))})})();if(g_fileview_only==0){var c=g_storage.get("openurl");g_storage.set("HostList","");doPROPFIND("/",function(){c!=void 0&&c!="/"&&doPROPFIND(c)},0)}else c=g_storage.get("openurl"),doPROPFIND(c);initAudioPlayer();$("#modalWindow").jqm({overlay:70,modal:!0,target:"#jqmContent",onHide:function(a){var b=$(a.w);a.o.remove();b.fadeOut("200",function(){g_show_modal=0;if(g_reload_page==
1){var a=addPathSlash(g_storage.get("openurl"));doPROPFIND(a)}})},onShow:function(a){var a=$(a.w),b=$("#jqmContent",a);$("#jqmTitle",a);var c=(getPageSize()[0]-g_modal_window_width)/2;g_show_modal=1;navigator.userAgent.toLowerCase();var d=function(){var a=-1;navigator.appName=="Microsoft Internet Explorer"&&/MSIE ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent)!=null&&(a=parseFloat(RegExp.$1));return a};g_modal_url!=""&&(b.empty(),$("<iframe src='' frameborder='0' width='100%' height='100%'>").appendTo(b),
$("iframe",a).attr("src",g_modal_url));isBrowser("msie")&&d()<=8&&(g_modal_window_height+=25);a.css({width:g_modal_window_width,height:g_modal_window_height,left:c,top:-g_modal_window_height,opacity:0,display:"block"}).jqmShow().animate({width:g_modal_window_width,height:g_modal_window_height,top:0,left:c,marginLeft:0,opacity:1},200,function(){adjustLayout();$(this).css("display","block")})}});$("div#btnDeleteSel").click(function(){if($(this).hasClass("disable"))return!1;if(!(g_select_array.length<=
0)){g_selected_files=null;g_selected_files=[];for(var e=0;e<g_select_array.length;e++)g_selected_files.push(g_select_array[e].uhref);(g_select_array.length==1?confirm(m.getString("del_files_msg")+" - "+decodeURIComponent(g_select_array[0].title)):confirm(m.getString("del_files_msg")))==!0&&g_webdav_client.DELETE(g_selected_files[0],a)}});$("div#btnNewDir").click(function(){if($(this).hasClass("disable"))return!1;var a=$("div#modalWindow");g_modal_url="/smb/css/makedir.html";g_modal_window_width=500;
g_modal_window_height=80;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_newdir"));a&&a.jqmShow()});$("div#btnDownload").click(function(){if($(this).hasClass("disable"))return!1;if(!(g_select_array.length<=0)){for(var a=[],b=0;b<g_select_array.length;b++){var c=g_select_array[b].title,d=g_select_array[b].uhref,h=g_select_array[b].isdir,g=window.location.href,g=d.substring(0,d.lastIndexOf("/")),c=g+"/"+c;h==1?a.push(c):download_file(c)}download_folder(a)}});$("div#btnRename").click(function(){if($(this).hasClass("disable"))return!1;
g_select_array.length==1&&open_rename_window(g_select_array[0].title,g_select_array[0].uhref,g_select_array[0].isdir)});$("div#btnLock").click(function(){if($(this).hasClass("disable"))return!1;g_select_array.length==1&&g_webdav_client.LOCK(g_select_array[0].uhref,"",function(a,b,c){a!="201"?alert("Error unlocking: "+b):(g_current_locktoken=getLockToken(c),alert("locktoken: "+g_current_locktoken))},null,"exclusive","write",0,3)});$("div#btnUnLock").click(function(){if($(this).hasClass("disable"))return!1;
g_select_array.length==1&&g_webdav_client.UNLOCK(g_select_array[0].uhref,g_current_locktoken,function(a){alert(a)})});$("div#btnChangeUser").click(function(){if(confirm(m.getString("msg_changeuser_confirm"))==!0){$("#main_right_container #fileview").empty();var a=g_storage.get("openurl");g_webdav_client.LOGOUT(a,function(b){b==200&&doPROPFIND(a)})}});$("#btnThumbView").click(function(){g_list_view.set(0);$("#btnThumbView").css("display","none");$("#btnListView").css("display","block");var a=g_storage.get("openurl"),
a=a==void 0?"/":a,b=isAiModeView();if(b<0)doPROPFIND(a);else{var c=g_storage.get("data-id")==void 0?"":g_storage.get("data-id"),d=myencodeURI($("div#boxSearch input").val());doPROPFINDMEDIALIST(a,!1,null,b,"0","50",d,"TIMESTAMP","DESC",c)}});$("#btnListView").click(function(){g_list_view.set(1);$("#btnThumbView").css("display","block");$("#btnListView").css("display","none");var a=g_storage.get("openurl"),a=a==void 0?"/":a,b=isAiModeView();if(b<0)doPROPFIND(a);else{var c=g_storage.get("data-id")==
void 0?"":g_storage.get("data-id"),d=myencodeURI($("div#boxSearch input").val());doPROPFINDMEDIALIST(a,!1,null,b,"0","50",d,"TIMESTAMP","DESC",c)}});$("#btnUpload2").click(function(){g_upload_mode=1;$("div#btnNewDir").css("display","none");$("div#btnUpload").css("display","none");$("div#btnPlayImage").css("display","none");$("div#boxSearch").css("display","none");$("#upload_panel").css("display","block");$("#upload_panel").css("left","1999px");$("#upload_panel").animate({left:"0px"},"slow");var a=
addPathSlash(g_storage.get("openurl"));$("#upload_panel iframe").attr("src","/smb/css/upload.html?u="+a);$("#function_help").text(m.getString("msg_uploadmode_help"));adjustLayout()});$("#btnCancelUpload").click(closeUploadPanel);$(".mediaListDiv").mousedown(function(){var a=$(this).attr("qtype"),b=g_storage.get("openurl");g_storage.set("data-id","");$(".mediaListDiv").removeClass("down");$(this).addClass("down");g_ui_mode.set(a);doPROPFINDMEDIALIST(b,!1,function(){},a,"0","50",null,"TIMESTAMP","DESC")});
$("div#btnAiMusicPopupMenux").click(function(){var a="<div class='popupmenu' id='popupmenu'>";a+="<div class='menuitem' id='classifyByAlbum'>";a+="<div class='menuitem-content' style='-webkit-user-select: none;'>";a+="<span class='menuitem-icon a-inline-block' style='-webkit-user-select: none;'>&nbsp;</span>";a+="<span class='menuitem-container a-inline-block' style='-webkit-user-select: none;'>";a+="<span class='menuitem-caption a-inline-block' style='-webkit-user-select: none;'>";a+="<div style='-webkit-user-select: none;'>"+
m.getString("title_sort_by_album")+"</div>";a+="</span>";a+="</span>";a+="</div>";a+="</div>";a+="<div class='menuitem' id='classifyByArtist'>";a+="<div class='menuitem-content' style='-webkit-user-select: none;'>";a+="<span class='menuitem-icon a-inline-block' style='-webkit-user-select: none;'>&nbsp;</span>";a+="<span class='menuitem-container a-inline-block' style='-webkit-user-select: none;'>";a+="<span class='menuitem-caption a-inline-block' style='-webkit-user-select: none;'>";a+="<div style='-webkit-user-select: none;'>"+
m.getString("title_sort_by_artist")+"</div>";a+="</span>";a+="</span>";a+="</div>";a+="</div>";a+="</div>";$(a).appendTo("body");$(".popupmenu").css("left",g_mouse_x-$(".popupmenu").width()+"px");$(".popupmenu").css("top",g_mouse_y-$(".popupmenu").height()+"px");$("#classifyByAlbum").click(function(a){if(g_webdav_client!=null){showHideLoadStatus(!0);var e=g_storage.get("openurl");g_webdav_client.GETMUSICCLASSIFICATION(e==void 0?"/":e,"album",function(a,e,b){a==200?createClassificationView(b,"album"):
a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)});a.preventDefault();return!1}});$("#classifyByArtist").click(function(){if(g_webdav_client!=null){showHideLoadStatus(!0);var a=g_storage.get("openurl");g_webdav_client.GETMUSICCLASSIFICATION(a==void 0?"/":a,"artist",function(a,e,b){a==200?createClassificationView(b,"artist"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)})}})});$("div#hostview").scroll(function(){g_storage.set("hostviewscrollTop",$(this).scrollTop())});$("div#fileview").scroll(function(){g_storage.set("contentscrollLeft",
$(this).scrollLeft());g_storage.set("contentscrollTop",$(this).scrollTop())});$(".navigation#lan dd a").click(function(){if(confirmCancelUploadFile()!=0){var a=$(this).attr("id");g_storage.set("lan",a);window.location.reload()}});$(".navigation#setting dd a").click(function(){var a=$(this).attr("id");if(a=="logout")confirmCancelUploadFile()!=0&&(a=confirm(m.getString("msg_logout_confirm")),a==!0&&doLOGOUT());else if(a=="mobile"){var b=window.location.href,b=b.substr(0,b.lastIndexOf("?"));window.location=
b+"?mobile=1"}else if(a=="favorite")addtoFavorite();else if(a=="config"){var b=g_storage.get("http_enable"),c=g_storage.get("misc_http_enable"),d=g_storage.get("misc_http_port"),h=g_storage.get("misc_https_port"),g=window.location.host,n="http",a=d;c==0&&!isPrivateIP()?alert(m.getString("msg_no_config")):(b=="0"?(n="http",a=d):b=="1"&&(n="https",a=h),isPrivateIP()?b=n+"://"+g.split(":")[0]:(b=n+"://"+g.split(":")[0],a!=""&&(b+=":"+a)),window.location=b)}else a=="rescan_samba"?confirmCancelUploadFile()!=
0&&(a=confirm(m.getString("title_desc_rescan")),a==!0&&doRescanSamba()):a=="sharelink"?(a=$("div#modalWindow"),b=getPageSize(),g_modal_url="/smb/css/setting.html?p=1&s=1",g_modal_window_width=800,g_modal_window_height=b[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),a&&a.jqmShow()):a=="version"?(a=$("div#modalWindow"),b=getPageSize(),g_modal_url="/smb/css/setting.html?p=2&s=1",g_modal_window_width=800,g_modal_window_height=b[1]-30,$("#jqmMsg").css("display",
"none"),$("#jqmTitleText").text(m.getString("title_setting")),a&&a.jqmShow()):a=="crt"?(a=$("div#modalWindow"),b=getPageSize(),g_modal_url="/smb/css/setting.html?p=3&s=1",g_modal_window_width=800,g_modal_window_height=b[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_crt")),a&&a.jqmShow()):a=="community"?(a=$("div#modalWindow"),b=getPageSize(),g_modal_url="/smb/css/setting.html?p=4&s=1",g_modal_window_width=800,g_modal_window_height=b[1]-30,$("#jqmMsg").css("display",
"none"),$("#jqmTitleText").text(m.getString("title_community")),a&&a.jqmShow()):a!="test_func"&&a=="test_func2"&&g_webdav_client.NVRAMGET("/","rc_support;webdav_last_login_info",function(a,b,e){a==200?(a=parseXml(e),$(a).find("nvram").each(function(){var a=$(this).attr("key"),b=$(this).attr("value");alert("key="+a+", value="+b)})):alert(a)})});$(".navigation#refresh dt a").click(function(){var a=g_storage.get("openurl");g_storage.set("HostList","");doPROPFIND("/",function(){a=a==void 0?"/":a;a!="/"&&
doPROPFIND(a)},0)});$(".themes_ctrl").click(function(){if(confirmCancelUploadFile()!=0){var a=$(this).attr("id");g_storage.setl("skin",a);window.location.reload()}});$("div#btnPlayImage").click(function(){var a=getPageSize();g_image_player.show("",a[0],a[1],g_file_array)});$("div#boxSearch").keyup(function(){var a=myencodeURI($("div#boxSearch input").val()),b=$(this).attr("uhref"),c=$(this).attr("qtype"),d=g_storage.get("data-id")==void 0?"":g_storage.get("data-id");doPROPFINDMEDIALIST(b,!1,function(){},
c,"0","50",a,"TIMESTAMP","DESC",d)});$("#button-select-all").click(function(){g_select_array=null;g_select_array=[];g_select_folder_count=g_select_file_count=0;$("#fileview .wcb").each(function(){var a=!1;var b=$(this),a=b.attr("uhref"),c=b.attr("isdir"),b=myencodeURI(b.attr("data-name"));a==void 0?a=!1:(c==1?g_select_folder_count++:g_select_file_count++,g_select_array.push({isdir:c,uhref:a,title:b}),a=!0);a&&($(this).find(".item-check").addClass("x-view-selected"),$(this).find(".item-check").show(),
...
b)}}else if(a=="upload2picasa"){if(!(g_select_array.length<=0)){b=[];for(a=0;a<g_select_array.length;a++)c=g_select_array[a].uhref,d=getFileExt(c),(d=="jpg"||d=="jpeg"||d=="png"||d=="gif")&&b.push(c);open_upload2service_window("picasa",b)}}else if(a=="upload2twitter"){if(!(g_select_array.length<=0)){b=[];for(a=0;a<g_select_array.length;a++)c=g_select_array[a].uhref,d=getFileExt(c),(d=="jpg"||d=="jpeg"||d=="png"||d=="gif")&&b.push(c);open_upload2service_window("twitter",b)}}else if(a=="share2facebook"){if(!(g_select_array.length<=
0)){b=[];for(a=0;a<g_select_array.length;a++)c=g_select_array[a].uhref,b.push(c);open_sharelink_window("facebook",b)}}else if(a=="share2googleplus"){if(!(g_select_array.length<=0)){b=[];for(a=0;a<g_select_array.length;a++)c=g_select_array[a].uhref,b.push(c);open_sharelink_window("googleplus",b)}}else if(a=="share2twitter"){if(!(g_select_array.length<=0)){b=[];for(a=0;a<g_select_array.length;a++)c=g_select_array[a].uhref,b.push(c);open_sharelink_window("twitter",b)}}else if(a=="share2plurk"){if(!(g_select_array.length<=
0)){b=[];for(a=0;a<g_select_array.length;a++)c=g_select_array[a].uhref,b.push(c);open_sharelink_window("plurk",b)}}else if(a=="share2weibo"){if(!(g_select_array.length<=0)){b=[];for(a=0;a<g_select_array.length;a++)c=g_select_array[a].uhref,b.push(c);open_sharelink_window("weibo",b)}}else if(a=="share2qq"){if(!(g_select_array.length<=0)){b=[];for(a=0;a<g_select_array.length;a++)c=g_select_array[a].uhref,b.push(c);open_sharelink_window("qq",b)}}else if(a=="sharelink"&&!(g_select_array.length<=0)){b=
[];for(a=0;a<g_select_array.length;a++)c=g_select_array[a].uhref,b.push(c);open_sharelink_window("other",b)}},items:{submenu_upload:{name:m.getString("title_upload2"),disabled:function(){if(g_select_array.length<=0)return!0;for(var a=0;a<g_select_array.length;a++){var b=getFileExt(g_select_array[a].uhref);if(b=="jpg"||b=="jpeg"||b=="png"||b=="gif")return!1}return!0},items:{upload2facebook:{name:m.getString("title_facebook")},upload2flickr:{name:m.getString("title_flickr")},upload2picasa:{name:m.getString("title_picasa")},
upload2twitter:{name:m.getString("title_twitter")}}},submenu_share:{name:m.getString("title_share2"),items:{share2facebook:{name:m.getString("title_facebook")},share2googleplus:{name:m.getString("title_googleplus")},share2twitter:{name:m.getString("title_twitter")},share2plurk:{name:m.getString("title_plurk")},share2weibo:{name:m.getString("title_weibo")},share2qq:{name:m.getString("title_qq")}}},sharelink:{name:m.getString("title_gen_sharelink")}}});$.contextMenu({selector:"div#btnCopyMove",trigger:"left",
callback:function(a){if((a=="copy"||a=="move")&&!(g_select_array.length<=0)){for(var b=g_storage.get("openurl"),c=[],d=0;d<g_select_array.length;d++)c.push(g_select_array[d].title);open_copymove_window(a,b,c)}},items:{copy:{name:m.getString("func_copy")},move:{name:m.getString("func_move")}}});$.contextMenu({selector:"div#btnUpload",trigger:"left",callback:function(a){a=="uploadfile"?open_uploadfile_window():a=="uploadfolder"&&open_uploadfolder_window()},items:{uploadfile:{name:m.getString("title_upload_file")},
uploadfolder:{name:m.getString("title_upload_folder")}}});$.contextMenu({selector:"div#btnAiMusicPopupMenu",trigger:"left",callback:function(a){a=="sort_by_album"?g_webdav_client!=null&&(showHideLoadStatus(!0),a=g_storage.get("openurl"),g_webdav_client.GETMUSICCLASSIFICATION(a==void 0?"/":a,"album",function(a,b,c){a==200?createClassificationView(c,"album"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)})):a=="sort_by_artist"&&g_webdav_client!=null&&(showHideLoadStatus(!0),a=g_storage.get("openurl"),
g_webdav_client.GETMUSICCLASSIFICATION(a==void 0?"/":a,"artist",function(a,b,c){a==200?createClassificationView(c,"artist"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)}))},items:{sort_by_album:{name:m.getString("title_sort_by_album")},sort_by_artist:{name:m.getString("title_sort_by_artist")}}});$.contextMenu({selector:".item-menu",trigger:"left",events:{show:function(){},hide:function(){$(this).removeClass("x-view-menu-popup")}},callback:function(a){var b=$(this).parents(".wcb"),c=b.attr("uhref"),
d=encodeURIComponent(b.attr("data-name")),b=b.attr("isdir");if(a=="delete")c!=""&&confirm(m.getString("del_files_msg")+" - "+decodeURIComponent(d))==!0&&g_webdav_client.DELETE(c,function(){var a=addPathSlash(g_storage.get("openurl"));doPROPFIND(a)});else if(a=="copy")open_copymove_window(a,g_storage.get("openurl"),d);else if(a=="move")open_copymove_window(a,g_storage.get("openurl"),d);else if(a=="rename")open_rename_window(d,c,b);else if(a=="download")b=="1"?download_folder(c):download_file(c);else if(a==
"upload2facebook")open_upload2service_window("facebook",c);else if(a=="upload2flickr")open_upload2service_window("flickr",c);else if(a=="upload2picasa")open_upload2service_window("picasa",c);else if(a=="upload2twitter")open_upload2service_window("twitter",c);else if(a=="share2facebook")open_sharelink_window("facebook",c);else if(a=="share2googleplus")open_sharelink_window("googleplus",c);else if(a=="share2twitter")open_sharelink_window("twitter",c);else if(a=="share2plurk")open_sharelink_window("plurk",
c);else if(a=="share2weibo")open_sharelink_window("weibo",c);else if(a=="share2qq")open_sharelink_window("qq",c);else if(a=="sharelink"){a=[];for(c=0;c<g_select_array.length;c++)a.push(g_select_array[c].uhref);open_sharelink_window("other",a);a=null}},items:{"delete":{name:m.getString("func_delete"),disabled:function(){if(g_storage.get("aimode")==1||g_storage.get("aimode")==2||g_storage.get("aimode")==3)return!0}},submenu_copymove:{name:m.getString("title_copymove"),items:{copy:{name:m.getString("func_copy")},
move:{name:m.getString("func_move")}}},rename:{name:m.getString("func_rename"),disabled:function(){if(g_storage.get("aimode")==1||g_storage.get("aimode")==2||g_storage.get("aimode")==3)return!0}},sep1:"---------",download:{name:m.getString("func_download")},sep2:"---------",submenu_upload:{name:m.getString("title_upload2"),disabled:function(){if(g_select_array.length<=0)return!0;for(var a=0;a<g_select_array.length;a++){var b=getFileExt(g_select_array[a].uhref);if(b=="jpg"||b=="jpeg"||b=="png"||b==
"gif")return!1}return!0},items:{upload2facebook:{name:m.getString("title_facebook")},upload2flickr:{name:m.getString("title_flickr")},upload2picasa:{name:m.getString("title_picasa")},upload2twitter:{name:m.getString("title_twitter")}}},submenu_share:{name:m.getString("title_share2"),items:{share2facebook:{name:m.getString("title_facebook")},share2googleplus:{name:m.getString("title_googleplus")},share2twitter:{name:m.getString("title_twitter")},share2plurk:{name:m.getString("title_plurk")},share2weibo:{name:m.getString("title_weibo")},
share2qq:{name:m.getString("title_qq")}}},sharelink:{name:m.getString("title_gen_sharelink")}}});$(window).resize(adjustLayout)});window.onbeforeunload=function(a){if(g_storage.get("isOnUploadFile")==1){var b=m.getString("msg_confirm_cancel_upload");if(a=a||window.event)a.returnValue=b;return b}};window.onunload=function(){confirmCancelUploadFile()};function doBackgroundPlay(){alert("doBackgroundPlay")};var g_bshowHideAiButton=!0,g_bshowHideEditUIRegion=!1,g_hide_aidisk_name=1,g_list_view={_storage:new myStorage,set:function(a){this._storage.setl("listview",a)},get:function(){return this._storage.getl("listview")}},g_ui_mode={_storage:new myStorage,set:function(a){this._storage.set("uimode",a)},get:function(){return this._storage.get("uimode")}},g_usbdisk_space_handler={_changed:!1,_usbdisk_query_index:0,_usbdisk_current_query_index:-1,_usbdisk_query_timer:0,_array:[],add:function(a,b){if(!this.exist(a,
...
b._usbdisk_query_index++):(j=new davlib.DavClient,j.initialize(),j.GETDISKSPACE("/",f,function(d,f,j){d==200?(d=parseXml(j),d=$(d),e.diskUsedPercent=d.find("DiskUsedPercent").text()==""?"0%":d.find("DiskUsedPercent").text(),e.diskUsed=parseInt(d.find("DiskUsed").text()==""?"0":d.find("DiskUsed").text())*1024,e.diskAvailable=parseInt(d.find("DiskAvailable").text()==""?"0":d.find("DiskAvailable").text())*1024,e.done=!0,a(e),b._usbdisk_query_index==c-1?clearInterval(b._usbdisk_query_timer):b._usbdisk_query_index++):
...
b+="<div class='albutton toolbar-button-right disable' id='btnRename' style='display:block'><div class='ticon'></div></div>",b+="<div class='albutton toolbar-button-right disable' id='btnCopyMove' style='display:block'><div class='ticon'></div></div>",b+="</div>",b+="</div>",b+="</div>");b+="</div>";b+="</div>";b+="<div id='bottom_region' class='unselectable'>";g_fileview_only==0&&(b+="<ul class='navigation' id='setting'>",b+="<li>",b+="<dl>",b+="<dd><a id='web_help' href='http://event.asus.com/2012/nw/aicloud/faq.html' target='_blank'>"+
m.getString("title_help")+"</a></dt>",b+="<dd><a id='web_feedback' href='https://vip.asus.com/VIP2/Services/QuestionForm/TechQuery' target='_blank'>"+m.getString("title_feedback")+"</a></dt>",b+="<dd><a id='version'>"+m.getString("title_version")+"</a></dt>",b+="<dd><a id='crt'>"+m.getString("title_crt")+"</a></dt>",b+="<dd><a id='sharelink'>"+m.getString("title_sharelink")+"</a></dt>",b+="<dd><a id='rescan_samba'>"+m.getString("title_rescan")+"</a></dt>",b+="<dd><a id='config'>"+m.getString("btn_config")+
"</a></dt>",b+="<dd><a id='favorite'>"+m.getString("btn_favorite")+"</a></dt>",b+="<dd><a id='mobile'>"+m.getString("title_mobile_view")+"</a></dt>",b+="<dd><a id='logout'>"+m.getString("title_logout")+"</a></dt>",b+="<dt><a>"+m.getString("title_setting")+"</a></dt>",b+="</dl>",b+="</li>",b+="</ul>",b+="<ul class='navigation' id='refresh'>",b+="<li>",b+="<dl>",b+="<dt><a>"+m.getString("btn_refresh")+"</a></dt>",b+="</dl>",b+="</li>",b+="</ul>");b+="<ul class='func_help'>";b+="<span id='function_help'></span>";
b+="</ul>";b+="<span id='right_info'>ASUSTeK Computer Inc. All rights reserved</span>";b+="</div>";b+="<div id='modalWindow' class='jqmWindow'>";b+="<div id='jqmTitle'>";b+="<span id='jqmTitleText'></span>";b+="</div>";b+="<div id='jqmMsg'>";b+="<span id='jqmMsgText'></span>";b+="</div>";b+="<div id='jqmContent' style='padding;0px;margin:0px'>";b+="</div>";b+="</div>";b+="<div id='selectWindow' class='select-window'>";b+="<div class='select-window-panel'>";b+="<table cellspacing='0' class='select-window-toolbar-ct'><tbody><tr>";
b+="<td class='select-window-toolbar-left' alight='left' width='100%'>";b+="<table cellspacing='0'><tbody><tr class='toolbar-left-row'><td class='toolbar-cell'>";b+="<label class='selected-desc-text'></label>";b+="</td></tr></tbody></table>";b+="</td>";b+="<td class='select-window-toolbar-right' alight='right'>";b+="<table cellspacing='0'><tbody><tr class='toolbar-right-row'><td class='toolbar-cell'>";b+="<table cellspacing='0'><tbody><tr>";b+="<td class='toolbar-cell'><button type='button' id='button-select-all' class='x-btn-text'>"+
m.getString("btn_select_all")+"</button></td>";b+="<td class='toolbar-cell'></td>";b+="<td class='toolbar-cell'><button type='button' id='button-unselect-all' class='x-btn-text'>"+m.getString("btn_deselect")+"</button></td>";b+="</tr></tbody></table>";b+="</td></tr></tbody></table>";b+="</td>";b+="</tr></tbody></table>";b+="</div>";b+="</div>";b+=getAudioPlayerLayout();$("body").empty();$("body").append(b);g_webdav_client.GETPRODUCTICON("/",function(a,b,c){a==200?(a=parseXml(c),a=$(a),$("img.production_icon").attr("src",
"data:"+a.find("mimetype").text()+";base64,"+a.find("product_icon").text())):$("img.production_icon").attr("src","/smb/css/default_router.png")});$("#main_region").mousedown(function(){});$("span#username").click(function(){confirm(m.getString("msg_logout_confirm"))==!0&&doLOGOUT()});var e;$(".navigation li").click(function(){clearInterval(e);$(this).find("dd").fadeIn("fast")});$(".navigation li").mouseenter(function(){var a=$(this);clearInterval(e);e=setTimeout(function(){a.find("dd").fadeIn("fast")},
500)});$(".navigation li, .navigation li a").mouseleave(function(){clearInterval(e);$(this).find("dd").fadeOut("fast")});$("#mainCss").attr("href","/smb/css/style-theme.css");$("#btnHelp").attr("title",m.getString("title_help"));$("#btnLogout").attr("title",m.getString("title_logout"));$("#btnConfig").attr("title",m.getString("btn_config"));$("#btnUpload").attr("title",m.getString("btn_upload"));$("#btnCancelUpload").attr("title",m.getString("btn_cancelupload"));$("#btnNewDir").attr("title",m.getString("btn_newdir"));
$("#btnShareLink").attr("title",m.getString("btn_sharelink"));$("#btnDeleteSel").attr("title",m.getString("btn_delselect"));$("#btnDownload").attr("title",m.getString("func_download"));$("#btnRename").attr("title",m.getString("btn_rename"));$("#btnCopyMove").attr("title",m.getString("title_copymove"));$("#btnSetting").attr("title",m.getString("title_setting"));$("#btnRefresh").attr("title",m.getString("btn_refresh"))}
function createHostList(a,b){var c="";$("#hostview").empty();var e=g_storage.get("HostList")?g_storage.get("HostList").split(/,/):[],f=g_storage.getl("onRescanSamba"),j=g_storage.getl("onRescanSambaCount"),d=g_storage.getl("rescan_samba_timer");if(a==2)for(var h=0;h<b.length;h++){var g=b[h].href+"|"+b[h].name+"|"+b[h].online+"|"+b[h].ip+"|"+b[h].mac+"|"+b[h].uid+"|"+b[h].freadonly+"|"+b[h].fhidden+"|"+b[h].type;e.contains(g)||e.push(g);g_storage.set("HostList",e.join(","))}for(h=0;h<e.length;h++){g=
e[h].split("|");c+="<div class='host_item unselectable";g[2]==0&&(c+=" offline");g[8]=="usbdisk"&&(c+=" usbdisk");c+="' uhref='";c+=g[0];c+="' title='";c+=g[1]+" - "+g[3];c+="' online='";c+=g[2];c+="' isdir='1'";c+=" ip='";c+=g[3];c+="' mac='";c+=g[4];c+="' uid='";c+=g[5];c+="' freadonly='";c+=g[6];c+="' fhidden='";c+=g[7];c+=g[8]=="usbdisk"?"' isusb='1'":"' isusb='0'";c+=">";c+="<div id='hosticon' class='sicon "+g[8];g[2]==0&&(c+="off");c+="'/>";if(g[8]=="usbdisk"){var n="usbdisk"+(h+10);c+="<div id='hostinfo' class='unselectable "+
n+"'>";g_usbdisk_space_handler.add(n,g[1])}else c+="<div id='hostinfo' class='unselectable'>";c+="<div id='hostname' class='unselectable'>";c+="<p>";c+=g[1];g[2]==0&&(c+="("+m.getString("title_offline")+")");c+="</p>";c+="</div>";g[8]=="usbdisk"&&(c+="<div id='space'>",c+="<div class='progress-bar'>",c+="<span></span>",c+="</div>",c+="</div>");c+="</div>";c+="</div>"}g_usbdisk_space_handler.refresh();f==1&&(c+="<div class='scan_item unselectable rescan'>",c+="<div id='hosticon' class='sicon sambapcrescan'/>",
c+="<div id='scanlabel' class='unselectable'>",c+="<p>"+m.getString("title_scan")+"</p>",c+="</div>",c+="</div>",d==0&&(d=setInterval(function(){j++;j>=10?(clearInterval(d),g_storage.setl("rescan_samba_timer",0),g_storage.setl("onRescanSamba",0),g_storage.setl("onRescanSambaCount",0)):g_storage.setl("onRescanSambaCount",j);refreshHostList()},5E3),g_storage.setl("rescan_samba_timer",d)));$("#hostview").append(c);var o=g_storage.get("openhostuid");$("#hostview .host_item").each(function(){$(this).attr("uid")==
o?$(this).addClass("select"):$(this).removeClass("select")});$("#hostview .host_item").click(function(){if($(this).attr("online")==0)confirm(m.getString("wol_msg"))==!0&&g_webdav_client.WOL("/",$(this).attr("mac"),function(a){a==200?alert(m.getString("wol_ok_msg")):alert(m.getString("wol_fail_msg"))});else{g_opening_uid=$(this).attr("uid");var a=$(this).attr("uhref");g_storage.set("opentype",$(this).attr("type")=="usbdisk"?"1":"0");doPROPFIND(a,function(){g_storage.set("openhostuid",g_opening_uid);
...
function createClassificationView(a,b){var c=parseXml(a);$(c);var e="";$("#main_right_container #fileview").empty();$(c).find("item").each(function(){var a=$(this).find("id").text(),c=$(this).find("title").text(),d=$(this).find("artist").text(),h=$(this).find("thumb_image").text();e+='<div class="card" data-id="'+a+'" data-no-nav="false">';e+='<div class="image-wrapper">';e+='<div class="image-inner-wrapper" id="'+b+'">';h!=""&&(e+='<img class="image" src="data:image/jpeg;base64,'+$(this).find("thumb_image").text()+
...
g_storage.get("openurl"),b=b==void 0?"/":b,c=window.location.host;c.indexOf(":")!=-1&&(c=c.substring(0,c.indexOf(":")));c="http://"+c+":"+g_storage.get("http_port")+"/";g_webdav_client.GETMUSICPLAYLIST(b,$(this).attr("data-id"),function(a,b,e){if(a==200){a=parseXml(e);$(a);var f=[];$(a).find("item").each(function(){var a=$(this).find("title").text(),b=c+$(this).find("sharelink").text(),e=[];e.name=mydecodeURI(a);e.mp3=b;f.push(e)});openAudioPlayerByPlayList(f)}});a.preventDefault();return!1})}
...
$("#header-fixed").css("top",b);g_fileview_only==1&&($("#button_panel").css("display","none"),$("#main_right_region").css("left","0px"),$("#main_right_region").css("width","100%"),$("#main_right_region").css("height","100%"));$("#audio_player_panel").css("display","block");adjustUploadLayout();g_image_player&&g_image_player.adjustLayout()}
...
function showHideEditUIRegion(a){a?g_bshowHideEditUIRegion||$("#button_panel #edit_ui_region").fadeIn("fast"):g_bshowHideEditUIRegion&&$("#button_panel #edit_ui_region").fadeOut("fast");g_select_file_count>0||g_select_folder_count>0?(isAiModeView()<0&&$("#btnDeleteSel").removeClass("disable"),$("#btnDownload").removeClass("disable"),$("#btnShareLink").removeClass("disable"),$("#btnCopyMove").removeClass("disable")):($("#btnDeleteSel").addClass("disable"),$("#btnDownload").addClass("disable"),$("#btnShareLink").addClass("disable"),
$("#btnCopyMove").addClass("disable"));g_select_file_count+g_select_folder_count==1&&isAiModeView()<0?$("#btnRename").removeClass("disable"):$("#btnRename").addClass("disable");g_bshowHideEditUIRegion=a}
...
d+="</div></div>";d+="</td></tr>";d+="<tr><td>";d+='<div class="albuminfo">';d+='<a id="list_item">';d+=e[c].shortname;e[c].online=="0"&&b=="2"&&(d+="("+m.getString("title_offline")+")");d+="</a>";d+="</div>";d+="</td></tr>";d+="</tbody>";d+="</table>";b=="0"&&(d+='<div class="item-check ui-icon"></div>',d+='<div class="item-menu ui-icon"></div>');d+="</div>"}for(c=0;c<f.length;c++){h=m.getString("table_filename")+": "+f[c].name+"\n"+m.getString("table_time")+": "+f[c].time+"\n"+m.getString("table_size")+
": "+f[c].size;d+='<div class="albumDiv fcb wcb"';d+=' title="';d+=h;d+='" qtype="1" isParent="1" isdir="0" uhref="';d+=f[c].href;d+='" data-name="';d+=f[c].name;d+='" matadatatitle="';d+=f[c].matadatatitle;d+='" uid="';d+=f[c].uid;d+='" ext="';d+=g;d+='" freadonly="';d+=f[c].freadonly;d+='" fhidden="';d+=f[c].fhidden;d+='" data-thumb="';d+=f[c].thumb;d+=f[c].type=="usbdisk"?'" isusb="1"':'" isusb="0"';d+='">';d+='<table class="thumb-table-parent">';d+="<tbody>";var g=getFileExt(String(f[c].href));
g.length>5&&(g="");d+="<tr><td>";d+=b=="0"?'<div class="picDiv cb" popupmenu="1" uhref="':'<div class="picDiv cb" popupmenu="0" uhref="';d+=f[c].href;d+='">';d+=g=="jpg"||g=="jpeg"||g=="png"||g=="gif"||g=="bmp"?'<div id="fileviewicon" class="imgfileDiv bicon">':g=="mp3"||g=="m4a"||g=="m4r"||g=="wav"?'<div id="fileviewicon" class="audiofileDiv bicon">':g=="mp4"||g=="rmvb"||g=="m4v"||g=="wmv"||g=="avi"||g=="mpg"||g=="mpeg"||g=="mkv"||g=="mov"||g=="flv"||g=="3gp"||g=="m2v"||g=="rm"?'<div id="fileviewicon" class="videofileDiv bicon">':
g=="doc"||g=="docx"?'<div id="fileviewicon" class="docfileDiv bicon">':g=="ppt"||g=="pptx"?'<div id="fileviewicon" class="pptfileDiv bicon">':g=="xls"||g=="xlsx"?'<div id="fileviewicon" class="xlsfileDiv bicon">':g=="pdf"?'<div id="fileviewicon" class="pdffileDiv bicon">':'<div id="fileviewicon" class="fileDiv bicon">';d+="</div></div>";d+="</td></tr>";d+="<tr><td>";d+='<div class="albuminfo" style="font-size:80%">';d+='<a id="list_item">';d+=f[c].shortname;d+="</a>";d+="</div>";d+="</td></tr>";d+=
...
function createListView(a,b,c,e,f,j){var d="";d+='<table id="ntl" class="table-file-list">';d+="<thead>";d+="<tr>";d+='<th style="width:30px"></th>';d+='<th style="width:40px"></th>';d+='<th style="width:58%">'+m.getString("table_filename")+"</th>";d+='<th style="width:25%">'+m.getString("table_time")+"</th>";d+='<th style="width:7%">'+m.getString("table_size")+"</th>";d+='<th style="width:30px"></th>';d+="</tr>";d+="</thead>";d+="<tbody>";b==0&&c!=""&&(d+='<tr class="listDiv fcb cbp" ',d+='qtype="1" isParent="1" isdir="1" uhref="',
...
b=="0"&&(d+='<div class="checklist">',d+='<div class="item-menu ui-icon"></div>',d+="</div>"),d+="</td>",d+="</tr>";d+="</tbody>";d+="</table>";d+='<table id="header-fixed" class="table-file-list"></table>';a.append(d);$("td[field=icon], td[field=filename], td[field=time], td[field=size]").mousedown(function(a){j(a,$(this).parent(".listDiv"))});var h=$("#ntl").offset().top,a=$("#ntl > thead").clone(),g=$("#header-fixed").append(a);$("#header-fixed").css("width",$("#ntl").width());$("#fileview").bind("scroll",
function(){var a=$(this).scrollTop();a>=h&&g.is(":hidden")?g.show():a<h&&g.hide()})};var g_image_player={loc:"",page_width:0,page_height:0,file_array:null,show_exif_mode:0,settings:null,keydown:function(a){this.settings&&(a.keyCode==27?this.close():a.keyCode==37?$("#"+this.settings.name).prev(this.settings):a.keyCode==39&&$("#"+this.settings.name).next(this.settings))},adjustLayout:function(){this.settings&&$("#"+this.settings.name).adjustLayout(this.settings)},close:function(){this.settings&&$("#"+this.settings.name).close(this.settings)},show:function(a,b,c,e){var f=this;this.loc=
a;this.page_width=b;this.page_height=c;this.file_array=e;a=[];for(b=0;b<this.file_array.length;b++)c=getFileExt(this.file_array[b].href),(c=="jpg"||c=="jpeg"||c=="png"||c=="gif")&&a.push(this.file_array[b]);if(a.length==0)alert(m.getString("msg_no_image_list"));else{for(b=c=0;b<a.length;b++)this.loc==a[b].href&&(c=b);e="";e+='<div id="image_slide_show" class="barousel unselectable" style="height: 0; width: 0; position: fixed; background-color: rgb(0, 0, 0); left: ';e+=this.page_width/2;e+="px; top: ";
e+=this.page_height/2;e+='px; z-index: 2999;">';e+='<div class="barousel_image">';for(b=0;b<a.length;b++){var j=window.location.protocol+"//"+window.location.host+a[b].href;e+=b==c?'<img src="" path="'+j+'" uhref="'+a[b].href+'" file="'+a[b].name+'" alt="" class="default"/>':'<img src="" path="'+j+'" uhref="'+a[b].href+'" file="'+a[b].name+'" alt="" class=""/>'}e+="</div>";e+='<div class="barousel_nav">';e+='<div class="barousel_content transparent" style="display: block; ">';for(b=0;b<a.length;b++)e+=
'<div class="',b==c&&(e+="default"),e+='" style="display: none; ">',e+='<p class="header">'+a[b].name+"</p>",e+="</div>";e+="</div>";e+="</div>";e+='<div class="barousel_loading" style="position:absolute;display:none;z-index=99;"><img src="/smb/css/load.gif" width="18px" height="18px"/></div>';e+='<div class="barousel_exif_data" style="display:none"></div>';e+="</div>";$(e).animate({width:"100%",height:"100%",left:"0px",top:"0px"},200,null,null).appendTo("body");$("#image_slide_show").barousel({name:"image_slide_show",
manualCarousel:1,contentResize:0,startIndex:c,storage:g_storage,stringTable:m,enableExifFunc:1,enableShareFunc:1,closeHandler:function(){f.file_array=null;f.settings=null},initCompleteHandler:function(a){f.settings=a}});a=null}}};var g_audioPlayer=null,g_audio_playlist=[],g_onPlaying=!1;function openAudioPlayer(a){for(var b=[],c=0;c<g_file_array.length;c++)getFileExt(g_file_array[c].href)=="mp3"&&b.push(g_file_array[c]);if(b.length==0)alert(m.getString("msg_no_image_list"));else{for(var e="",f=0,c=0;c<b.length;c++){var j=b[c].href;a==j&&(f=c);e+=j;c!=b.length-1&&(e+=",")}get_mp3_url(e,!0,function(a){g_audioPlayer.showHideAudioPlayerWindow(!0,function(){g_audioPlayer.addPlaylist(a,f)})})}}
...
function get_mp3_url(a,b,c){if(a!=""){var e=g_audio_playlist,f=a.split(","),j=0,d=!1;g_audio_playlist=[];for(a=0;a<e.length;a++)for(var h=0;h<f.length;h++)e[a].source==f[h]&&(g_audio_playlist.push(e[a]),f.splice(h,1),h=-1);if(b){var g=window.location.host;g.indexOf(":")!=-1&&(g=g.substring(0,g.indexOf(":")));var g="http://"+g+":"+g_storage.get("http_port")+"/",n=setInterval(function(){if(d==!1)if(j<0||j>f.length-1)clearInterval(n),c(g_audio_playlist);else{var a=f[j],b=a.substring(a.lastIndexOf("/")+
1,a.length),e=a.substring(0,a.lastIndexOf("/"));d=!0;g_webdav_client.GSL(e,e,b,0,0,function(c,e,f){if(c==200)c=parseXml(f),c=$(c).find("sharelink").text(),c=g+c,d=!1,e=[],e.source=a,e.name=mydecodeURI(b),e.mp3=c,g_audio_playlist.push(e),j++})}},100)}else{for(a=0;a<f.length;a++)b=f[a],e=b.substring(b.lastIndexOf("/")+1,b.length),b.substring(0,b.lastIndexOf("/")),h=[],h.source=b,h.name=mydecodeURI(e),h.mp3=b,g_audio_playlist.push(h);c(g_audio_playlist)}}}
...
this.startStopRunAudioPlayerWindowTimer(!1);$("#audioPlayerStatusWindow").hide();$("#audioPlayerWindow").hide()}};var b="html,flash",c="mp3",e=navigator.userAgent;if(e.indexOf("Chrome")!=-1||e.indexOf("Safari")!=-1&&(isMacOS()||isWinOS()))b="html,flash",c="mp3";else if(isIE()||e.indexOf("Firefox")!=-1||e.indexOf("Opera")!=-1)b="flash",c="mp3";g_audioPlayer=new a("1",{ready:function(){},ended:function(){g_audioPlayer.playlistNext();g_storage.set("stopLogoutTimer","0")},play:function(){$(this).jPlayer("pauseOthers");
...
error:function(a){a=a.jPlayer.error.type;a=="e_no_solution"?($(".jp-no-solution").html(m.getString("title_install_flash")),$(".jp-no-solution").css("display","block")):a=="e_url"&&g_audio_playlist.length>1&&g_audioPlayer.playlistNext()}})};var this_upload_files=[],g_upload_handler=null,g_upload_option=0;
...
b!=""&&a.setImage(c,b));a._array.shift();a._onLoading=!1})}},100)},stop:function(){this._array=null;clearInterval(this._timer)}};(function(a,b){function c(a){for(var a=a.split(/\s+/),b=[],c=0,d;d=a[c];c++)d=d[0].toUpperCase(),b.push(d);return b}function e(b){return b.id&&a('label[for="'+b.id+'"]').val()||b.name}function f(c,d,t){t||(t=0);d.each(function(){var d=a(this),v=this,l=this.nodeName.toLowerCase(),h,k;l=="label"&&d.find("input, textarea, select").length&&(h=d.text(),d=d.children().first(),v=d.get(0),l=v.nodeName.toLowerCase());switch(l){case "menu":k={name:d.attr("label"),items:{}};t=f(k.items,d.children(),t);break;
case "a":case "button":k={name:d.text(),disabled:!!d.attr("disabled"),callback:function(){return function(){d.click()}}()};break;case "menuitem":case "command":switch(d.attr("type")){case b:case "command":case "menuitem":k={name:d.attr("label"),disabled:!!d.attr("disabled"),callback:function(){return function(){d.click()}}()};break;case "checkbox":k={type:"checkbox",disabled:!!d.attr("disabled"),name:d.attr("label"),selected:!!d.attr("checked")};break;case "radio":k={type:"radio",disabled:!!d.attr("disabled"),
name:d.attr("label"),radio:d.attr("radiogroup"),value:d.attr("id"),selected:!!d.attr("checked")};break;default:k=b}break;case "hr":k="-------";break;case "input":switch(d.attr("type")){case "text":k={type:"text",name:h||e(v),disabled:!!d.attr("disabled"),value:d.val()};break;case "checkbox":k={type:"checkbox",name:h||e(v),disabled:!!d.attr("disabled"),selected:!!d.attr("checked")};break;case "radio":k={type:"radio",name:h||e(v),disabled:!!d.attr("disabled"),radio:!!d.attr("name"),value:d.val(),selected:!!d.attr("checked")};
break;default:k=b}break;case "select":k={type:"select",name:h||e(v),disabled:!!d.attr("disabled"),selected:d.val(),options:{}};d.children().each(function(){k.options[this.value]=a(this).text()});break;case "textarea":k={type:"textarea",name:h||e(v),disabled:!!d.attr("disabled"),value:d.val()};break;case "label":break;default:k={type:"html",html:d.clone(!0)}}k&&(t++,c["key"+t]=k)});return t}a.support.htmlMenuitem="HTMLMenuItemElement"in window;a.support.htmlCommand="HTMLCommandElement"in window;a.support.eventSelectstart=
"onselectstart"in document.documentElement;if(!a.ui||!a.ui.widget){var j=a.cleanData;a.cleanData=function(b){for(var c=0,d;(d=b[c])!=null;c++)try{a(d).triggerHandler("remove")}catch(e){}j(b)}}var d=null,h=!1,g=a(window),n=0,o={},r={},w={},y={selector:null,appendTo:null,trigger:"right",autoHide:!1,delay:200,reposition:!0,determinePosition:function(b){if(a.ui&&a.ui.position)b.css("display","block").position({my:"center top",at:"center bottom",of:this,offset:"0 5",collision:"fit"}).css("display","none");
else{var c=this.offset();c.top+=this.outerHeight();c.left+=this.outerWidth()/2-b.outerWidth()/2;b.css(c)}},position:function(a,b,c){if(!b&&!c)a.determinePosition.call(this,a.$menu);else{var b=b==="maintain"&&c==="maintain"?a.$menu.position():{top:c,left:b},c=g.scrollTop()+g.height(),d=g.scrollLeft()+g.width(),e=a.$menu.height(),f=a.$menu.width();b.top+e>c&&(b.top-=e);b.left+f>d&&(b.left-=f);a.$menu.css(b)}},positionSubmenu:function(b){if(a.ui&&a.ui.position)b.css("display","block").position({my:"left top",
at:"right top",of:this,collision:"flipfit fit"}).css("display","");else{var c={top:0,left:this.outerWidth()};b.css(c)}},zIndex:1,animation:{duration:50,show:"slideDown",hide:"slideUp"},events:{show:a.noop,hide:a.noop},callback:null,items:{}},s={timer:null,pageX:null,pageY:null},k=function(a){for(var b=0;;)if(b=Math.max(b,parseInt(a.css("z-index"),10)||0),a=a.parent(),!a||!a.length||"html body".indexOf(a.prop("nodeName").toLowerCase())>-1)break;return b},l={abortevent:function(a){a.preventDefault();
...
(b.preventDefault(),b.stopImmediatePropagation(),d=c,c.trigger(a.Event("contextmenu",{data:b.data,pageX:b.pageX,pageY:b.pageY})));c.removeData("contextMenuActive")},mouseenter:function(b){var c=a(this),e=a(b.relatedTarget),f=a(document);if(!e.is(".context-menu-list")&&!e.closest(".context-menu-list").length&&(!d||!d.length))s.pageX=b.pageX,s.pageY=b.pageY,s.data=b.data,f.on("mousemove.contextMenuShow",l.mousemove),s.timer=setTimeout(function(){s.timer=null;f.off("mousemove.contextMenuShow");d=c;c.trigger(a.Event("contextmenu",
{data:s.data,pageX:s.pageX,pageY:s.pageY}))},b.data.delay)},mousemove:function(a){s.pageX=a.pageX;s.pageY=a.pageY},mouseleave:function(b){b=a(b.relatedTarget);if(!b.is(".context-menu-list")&&!b.closest(".context-menu-list").length){try{clearTimeout(s.timer)}catch(c){}s.timer=null}},layerClick:function(b){var c=a(this).data("contextMenuRoot"),d=b.button,e=b.pageX,f=b.pageY,k,l;b.preventDefault();b.stopImmediatePropagation();setTimeout(function(){var h,u=c.trigger=="left"&&d===0||c.trigger=="right"&&
d===2;document.elementFromPoint&&(c.$layer.hide(),k=document.elementFromPoint(e-g.scrollLeft(),f-g.scrollTop()),c.$layer.show());if(c.reposition&&u)if(document.elementFromPoint){if(c.$trigger.is(k)||c.$trigger.has(k).length){c.position.call(c.$trigger,c,e,f);return}}else if(l=c.$trigger.offset(),h=a(window),l.top+=h.scrollTop(),l.top<=b.pageY&&(l.left+=h.scrollLeft(),l.left<=b.pageX&&(l.bottom=l.top+c.$trigger.outerHeight(),l.bottom>=b.pageY&&(l.right=l.left+c.$trigger.outerWidth(),l.right>=b.pageX)))){c.position.call(c.$trigger,
c,e,f);return}if(k&&u)c.$trigger.one("contextmenu:hidden",function(){a(k).contextMenu({x:e,y:f})});c.$menu.trigger("contextmenu:hide")},50)},keyStop:function(a,b){b.isInput||a.preventDefault();a.stopPropagation()},key:function(a){var b=d.data("contextMenu")||{};switch(a.keyCode){case 9:case 38:if(l.keyStop(a,b),b.isInput)if(a.keyCode==9&&a.shiftKey){a.preventDefault();b.$selected&&b.$selected.find("input, textarea, select").blur();b.$menu.trigger("prevcommand");return}else{if(a.keyCode==38&&b.$selected.find("input, textarea, select").prop("type")==
"checkbox"){a.preventDefault();return}}else if(a.keyCode!=9||a.shiftKey){b.$menu.trigger("prevcommand");return}case 40:l.keyStop(a,b);if(b.isInput)if(a.keyCode==9){a.preventDefault();b.$selected&&b.$selected.find("input, textarea, select").blur();b.$menu.trigger("nextcommand");return}else{if(a.keyCode==40&&b.$selected.find("input, textarea, select").prop("type")=="checkbox"){a.preventDefault();return}}else{b.$menu.trigger("nextcommand");return}break;case 37:l.keyStop(a,b);if(b.isInput||!b.$selected||
!b.$selected.length)break;if(!b.$selected.parent().hasClass("context-menu-root")){a=b.$selected.parent().parent();b.$selected.trigger("contextmenu:blur");b.$selected=a;return}break;case 39:l.keyStop(a,b);if(b.isInput||!b.$selected||!b.$selected.length)break;var c=b.$selected.data("contextMenu")||{};if(c.$menu&&b.$selected.hasClass("context-menu-submenu")){b.$selected=null;c.$selected=null;c.$menu.trigger("nextcommand");return}break;case 35:case 36:if(!b.$selected||!b.$selected.find("input, textarea, select").length)(b.$selected&&
b.$selected.parent()||b.$menu).children(":not(.disabled, .not-selectable)")[a.keyCode==36?"first":"last"]().trigger("contextmenu:focus"),a.preventDefault();return;case 13:l.keyStop(a,b);if(b.isInput){if(b.$selected&&!b.$selected.is("textarea, select")){a.preventDefault();return}break}b.$selected&&b.$selected.trigger("mouseup");return;case 32:case 33:case 34:l.keyStop(a,b);return;case 27:l.keyStop(a,b);b.$menu.trigger("contextmenu:hide");return;default:if(c=String.fromCharCode(a.keyCode).toUpperCase(),
...
c=c.contextMenuRoot;b.addClass("hover").siblings(".hover").trigger("contextmenu:blur");d.$selected=c.$selected=b;d.$node&&c.positionSubmenu.call(d.$node,d.$menu)},blurItem:function(b){b.stopPropagation();var b=a(this),c=b.data().contextMenu;b.removeClass("hover");c.$selected=null}},u={show:function(b,c,e){var f=a(this),h={};a("#context-menu-layer").trigger("mousedown");b.$trigger=f;if(b.events.show.call(f,b)===!1)d=null;else{u.update.call(f,b);b.position.call(f,b,c,e);if(b.zIndex)h.zIndex=k(f)+b.zIndex;
u.layer.call(b.$menu,b,h.zIndex);b.$menu.find("ul").css("zIndex",h.zIndex+1);b.$menu.css(h)[b.animation.show](b.animation.duration,function(){f.trigger("contextmenu:visible")});f.data("contextMenu",b).addClass("context-menu-active");a(document).off("keydown.contextMenu").on("keydown.contextMenu",l.key);if(b.autoHide)a(document).on("mousemove.contextMenuAutoHide",function(a){var c=f.offset();c.right=c.left+f.outerWidth();c.bottom=c.top+f.outerHeight();b.$layer&&!b.hovering&&(!(a.pageX>=c.left&&a.pageX<=
c.right)||!(a.pageY>=c.top&&a.pageY<=c.bottom))&&b.$menu.trigger("contextmenu:hide")})}},hide:function(c,e){var f=a(this);c||(c=f.data("contextMenu")||{});if(e||!(c.events&&c.events.hide.call(f,c)===!1)){f.removeData("contextMenu").removeClass("context-menu-active");if(c.$layer){setTimeout(function(a){return function(){a.remove()}}(c.$layer),10);try{delete c.$layer}catch(l){c.$layer=null}}d=null;c.$menu.find(".hover").trigger("contextmenu:blur");c.$selected=null;a(document).off(".contextMenuAutoHide").off("keydown.contextMenu");
...
b){d[b]={};e[b]||(e[b]={})});e.accesskeys||(e.accesskeys={});a.each(d.items,function(b,f){var k=a('<li class="context-menu-item"></li>').addClass(f.className||""),h=null,g=null;k.on("click",a.noop);f.$node=k.data({contextMenu:d,contextMenuRoot:e,contextMenuKey:b});if(f.accesskey)for(var j=c(f.accesskey),n=0,o;o=j[n];n++)if(!e.accesskeys[o]){e.accesskeys[o]=f;f._name=f.name.replace(RegExp("("+o+")","i"),'<span class="context-menu-accesskey">$1</span>');break}if(typeof f=="string")k.addClass("context-menu-separator not-selectable");
else if(f.type&&w[f.type])w[f.type].call(k,f,d,e),a.each([d,e],function(c,d){d.commands[b]=f;if(a.isFunction(f.callback))d.callbacks[b]=f.callback});else{if(f.type=="html")k.addClass("context-menu-html not-selectable");else if(f.type)h=a("<label></label>").appendTo(k),a("<span></span>").html(f._name||f.name).appendTo(h),k.addClass("context-menu-input"),d.hasTypes=!0,a.each([d,e],function(a,c){c.commands[b]=f;c.inputs[b]=f});else if(f.items)f.type="sub";switch(f.type){case "text":g=a('<input type="text" value="1" name="" value="">').attr("name",
"context-menu-input-"+b).val(f.value||"").appendTo(h);break;case "textarea":g=a('<textarea name=""></textarea>').attr("name","context-menu-input-"+b).val(f.value||"").appendTo(h);f.height&&g.height(f.height);break;case "checkbox":g=a('<input type="checkbox" value="1" name="" value="">').attr("name","context-menu-input-"+b).val(f.value||"").prop("checked",!!f.selected).prependTo(h);break;case "radio":g=a('<input type="radio" value="1" name="" value="">').attr("name","context-menu-input-"+f.radio).val(f.value||
"").prop("checked",!!f.selected).prependTo(h);break;case "select":g=a('<select name="">').attr("name","context-menu-input-"+b).appendTo(h);f.options&&(a.each(f.options,function(b,c){a("<option></option>").val(b).text(c).appendTo(g)}),g.val(f.selected));break;case "sub":a("<span></span>").html(f._name||f.name).appendTo(k);f.appendTo=f.$node;u.create(f,e);k.data("contextMenu",f).addClass("context-menu-submenu");f.callback=null;break;case "html":a(f.html).appendTo(k);break;default:a.each([d,e],function(c,
d){d.commands[b]=f;if(a.isFunction(f.callback))d.callbacks[b]=f.callback}),a("<span></span>").html(f._name||f.name||"").appendTo(k)}if(f.type&&f.type!="sub"&&f.type!="html"&&(g.on("focus",l.focusInput).on("blur",l.blurInput),f.events))g.on(f.events,d);f.icon&&k.addClass("icon icon-"+f.icon)}f.$input=g;f.$label=h;k.appendTo(d.$menu);if(!d.hasTypes&&a.support.eventSelectstart)k.on("selectstart.disableTextSelect",l.abortevent)});d.$node||d.$menu.css("display","none").addClass("context-menu-root");d.$menu.appendTo(d.appendTo||
...
k=c.items[f],f=a.isFunction(k.disabled)&&k.disabled.call(e,f,d)||k.disabled===!0;b[f?"addClass":"removeClass"]("disabled");if(k.type)switch(b.find("input, select, textarea").prop("disabled",f),k.type){case "text":case "textarea":k.$input.val(k.value||"");break;case "checkbox":case "radio":k.$input.val(k.value||"").prop("checked",!!k.selected);break;case "select":k.$input.val(k.selected||"")}k.$menu&&u.update.call(e,k,d)})},layer:function(b,c){var d=b.$layer=a('<div id="context-menu-layer" style="position:fixed; z-index:'+
c+'; top:0; left:0; opacity: 0; filter: alpha(opacity=0); background-color: #000;"></div>').css({height:g.height(),width:g.width(),display:"block"}).data("contextMenuRoot",b).insertBefore(this).on("contextmenu",l.abortevent).on("mousedown",l.layerClick);a.support.fixedPosition||d.css({position:"absolute",height:a(document).height()});return d}};a.fn.contextMenu=function(c){c===b?this.first().trigger("contextmenu"):c.x&&c.y?this.first().trigger(a.Event("contextmenu",{pageX:c.x,pageY:c.y})):c==="hide"?
(c=this.data("contextMenu").$menu)&&c.trigger("contextmenu:hide"):c==="destroy"?a.contextMenu("destroy",{context:this}):a.isPlainObject(c)?(c.context=this,a.contextMenu("create",c)):c?this.removeClass("context-menu-disabled"):c||this.addClass("context-menu-disabled");return this};a.contextMenu=function(c,d){typeof c!="string"&&(d=c,c="create");typeof d=="string"?d={selector:d}:d===b&&(d={});var e=a.extend(!0,{},y,d||{}),f=a(document),k=f,g=!1;!e.context||!e.context.length?e.context=document:(k=a(e.context).first(),
e.context=k.get(0),g=e.context!==document);switch(c){case "create":if(!e.selector)throw Error("No selector specified");if(e.selector.match(/.context-menu-(list|item|input)($|\s)/))throw Error('Cannot bind to selector "'+e.selector+'" as it contains a reserved className');if(!e.build&&(!e.items||a.isEmptyObject(e.items)))throw Error("No Items specified");n++;e.ns=".contextMenu"+n;if(!g)o[e.selector]=e.ns;r[e.ns]=e;if(!e.trigger)e.trigger="right";h||(f.on({"contextmenu:hide.contextMenu":l.hideMenu,
"prevcommand.contextMenu":l.prevItem,"nextcommand.contextMenu":l.nextItem,"contextmenu.contextMenu":l.abortevent,"mouseenter.contextMenu":l.menuMouseenter,"mouseleave.contextMenu":l.menuMouseleave},".context-menu-list").on("mouseup.contextMenu",".context-menu-input",l.inputClick).on({"mouseup.contextMenu":l.itemClick,"contextmenu:focus.contextMenu":l.focusItem,"contextmenu:blur.contextMenu":l.blurItem,"contextmenu.contextMenu":l.abortevent,"mouseenter.contextMenu":l.itemMouseenter,"mouseleave.contextMenu":l.itemMouseleave},
".context-menu-item"),h=!0);k.on("contextmenu"+e.ns,e.selector,e,l.contextmenu);if(g)k.on("remove"+e.ns,function(){a(this).contextMenu("destroy")});switch(e.trigger){case "hover":k.on("mouseenter"+e.ns,e.selector,e,l.mouseenter).on("mouseleave"+e.ns,e.selector,e,l.mouseleave);break;case "left":k.on("click"+e.ns,e.selector,e,l.click)}e.build||u.create(e);break;case "destroy":var j;if(g){var q=e.context;a.each(r,function(b,c){if(c.context!==q)return!0;j=a(".context-menu-list").filter(":visible");j.length&&
j.data().contextMenuRoot.$trigger.is(a(c.context).find(c.selector))&&j.trigger("contextmenu:hide",{force:!0});try{r[c.ns].$menu&&r[c.ns].$menu.remove(),delete r[c.ns]}catch(d){r[c.ns]=null}a(c.context).off(c.ns);return!0})}else if(e.selector){if(o[e.selector]){j=a(".context-menu-list").filter(":visible");j.length&&j.data().contextMenuRoot.$trigger.is(e.selector)&&j.trigger("contextmenu:hide",{force:!0});try{r[o[e.selector]].$menu&&r[o[e.selector]].$menu.remove(),delete r[o[e.selector]]}catch(p){r[o[e.selector]]=
null}f.off(o[e.selector])}}else f.off(".contextMenu .contextMenuAutoHide"),a.each(r,function(b,c){a(c.context).off(c.ns)}),o={},r={},n=0,h=!1,a("#context-menu-layer, .context-menu-list").remove();break;case "html5":(!a.support.htmlCommand&&!a.support.htmlMenuitem||typeof d=="boolean"&&d)&&a('menu[type="context"]').each(function(){this.id&&a.contextMenu({selector:"[contextmenu="+this.id+"]",items:a.contextMenu.fromMenu(this)})}).css("display","none");break;default:throw Error('Unknown operation "'+
...
height:c?b.height():b.outerHeight()}}};a.fn.position=function(b){if(!b||!b.of)return s.apply(this,arguments);var b=a.extend({},b),l,j,z,v,t,x,B=a(b.of),C=a.position.getWithinInfo(b.within),D=a.position.getScrollInfo(C),q=(b.collision||"flip").split(" "),p={};x=f(B);if(B[0].preventDefault)b.at="left top";j=x.width;z=x.height;v=x.offset;t=a.extend({},v);a.each(["my","at"],function(){var a=(b[this]||"").split(" "),c,d;a.length===1&&(a=n.test(a[0])?a.concat(["center"]):o.test(a[0])?["center"].concat(a):
["center","center"]);a[0]=n.test(a[0])?a[0]:"center";a[1]=o.test(a[1])?a[1]:"center";c=r.exec(a[0]);d=r.exec(a[1]);p[this]=[c?c[0]:0,d?d[0]:0];b[this]=[w.exec(a[0])[0],w.exec(a[1])[0]]});q.length===1&&(q[1]=q[0]);b.at[0]==="right"?t.left+=j:b.at[0]==="center"&&(t.left+=j/2);b.at[1]==="bottom"?t.top+=z:b.at[1]==="center"&&(t.top+=z/2);l=c(p.at,j,z);t.left+=l[0];t.top+=l[1];return this.each(function(){var f,n,o=a(this),x=o.outerWidth(),r=o.outerHeight(),s=e(this,"marginLeft"),w=e(this,"marginTop"),
y=x+s+e(this,"marginRight")+D.width,G=r+w+e(this,"marginBottom")+D.height,A=a.extend({},t),F=c(p.my,o.outerWidth(),o.outerHeight());b.my[0]==="right"?A.left-=x:b.my[0]==="center"&&(A.left-=x/2);b.my[1]==="bottom"?A.top-=r:b.my[1]==="center"&&(A.top-=r/2);A.left+=F[0];A.top+=F[1];if(!a.support.offsetFractions)A.left=g(A.left),A.top=g(A.top);f={marginLeft:s,marginTop:w};a.each(["left","top"],function(c,d){if(a.ui.position[q[c]])a.ui.position[q[c]][d](A,{targetWidth:j,targetHeight:z,elemWidth:x,elemHeight:r,
collisionPosition:f,collisionWidth:y,collisionHeight:G,offset:[l[0]+F[0],l[1]+F[1]],my:b.my,at:b.at,within:C,elem:o})});b.using&&(n=function(a){var c=v.left-A.left,e=c+j-x,f=v.top-A.top,g=f+z-r,l={target:{element:B,left:v.left,top:v.top,width:j,height:z},element:{element:o,left:A.left,top:A.top,width:x,height:r},horizontal:e<0?"left":c>0?"right":"center",vertical:g<0?"top":f>0?"bottom":"middle"};if(j<x&&h(c+e)<j)l.horizontal="center";if(z<r&&h(f+g)<z)l.vertical="middle";l.important=d(h(c),h(e))>d(h(f),
h(g))?"horizontal":"vertical";b.using.call(this,a,l)});o.offset(a.extend(A,{using:n}))})};a.ui.position={fit:{left:function(a,b){var c=b.within,e=c.isWindow?c.scrollLeft:c.offset.left,f=c.width,h=a.left-b.collisionPosition.marginLeft,c=e-h,g=h+b.collisionWidth-f-e;b.collisionWidth>f?c>0&&g<=0?(e=a.left+c+b.collisionWidth-f-e,a.left+=c-e):a.left=g>0&&c<=0?e:c>g?e+f-b.collisionWidth:e:c>0?a.left+=c:g>0?a.left-=g:a.left=d(a.left-h,a.left)},top:function(a,b){var c=b.within,e=c.isWindow?c.scrollTop:c.offset.top,
f=b.within.height,h=a.top-b.collisionPosition.marginTop,c=e-h,g=h+b.collisionHeight-f-e;b.collisionHeight>f?c>0&&g<=0?(e=a.top+c+b.collisionHeight-f-e,a.top+=c-e):a.top=g>0&&c<=0?e:c>g?e+f-b.collisionHeight:e:c>0?a.top+=c:g>0?a.top-=g:a.top=d(a.top-h,a.top)}},flip:{left:function(a,b){var c=b.within,d=c.offset.left+c.scrollLeft,e=c.width,f=c.isWindow?c.scrollLeft:c.offset.left,g=a.left-b.collisionPosition.marginLeft,c=g-f,j=g+b.collisionWidth-e-f,g=b.my[0]==="left"?-b.elemWidth:b.my[0]==="right"?b.elemWidth:
0,n=b.at[0]==="left"?b.targetWidth:b.at[0]==="right"?-b.targetWidth:0,o=-2*b.offset[0];if(c<0){if(d=a.left+g+n+o+b.collisionWidth-e-d,d<0||d<h(c))a.left+=g+n+o}else if(j>0&&(d=a.left-b.collisionPosition.marginLeft+g+n+o-f,d>0||h(d)<j))a.left+=g+n+o},top:function(a,b){var c=b.within,d=c.offset.top+c.scrollTop,e=c.height,f=c.isWindow?c.scrollTop:c.offset.top,g=a.top-b.collisionPosition.marginTop,c=g-f,j=g+b.collisionHeight-e-f,g=b.my[1]==="top"?-b.elemHeight:b.my[1]==="bottom"?b.elemHeight:0,n=b.at[1]===
"top"?b.targetHeight:b.at[1]==="bottom"?-b.targetHeight:0,o=-2*b.offset[1];if(c<0){if(d=a.top+g+n+o+b.collisionHeight-e-d,a.top+g+n+o>c&&(d<0||d<h(c)))a.top+=g+n+o}else if(j>0&&(d=a.top-b.collisionPosition.marginTop+g+n+o-f,a.top+g+n+o>j&&(d>0||h(d)<j)))a.top+=g+n+o}},flipfit:{left:function(){a.ui.position.flip.left.apply(this,arguments);a.ui.position.fit.left.apply(this,arguments)},top:function(){a.ui.position.flip.top.apply(this,arguments);a.ui.position.fit.top.apply(this,arguments)}}};(function(){var b,
...
function open_copymove_window(a,b,c){var e="";if(c instanceof Array)for(var f=0;f<c.length;f++)e+=c[f],f!=c.length-1&&(e+=",");else e=c;e==""||b==""||(c=$("div#modalWindow"),g_modal_url="/smb/css/copymove.html?a="+a+"&o="+e+"&f="+b,g_modal_window_height=g_modal_window_width=500,$("#jqmMsg").css("display","none"),a=="copy"?$("#jqmTitleText").text(m.getString("func_copy")):a=="move"&&$("#jqmTitleText").text(m.getString("func_move")),c&&c.jqmShow())}
function open_upload2service_window(a,b){var c="";if(b instanceof Array)for(var e=b.length,f=0;f<e;f++)c+=b[f],f!=e-1&&(c+=";");else c=b;c!=""&&(e=$("div#modalWindow"),f="",a=="facebook"?(g_modal_url="/smb/css/service/facebook.html",f=m.getString("title_upload2")+" "+m.getString("title_facebook")):a=="flickr"?(g_modal_url="/smb/css/service/flickr.html",f=m.getString("title_upload2")+" "+m.getString("title_flickr")):a=="picasa"?(g_modal_url="/smb/css/service/picasa.html",f=m.getString("title_upload2")+
" "+m.getString("title_picasa")):a=="twitter"&&(g_modal_url="/smb/css/service/twitter.html",f=m.getString("title_upload2")+" "+m.getString("title_twitter")),g_modal_url+="?v="+c,g_modal_window_width=600,g_modal_window_height=370,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(f),e.jqmShow())}
function open_sharelink_window(a,b){var c="";if(b instanceof Array)for(var e=b.length,f=0;f<e;f++)c+=b[f],f!=e-1&&(c+=";");else c=b;c!=""&&(e="",e=a=="facebook"?m.getString("title_share2")+" "+m.getString("title_facebook"):a=="googleplus"?m.getString("title_share2")+" "+m.getString("title_googleplus"):a=="twitter"?m.getString("title_share2")+" "+m.getString("title_twitter"):a=="plurk"?m.getString("title_share2")+" "+m.getString("title_plurk"):a=="weibo"?m.getString("title_share2")+" "+m.getString("title_weibo"):
a=="qq"?m.getString("title_share2")+" "+m.getString("title_qq"):m.getString("title_gen_sharelink"),f=$("div#modalWindow"),g_modal_url="/smb/css/sharelink.html?s="+a+"&f="+c,g_modal_window_width=600,g_modal_window_height=530,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(e),f&&f.jqmShow())}function download_file(a){a!=""&&$.fileDownload(a,{successCallback:function(){},failCallback:function(a,c){window.open(c)}})}
