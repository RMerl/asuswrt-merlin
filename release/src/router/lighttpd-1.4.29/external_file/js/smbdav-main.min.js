...
b&&b.jqmShow()):a=="rescan_samba"?doRescanSamba():a=="sharelink"?(b=$("div#modalWindow"),g_modal_url="/smb/css/setting.html?p=1",g_modal_window_width=800,g_modal_window_height=600,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),b&&b.jqmShow()):a=="version"&&(b=$("div#modalWindow"),g_modal_url="/smb/css/setting.html?p=2",g_modal_window_width=800,g_modal_window_height=600,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),
