...
["zh-tw","en-us"],g_current_locktoken="",g_mouse_x=0,g_mouse_y=0,g_fileview_only=0,g_medialist_mode=0,client=new davlib.DavClient;client.initialize();g_support_html5=window.File&&window.FileReader&&window.FileList&&window.Blob?1:0;
...
$(".mediaListDiv").mousedown(function(){var a=$(this).parents(".thumb-table-parent").find("a#list_item"),b=a.attr("qtype"),a=a.attr("uhref");doPROPFINDMEDIALIST(a,!1,function(){},b,"0","50",null,"TIMESTAMP","DESC")})}}function sortByName(d,b){var a=d.name.toLowerCase(),e=b.name.toLowerCase();return a<e?-1:a>e?1:0}function arraymove(d,b,a){var e=d[b];d.splice(b,1);d.splice(a,0,e)}function showHideLoadStatus(d){d?$("#loading").css("display","block"):$("#loading").css("display","none")}
...
null;g_select_array=[];var b=0,a=0;$("#fileview").find(".albumDiv").each(function(){if($(this).find(".selectDiv").css("display")=="block"){var e=$(this).find("#list_item").attr("uhref"),c=$(this).find("#list_item").attr("isdir"),d=myencodeURI($(this).find("#list_item").attr("title"));c==1?a++:b++;g_select_array.push({isdir:c,uhref:e,title:d})}});$("#btnDownload").removeClass("disable");$("#btnShareLink").removeClass("disable");g_medialist_mode==0&&(b>0||a>0?$("#btnDeleteSel").removeClass("disable"):
