...
["zh-tw","en"],client=new davlib.DavClient;client.initialize();g_support_html5=window.File&&window.FileReader&&window.FileList&&window.Blob?1:0;
...
13&&e()});$("#table_login #ok").click(function(){e()});$("#table_login #cancel").click(function(){closeJqmWindow(0)});b&&b.jqmShow()}function doRescanSamba(){var c=addPathSlash(g_storage.get("openurl"));closeJqmWindow(0);showHideLoadStatus(!0);client.RESCANSMBPC(c,function(b){b[0]==2&&(g_storage.setl("onRescanSamba",1),g_storage.setl("onRescanSambaCount",0),g_storage.set("HostList",""),doPROPFIND("/"))})}
...
function doRENAME(c,b){var a=0,e=addPathSlash(g_storage.get("openurl")),d=e+b;$("a#list_item").each(function(){b==myencodeURI($(this).attr("title"))&&(a=1,$(this).attr("isdir")=="1"?alert(m.getString("folder_already_exist_msg")):alert(m.getString("file_already_exist_msg")))});a!=1&&client.MOVE(c,d,function(a){a[0]==2?(doPROPFIND(e),closeJqmWindow(0)):alert(m.getString(a)+" : "+decodeURI(c))},null,!1)}function getFileViewHeight(){return $("#fileview").height()}
function closeUploadPanel(c){g_upload_mode=0;g_reload_page=c;g_storage.set("stopLogoutTimer","0");$("div#btnNewDir").css("display","block");g_support_html5==1&&$("div#btnUpload").css("display","block");$("div#btnSelect").css("display","block");$("#btnPlayImage").css("display","block");$("div#btnCancelUpload").css("display","none");$("#function_help").text("");$("#upload_panel").animate({left:"1999px"},"slow",null,function(){$("#upload_panel").css("display","none");adjustLayout()});c==1&&(c=addPathSlash(g_storage.get("openurl")),
doPROPFIND(c))}
...
e+"'>"+b[f]+"</a>";d=a}$("p#openurl").empty();$("p#openurl").append(a);$("a#url_path").click(function(){doPROPFIND($(this).attr("uhref"))})}
function doPROPFIND(c,b,a){if(client!=null){showHideLoadStatus(!0);try{client.PROPFIND(c,a,function(a,e,f){if(a){if(a==207){cancelSelectMode();closeUploadPanel();g_folder_array=[];g_file_array=[];if(window.DOMParser)a=new DOMParser,e=a.parseFromString(f,"text/xml");else if(e=new ActiveXObject("Microsoft.XMLDOM"),e.async="false",e.loadXML(f),!e.documentElement){alert("Fail to load xml!");showHideLoadStatus(!1);return}var g,i,k,j,s,u=e.documentElement.childNodes,f=e.documentElement.getAttribute("qtype");
e.documentElement.getAttribute("readonly");a=e.documentElement.getAttribute("ruser");e.documentElement.getAttribute("computername");e=e.documentElement.getAttribute("isusb");for(g=0;g<u.length;g++){var p="",w="",z="",t="",v="",A="",B="",C="",D="",q="",r="",x="",n="",l,y=u[g].childNodes;for(i=0;i<y.length;i++)if(y[i].nodeType==1&&y[i].nodeName=="D:propstat"){var F=y[i].childNodes;for(k=0;k<F.length;k++)if(F[k].nodeName=="D:prop"){var o=F[k].childNodes;for(j=0;j<o.length;j++)if(!(o[j].childNodes.length<=
0))if(o[j].nodeName=="D:getcontenttype")w=String(o[j].childNodes[0].nodeValue);else if(o[j].nodeName=="D:getuniqueid")z=String(o[j].childNodes[0].nodeValue);else if(o[j].nodeName=="D:getonline")A=String(o[j].childNodes[0].nodeValue);else if(o[j].nodeName=="D:getlastmodified")B=String(o[j].childNodes[0].nodeValue);else if(o[j].nodeName=="D:getcontentlength")C=String(size_format(parseInt(o[j].childNodes[0].nodeValue)));else if(o[j].nodeName=="D:getmac")q=String(o[j].childNodes[0].nodeValue);else if(o[j].nodeName==
"D:getip")D=String(o[j].childNodes[0].nodeValue);else if(o[j].nodeName=="D:gettype")r=String(o[j].childNodes[0].nodeValue);else if(o[j].nodeName=="D:getattr"){var E=o[j].childNodes;for(s=0;s<E.length;s++)if(E[s].nodeName=="D:readonly")x=E[s].childNodes[0].nodeValue;else if(E[s].nodeName=="D:hidden")n=E[s].childNodes[0].nodeValue}}}else y[i].nodeType==1&&y[i].nodeName=="D:href"&&(p=String(y[i].childNodes[0].nodeValue),k="",p.match(/^http/)&&(k=window.location.protocol+"//"+window.location.host),j=
k+addPathSlash(c),p!=j?(p=p.replace(k,""),t=p.substring(p.lastIndexOf("/")+1,p.length),t!=""?(l=t,v=t=mydecodeURI(t),k=g_listview==0?12:45,v.length>k&&(v=v.substring(0,k)+"...")):p=""):p="");p!=""&&(w=="httpd/unix-directory"?g_folder_array.push({contenttype:w,href:p,name:t,uname:l,shortname:v,online:A,time:B,size:C,ip:D,mac:q,uid:z,type:r,freadonly:x,fhidden:n}):g_file_array.push({contenttype:w,href:p,name:t,uname:l,shortname:v,online:A,time:B,size:C,ip:D,mac:q,uid:z,type:r,freadonly:x,fhidden:n}))}g_folder_array.sort(sortByName);
g_file_array.sort(sortByName);for(l=0;l<g_folder_array.length;l++)g_folder_array[l].type=="usbdisk"&&arraymove(g_folder_array,l,0);l=addPathSlash(c);l!="/"&&(l=l.substring(0,l.length-1),l=l.substring(0,l.lastIndexOf("/")),l==""&&(l="/"));createHostList(f,g_folder_array);createThumbView(f,l,g_folder_array,g_file_array);f==0&&g_select_mode==0?($("#btnUpload").css("display","block"),$("#btnSelect").css("display","block"),$("#btnNewDir").css("display","block"),$("#btnPlayImage").css("display","block")):
($("#btnUpload").css("display","none"),$("#btnSelect").css("display","none"),$("#btnNewDir").css("display","none"),$("#btnPlayImage").css("display","none"));g_support_html5==0&&$("#btnUpload").css("display","none");g_select_mode==1&&$("#btnCancelSelect").css("display","block");g_upload_mode==1&&$("#btnCancelUpload").css("display","block");f==1&&e==0?$("#btnChangeUser").css("display","block"):$("#btnChangeUser").css("display","none");$("span#username").text(a);g_storage.set("openurl",c);$("div#hostview").scrollTop(g_storage.get("hostviewscrollTop"));
$("div#fileview").scrollLeft(g_storage.get("contentscrollLeft"));$("div#fileview").scrollTop(g_storage.get("contentscrollTop"));adjustLayout();closeJqmWindow(0);b!=void 0&&b()}else a==501?doPROPFIND(c):a==401?setTimeout(openLoginWindow(c),1E3):alert(m.getString(a));showHideLoadStatus(!1)}},null,1),resetTimer()}catch(e){alert("catch error: "+e)}}}
function doLOGIN(c,b){doPROPFIND(c,function(){g_storage.set("openhostuid",g_opening_uid);$("#hostview .host_item").each(function(){$(this).attr("uid")==g_opening_uid?$(this).addClass("select"):$(this).removeClass("select")});g_opening_uid=""},b)}
...
d.documentElement.getAttribute("computername");d.documentElement.getAttribute("isusb");for(d=0;d<a.length;d++){var k="",j="",s="",u="",p="",w="",z="",t="",v="",A="",B="",C="",D="",q,r=a[d].childNodes;for(h=0;h<r.length;h++)if(r[h].nodeType==1&&r[h].nodeName=="D:propstat"){var x=r[h].childNodes;for(f=0;f<x.length;f++)if(x[f].nodeName=="D:prop"){var n=x[f].childNodes;for(g=0;g<n.length;g++)if(!(n[g].childNodes.length<=0))if(n[g].nodeName=="D:getcontenttype")j=String(n[g].childNodes[0].nodeValue);else if(n[g].nodeName==
"D:getuniqueid")s=String(n[g].childNodes[0].nodeValue);else if(n[g].nodeName=="D:getonline")w=String(n[g].childNodes[0].nodeValue);else if(n[g].nodeName=="D:getlastmodified")z=String(n[g].childNodes[0].nodeValue);else if(n[g].nodeName=="D:getcontentlength")t=String(size_format(parseInt(n[g].childNodes[0].nodeValue)));else if(n[g].nodeName=="D:getmac")A=String(n[g].childNodes[0].nodeValue);else if(n[g].nodeName=="D:getip")v=String(n[g].childNodes[0].nodeValue);else if(n[g].nodeName=="D:gettype")B=
String(n[g].childNodes[0].nodeValue);else if(n[g].nodeName=="D:getattr"){var l=n[g].childNodes;for(i=0;i<l.length;i++)if(l[i].nodeName=="D:readonly")C=l[i].childNodes[0].nodeValue;else if(l[i].nodeName=="D:hidden")D=l[i].childNodes[0].nodeValue}}}else r[h].nodeType==1&&r[h].nodeName=="D:href"&&(k=String(r[h].childNodes[0].nodeValue),f="",k.match(/^http/)&&(f=window.location.protocol+"//"+window.location.host),g=f+addPathSlash("/"),k!=g?(k=k.replace(f,""),u=k.substring(k.lastIndexOf("/")+1,k.length),
u!=""?(q=u,p=u=mydecodeURI(u),f=g_listview==0?12:45,p.length>f&&(p=p.substring(0,f)+"...")):k=""):k="");k!=""&&j=="httpd/unix-directory"&&b.push({contenttype:j,href:k,name:u,uname:q,shortname:p,online:w,time:z,size:t,ip:v,mac:A,uid:s,type:B,freadonly:C,fhidden:D})}b.sort(sortByName);for(q=0;q<b.length;q++)b[q].type=="usbdisk"&&arraymove(b,q,0);createHostList(c,b)}},null,1)}catch(c){alert("catch error: "+c)}}
...
var i=g_storage.get("openhostuid");$("#hostview .host_item").each(function(){$(this).attr("uid")==i?$(this).addClass("select"):$(this).removeClass("select")});$("#hostview .host_item").click(function(){if($(this).attr("online")==0)confirm(m.getString("wol_msg"))==!0&&client.WOL("/",$(this).attr("mac"),function(a){a==200?alert(m.getString("wol_ok_msg")):alert(m.getString("wol_fail_msg"))});else{g_opening_uid=$(this).attr("uid");var a=$(this).attr("uhref");g_storage.set("opentype",$(this).attr("type")==
"usbdisk"?"1":"0");doPROPFIND(a,function(){g_storage.set("openhostuid",g_opening_uid);$("#hostview .host_item").each(function(){$(this).attr("uid")==g_opening_uid?$(this).addClass("select"):$(this).removeClass("select")});g_opening_uid=""},null)}})}
...
a[b].online=="1"?'<div id="fileviewicon" class="computerDiv bicon">':'<div id="fileviewicon" class="computerOffDiv bicon">':'<div id="fileviewicon" class="folderDiv bicon">';d+='<div class="selectDiv sicon"></div>';d+='<div class="selectHintDiv sicon"></div>';d+="</div></div>";d+="</td></tr>";d+="<tr><td>";d+='<div class="albuminfo">';d+='<a id="list_item" qtype="';d+=c;d+='" isdir="1" uhref="';d+=a[b].href;d+='" title="';d+=a[b].name;d+='" online="';d+=a[b].online;d+='" ip="" mac="';d+=a[b].mac;
d+='" uid="';d+=a[b].uid;d+='" freadonly="';d+=a[b].freadonly;d+='" fhidden="';d+=a[b].fhidden;d+=a[b].type=="usbdisk"?'" isusb="1"':'" isusb="0"';d+='">';d+=a[b].shortname;a[b].online=="0"&&c=="2"&&(d+="("+m.getString("title_offline")+")");d+="</a>";d+="</div>";d+="</td></tr>";d+="</tbody>";d+="</table>";d+="</div>";a[b].type=="usbdisk"&&c==1&&client.GETDISKSPACE("/",a[b].name,function(a,b,c){a==200&&(a=parseXml(c),b=$(a),a=$('a#list_item[title="'+b.find("DiskName").text()+'"]').parents(".albumDiv"),
b=a.attr("title")+"\n"+m.getString("table_diskusedpercent")+": "+b.find("DiskUsedPercent").text(),a.attr("title",b))})}for(b=0;b<e.length;b++)h=m.getString("table_filename")+": "+e[b].name+"\n"+m.getString("table_time")+": "+e[b].time+"\n"+m.getString("table_size")+": "+e[b].size,d+='<div class="albumDiv"',d+=' title="',d+=h,d+='">',d+='<table class="thumb-table-parent">',d+="<tbody>",a=getFileExt(String(e[b].href)),a.length>5&&(a=""),d+="<tr><td>",d+=c=="0"?'<div class="picDiv" popupmenu="1" uhref="':
'<div class="picDiv" popupmenu="0" uhref="',d+=e[b].href,d+='">',d+=a=="jpg"||a=="jpeg"||a=="png"||a=="gif"||a=="bmp"?'<div id="fileviewicon" class="imgfileDiv bicon">':a=="mp3"||a=="m4a"||a=="m4r"||a=="wav"?'<div id="fileviewicon" class="audiofileDiv bicon">':a=="mp4"||a=="rmvb"||a=="m4v"||a=="wmv"||a=="avi"||a=="mpg"||a=="mpeg"||a=="mkv"||a=="mov"||a=="flv"||a=="3gp"||a=="m2v"||a=="rm"?'<div id="fileviewicon" class="videofileDiv bicon">':a=="doc"||a=="docx"?'<div id="fileviewicon" class="docfileDiv bicon">':
a=="ppt"||a=="pptx"?'<div id="fileviewicon" class="pptfileDiv bicon">':a=="xls"||a=="xlsx"?'<div id="fileviewicon" class="xlsfileDiv bicon">':a=="pdf"?'<div id="fileviewicon" class="pdffileDiv bicon">':'<div id="fileviewicon" class="fileDiv bicon">',d+='<div class="selectDiv sicon"></div>',d+='<div class="selectHintDiv sicon"></div>',d+="</div></div>",d+="</td></tr>",d+="<tr><td>",d+='<div class="albuminfo" style="font-size:80%">',d+='<a id="list_item" qtype="1" isdir="0" uhref="',d+=e[b].href,d+=
'" title="',d+=e[b].name,d+='" uid="',d+=e[b].uid,d+='" ext="',d+=a,d+='" freadonly="',d+=e[b].freadonly,d+='" fhidden="',d+=e[b].fhidden,d+='">',d+=e[b].shortname,d+="</a>",d+="</div>",d+="</td></tr>",d+="</tbody>",d+="</table>",d+="</div>";$("#main_right_container #fileview").append(d);$(".picDiv").mousedown(onMouseDownPicDIVHandler)}}function sortByName(c,b){var a=c.name.toLowerCase(),e=b.name.toLowerCase();return a<e?-1:a>e?1:0}
function arraymove(c,b,a){var e=c[b];c.splice(b,1);c.splice(a,0,e)}function showHideLoadStatus(c){c?$("#loading").css("display","block"):$("#loading").css("display","none")}
...
null;g_select_array=[];var b=0,a=0;$("#fileview").find(".albumDiv").each(function(){if($(this).find(".selectDiv").css("display")=="block"){var c=$(this).find("#list_item").attr("uhref"),d=$(this).find("#list_item").attr("isdir"),h=myencodeURI($(this).find("#list_item").attr("title"));d==1?a++:b++;g_select_array.push({isdir:d,uhref:c,title:h})}});b>=1?$("#btnDownload").removeClass("disable"):$("#btnDownload").addClass("disable");$("#btnShareLink").removeClass("disable");b>0||a>0?$("#btnDeleteSel").removeClass("disable"):
$("#btnDeleteSel").addClass("disable");b+a==1?$("#btnRename").removeClass("disable"):$("#btnRename").addClass("disable")}else openSelItem($(this).parents(".thumb-table-parent").find("a#list_item"))}
...
function createLayout(){var c=String(window.navigator.userLanguage||window.navigator.language).toLowerCase(),c=g_storage.get("lan")==void 0?c:g_storage.get("lan");m.setLanguage(c);var b="";b+="<div id='header_region' class='unselectable' width='100%' border='0'>";b+="<div id='logo'></div>";b+="<div id='user'>Welcome home, <span id='username'></span><span id='login_info'></span>";b+="</div>";b+="<div id='loading'><img src='/smb/css/load.gif'/><div><span>Loading...</span></div></div>";b+="<ul class='navigation' id='lan'>";
b+="<li>";b+="<dl>";b+="<dt><a id='"+c+"'>"+m.getString("lan_"+c)+"</a></dt>";for(var a=0;a<g_support_lan.length;a++)g_support_lan[a]!=c&&(b+="<dd><a id='"+g_support_lan[a]+"'>"+m.getString("lan_"+g_support_lan[a])+"</a></dt>");b+="</dl>";b+="</li>";b+="<ul>";b+="</div>";b+="<div id='main_region' class='unselectable'>";b+="<div id='main_left_region' class='unselectable'>";b+="<div id='infobar' class='unselectable'></div>";b+="<div id='hostview' class='unselectable'></div>";b+="</div>";b+="<div id='main_right_region' class='unselectable'>";
b+="<div id='main_right_container' class='unselectable'>";b+="<div id='infobar' class='unselectable'>";b+="<div id='toolbar' class='unselectable'>";b+="<div id='urlregion-url'>";b+="<p id='openurl' align='left' width='150' style='padding-left:10px' ></p>";b+="</div>";b+="<div class='albutton toolbar-button-right' id='btnUpload' style='display:none'><div class='ticon'></div></div>";b+="<div class='albutton toolbar-button-right' id='btnPlayImage' style='display:none'><div class='ticon'></div></div>";
...
b+="<div class='abbutton toolbar-button-right disable' id='btnRename' style='display:block'><div class='ticon'></div></div>";b+="</div>";b+="<div id='upload_panel' class='unselectable'>";b+="<div style='position:absolute;width:98%;height:100%;padding:10px'>";b+="<iframe src='' width='100%' height='100%' frameborder='0'/>";b+="</div>";b+="</div>";b+="</div>";b+="</div>";b+="</div>";b+="<div id='bottom_region' class='unselectable'>";b+="<ul class='navigation' id='setting'>";b+="<li>";b+="<dl>";b+="<dd><a id='help'>"+
m.getString("title_help")+"</a></dt>";b+="<dd><a id='version'>"+m.getString("title_version")+"</a></dt>";b+="<dd><a id='sharelink'>"+m.getString("title_sharelink")+"</a></dt>";b+="<dd><a id='rescan_samba'>"+m.getString("title_rescan")+"</a></dt>";b+="<dd><a id='config'>"+m.getString("btn_config")+"</a></dt>";b+="<dd><a id='favorite'>"+m.getString("btn_favorite")+"</a></dt>";b+="<dd><a id='logout'>"+m.getString("title_logout")+"</a></dt>";b+="<dt><a>"+m.getString("title_setting")+"</a></dt>";b+="</dl>";
b+="</li>";b+="</ul>";b+="<ul class='navigation' id='refresh'>";b+="<li>";b+="<dl>";b+="<dt><a>"+m.getString("btn_refresh")+"</a></dt>";b+="</dl>";b+="</li>";b+="</ul>";b+="<ul class='themes'>";b+="<span>"+m.getString("title_skin")+"</span>";b+="<span id='skin1' class='themes_ctrl'></span>";b+="<span id='skin2' class='themes_ctrl'></span>";b+="</ul>";b+="<ul class='func_help'>";b+="<span id='function_help'></span>";b+="</ul>";b+="<span id='right_info'>ASUSTeK Computer Inc. All rights reserved</span>";
b+="</div>";b+="<div id='modalWindow' class='jqmWindow'>";b+="<div id='jqmTitle'>";b+="<span id='jqmTitleText'></span>";b+="</div>";b+="<div id='jqmMsg'>";b+="<span id='jqmMsgText'></span>";b+="</div>";b+="<div id='jqmContent' style='padding;0px;margin:0px'>";b+="</div>";b+="</div>";$("body").empty();$("body").append(b);$("span#username").click(function(){confirm(m.getString("msg_logout_confirm"))==!0&&doLOGOUT()});c=g_storage.getl("skin")==void 0?"skin1":g_storage.getl("skin");c=="skin1"?$("#mainCss").attr("href",
"/smb/css/style-metro.css"):c=="skin2"&&$("#mainCss").attr("href","/smb/css/style-metro2.css");$("#btnHelp").attr("title",m.getString("title_help"));$("#btnLogout").attr("title",m.getString("title_logout"));$("#btnConfig").attr("title",m.getString("btn_config"));$("#btnUpload").attr("title",m.getString("btn_upload"));$("#btnCancelUpload").attr("title",m.getString("btn_cancelupload"));$("#btnSelect").attr("title",m.getString("btn_select"));$("#btnCancelSelect").attr("title",m.getString("btn_cancelselect"));
$("#btnNewDir").attr("title",m.getString("btn_newdir"));$("#btnShareLink").attr("title",m.getString("btn_sharelink"));$("#btnDeleteSel").attr("title",m.getString("btn_delselect"));$("#btnDownload").attr("title",m.getString("func_download"));$("#btnRename").attr("title",m.getString("btn_rename"));$("#btnSetting").attr("title",m.getString("title_setting"));$("#btnRefresh").attr("title",m.getString("btn_refresh"))}
...
-1)b="CTRL + B";else if(window.home||a||e)b=(e?"Command/Cmd":"CTRL")+" + D";b=b?m.getString("msg_add_favorite1")+b+m.getString("msg_add_favorite2"):b;alert(b)}}
$(document).ready(function(){function c(a){a&&a[0]!=2?alert(m.getString(a)+" : "+decodeURI(g_selected_files[0])):(g_selected_files.splice(0,1),g_selected_files.length<=0?(a=addPathSlash(g_storage.get("openurl")),doPROPFIND(a)):client.DELETE(g_selected_files[0],c))}document.oncontextmenu=function(){return!1};document.onmousedown=function(){resetTimer()};document.onmousemove=function(){resetTimer()};$(document).keydown(function(a){a.keyCode==27&&(g_select_mode==1?cancelSelectMode():g_upload_mode==1&&
...
String(a.find("misc_http_port").text()).replace("\n","")),g_storage.set("last_login_info",a.find("last_login_info").text()),g_storage.set("ddns_host_name",a.find("ddns_host_name").text()),g_storage.set("router_version",a.find("version").text()),a=g_storage.get("last_login_info"),a!=""&&a!=void 0&&(a=String(a).split(">"),a=m.getString("title_logininfo")+a[1]+", "+m.getString("title_ip")+a[2],$("#login_info").text(a)))})})();var b=g_storage.get("openurl");g_storage.set("HostList","");doPROPFIND("/",
function(){b!=void 0&&b!="/"&&doPROPFIND(b);if(g_storage.get("openhostuid")==void 0||g_storage.get("openhostuid")==0){var a="<div id='help_1'>";a+="<div id='help_content'>";a+=m.getString("msg_help");a+="</div>";a+="<div id='help_image'>";a+="</div>";a+="</div>";$("div#fileview").append(a)}},0);$("#modalWindow").jqm({overlay:70,modal:!0,target:"#jqmContent",onHide:function(a){$(a.w).fadeOut("2000",function(){a.o.remove();g_show_modal=0;if(g_reload_page==1){var b=addPathSlash(g_storage.get("openurl"));
doPROPFIND(b)}})},onShow:function(a){var a=$(a.w),b=$("#jqmContent",a);$("#jqmTitle",a);var c=(getPageSize()[0]-g_modal_window_width)/2;g_show_modal=1;navigator.userAgent.toLowerCase().indexOf("msie");var h=function(){var a=-1;navigator.appName=="Microsoft Internet Explorer"&&/MSIE ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent)!=null&&(a=parseFloat(RegExp.$1));return a};g_modal_url!=""&&(b.empty(),$("<iframe src='' frameborder='0' width='100%' height='100%'>").appendTo(b),$("iframe",a).attr("src",
g_modal_url));isBrowser("msie")&&h()<=8&&(g_modal_window_height+=25);a.css({width:g_modal_window_width,height:g_modal_window_height,left:c,top:-g_modal_window_height,opacity:0}).jqmShow().animate({width:g_modal_window_width,height:g_modal_window_height,top:0,left:c,marginLeft:0,opacity:1},200,function(){adjustLayout()})}});$("div#btnDeleteSel").click(function(){if(!(g_select_array.length<=0)&&confirm(m.getString("del_files_msg"))==!0){g_selected_files=null;g_selected_files=[];for(var a=0;a<g_select_array.length;a++)g_selected_files.push(g_select_array[a].uhref);
...
b[d],d!=c-1&&(a+="<br><br>");b=$("div#modalWindow");g_modal_url="/smb/css/sharelink.html?v="+a+"&b="+k;g_modal_window_width=600;g_modal_window_height=500;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_sharelink"));b&&b.jqmShow()}})}});$("div#btnDownload").click(function(){if(!(g_select_array.length<=0))for(var a=0;a<g_select_array.length;a++){var b=g_select_array[a].title,c=g_select_array[a].uhref,h=window.location.href;g_select_array[a].isdir!=1&&(h=c.substring(0,c.lastIndexOf("/")),
$.fileDownload(h+"/"+b,{successCallback:function(){},failCallback:function(a,b){window.open(b)}}))}});$("div#btnRename").click(function(){if(g_select_array.length==1){var a=g_select_array[0].title,b=g_select_array[0].uhref,c=g_select_array[0].isdir,h=$("div#modalWindow");g_modal_url="/smb/css/rename.html?o="+a+"&f="+b+"&d="+c;g_modal_window_width=500;g_modal_window_height=80;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_rename"));h&&h.jqmShow()}});$("div#btnChangeUser").click(function(){$("#main_right_container #fileview").empty();
var a=g_storage.get("openurl");client.LOGOUT(a,function(b){b==200&&doPROPFIND(a)})});$("div#btnSelect").click(function(){g_select_mode=1;$("div#btnNewDir").css("display","none");$("div#btnUpload").css("display","none");$("div#btnSelect").css("display","none");$("#btnPlayImage").css("display","none");var a=$("div#btnNewDir").width()+$("div#btnUpload").width()+5;$("div#btnCancelSelect").css("display","block");$("div#btnCancelSelect").css("right",a);g_on_button_animation=1;$("div#btnCancelSelect").animate({right:5},
...
"none");$("div#btnSelect").css("display","block");$("div#btnSelect").css("right",5);g_on_button_animation=1;$("div#btnSelect").animate({right:85},500,function(){cancelSelectMode();$("div#btnSelect").css("right",5);g_on_button_animation=0})});$("#btnUpload").click(function(){g_upload_mode=1;$("div#btnNewDir").css("display","none");$("div#btnUpload").css("display","none");$("div#btnSelect").css("display","none");$("#btnPlayImage").css("display","none");$("div#btnCancelUpload").css("display","block");
$("#upload_panel").css("display","block");$("#upload_panel").css("left","1999px");$("#upload_panel").animate({left:"0px"},"slow");var a=addPathSlash(g_storage.get("openurl"));$("#upload_panel iframe").attr("src","/smb/css/upload.html?u="+a);$("#function_help").text(m.getString("msg_uploadmode_help"));adjustLayout()});$("#btnCancelUpload").click(closeUploadPanel);$("div#hostview").scroll(function(){g_storage.set("hostviewscrollTop",$(this).scrollTop())});$("div#fileview").scroll(function(){g_storage.set("contentscrollLeft",
$(this).scrollLeft());g_storage.set("contentscrollTop",$(this).scrollTop())});$(".navigation#lan dd a").click(function(){var a=$(this).attr("id");g_storage.set("lan",a);window.location.reload()});$(".navigation#setting dd a").click(function(){var a=$(this).attr("id");if(a=="logout")confirm(m.getString("msg_logout_confirm"))==!0&&doLOGOUT();else if(a=="favorite")addtoFavorite();else if(a=="config"){var a=g_storage.get("misc_http_enable"),b=g_storage.get("misc_http_port"),c=window.location.host;a==
0&&!isPrivateIP()?alert(m.getString("msg_no_config")):(a=isPrivateIP()?"http://"+c.split(":")[0]:"http://"+c.split(":")[0]+":"+b,window.location=a)}else a=="help"?(a=getPageSize(),b=$("div#modalWindow"),g_modal_window_height=a[1]-30,g_modal_window_width=g_modal_window_height*1.28,g_modal_window_width>a[0]&&(g_modal_window_width=a[0],g_modal_window_height=g_modal_window_width*0.78125),g_modal_url="/smb/css/help.html?showbutton=1",$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_help")),
b&&b.jqmShow()):a=="rescan_samba"?doRescanSamba():a=="sharelink"?(b=$("div#modalWindow"),g_modal_url="/smb/css/setting.html?p=1",g_modal_window_width=800,g_modal_window_height=530,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),b&&b.jqmShow()):a=="version"&&(b=$("div#modalWindow"),g_modal_url="/smb/css/setting.html?p=2",g_modal_window_width=800,g_modal_window_height=530,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),
b&&b.jqmShow())});$(".navigation#refresh dt a").click(function(){var a=g_storage.get("openurl");g_storage.set("HostList","");doPROPFIND("/",function(){a=a==void 0?"/":a;a!="/"&&doPROPFIND(a)},0)});$(".themes_ctrl").click(function(){var a=$(this).attr("id");g_storage.setl("skin",a);window.location.reload()});$("#btnPlayImage").click(function(){openImageViewer()});$(window).resize(adjustLayout)});
