...
function doRENAME(a,b,c){var e=0,f=addPathSlash(g_storage.get("openurl")),j=f+b;$(".wcb").each(function(){b==myencodeURI($(this).attr("data-name"))&&(e=1,$(this).attr("isdir")=="1"?alert(m.getString("folder_already_exist_msg")):alert(m.getString("file_already_exist_msg")))});e==1?c&&c():g_webdav_client.LOCK(a,"",function(e,b,h){if(e!="201")alert(m.getString("msg_already_lock")),c&&c();else{var l=getLockToken(h);g_webdav_client.MOVE(a,j,function(e){e[0]==2?(doPROPFIND(f),closeJqmWindow(0)):(alert(m.getString(e)),
c&&c());g_webdav_client.UNLOCK(a,l,function(a){a!=204&&alert("Unlock error: "+a);c&&c()})},null,!1,l)}},null)}
...
function doPROPFINDMEDIALIST(a,b,c,e,f,j,d,g,h,l){if(g_webdav_client!=null){showHideLoadStatus(!0);showHideEditUIRegion(!1);try{g_webdav_client.PROPFINDMEDIALIST(a,function(f,j,n){if(f){if(f==207){showHideSelectModeUI(!1);closeUploadPanel();var l=content2XMLDOM(n),n=1,o=f=0,j="Idle";b||(g_folder_array=null,g_folder_array=[],g_file_array=null,g_file_array=[]);l&&(n=1,f=parseInt(l.documentElement.getAttribute("qcount")),parseInt(l.documentElement.getAttribute("qstart")),o=parseInt(l.documentElement.getAttribute("qend")),
j=l.documentElement.getAttribute("scan_status"),parserPropfindXML(l,a,b));l="";g_ui_mode.get()==1||g_ui_mode.get()==2||g_ui_mode.get()==3?n=0:g_ui_mode.get()==6?(n=0,l="goto:music_album"):g_ui_mode.get()==7&&(n=0,l="goto:music_artist");var k=g_list_view.get()==1?"listview":"thumbview";create_ui_view(k,$("#main_right_container #fileview"),n,l,g_folder_array,g_file_array,onMouseDownListDIVHandler);f>o&&(n=o+1,o=n+50,o>f&&(o=f),l="<div class='nextDiv' start='"+n+"' end='"+o+"'><span>",k=m.getString("title_next_query"),
k=k.replace("%s",n+"-"+o),k=k.replace("%s",f),l+=k,l+="</span></div>",$("#main_right_container #fileview").append(l),$(".nextDiv").click(function(){doPROPFINDMEDIALIST(a,!0,null,e,$(this).attr("start"),$(this).attr("end"),d,g,h)}));j=="Scanning"?($("#main_right_container #hintbar").text(m.getString("msg_dms_scanning")),$("#main_right_container #hintbar").show()):$("#main_right_container #hintbar").hide();g_storage.set("aimode",e);$("div#btnUpload").css("display","none");$("div#btnNewDir").css("display",
...
f==401?setTimeout(function(){openLoginWindow(a)},2E3):alert(m.getString(f));showHideLoadStatus(!1)}},null,e,f,j,d,g,h,l),resetTimer()}catch(n){alert("catch error: "+n)}}}
function parserPropfindXML(a,b,c){if(a){c==!1&&(g_file_array=g_folder_array=null);g_folder_array==null&&(g_folder_array=[]);g_file_array==null&&(g_file_array=[]);for(var e,f,j,d=a.documentElement.childNodes,a=0;a<d.length;a++){var g="",h="",l="",n="",r="",w="",y="",s="",o="",k="",u="",z="",v="",t;j="";for(var x="0",B="",C="0",D=d[a].childNodes,c=0;c<D.length;c++)if(D[c].nodeType==1&&D[c].nodeName=="D:propstat"){var q=D[c].childNodes;for(e=0;e<q.length;e++)if(q[e].nodeName=="D:prop"){var p=q[e].childNodes;
for(f=0;f<p.length;f++)if(!(p[f].childNodes.length<=0))if(p[f].nodeName=="D:getcontenttype")h=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getuniqueid")l=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getonline")w=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getlastmodified")y=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getcontentlength")s=String(size_format(parseInt(p[f].childNodes[0].nodeValue)));else if(p[f].nodeName=="D:getmac")k=
...
1,g.length),n!=""?(t=n,r=n=mydecodeURI(n)):g=""):g="");g!=""&&(h=="httpd/unix-directory"?g_folder_array.push({contenttype:h,href:g,name:n,uname:t,shortname:r,online:w,time:y,size:s,ip:o,mac:k,uid:l,type:u,freadonly:z,fhidden:v,routersyncfolder:x,matadatatitle:B,thumb:C}):g_file_array.push({contenttype:h,href:g,name:n,uname:t,shortname:r,online:w,time:y,size:s,ip:o,mac:k,uid:l,type:u,freadonly:z,fhidden:v,routersyncfolder:x,matadatatitle:B,thumb:C}))}}}
...
f.documentElement.getAttribute("computername");f.documentElement.getAttribute("isusb");for(f=0;f<c.length;f++){var l="",n="",r="",w="",y="",s="",o="",k="",u="",z="",v="",t="",x="",B,C=c[f].childNodes;for(j=0;j<C.length;j++)if(C[j].nodeType==1&&C[j].nodeName=="D:propstat"){var D=C[j].childNodes;for(d=0;d<D.length;d++)if(D[d].nodeName=="D:prop"){var q=D[d].childNodes;for(g=0;g<q.length;g++)if(!(q[g].childNodes.length<=0))if(q[g].nodeName=="D:getcontenttype")n=String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName==
"D:getuniqueid")r=String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName=="D:getonline")s=String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName=="D:getlastmodified")o=String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName=="D:getcontentlength")k=String(size_format(parseInt(q[g].childNodes[0].nodeValue)));else if(q[g].nodeName=="D:getmac")z=String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName=="D:getip")u=String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName=="D:gettype")v=
String(q[g].childNodes[0].nodeValue);else if(q[g].nodeName=="D:getattr"){var p=q[g].childNodes;for(h=0;h<p.length;h++)if(p[h].nodeName=="D:readonly")t=p[h].childNodes[0].nodeValue;else if(p[h].nodeName=="D:hidden")x=p[h].childNodes[0].nodeValue}}}else C[j].nodeType==1&&C[j].nodeName=="D:href"&&(l=String(C[j].childNodes[0].nodeValue),d="",l.match(/^http/)&&(d=window.location.protocol+"//"+window.location.host),g=d+addPathSlash("/"),l!=g?(l=l.replace(d,""),w=l.substring(l.lastIndexOf("/")+1,l.length),
w!=""?(B=w,y=w=mydecodeURI(w),d=g_list_view.get()==0?12:45,y.length>d&&(y=y.substring(0,d)+"...")):l=""):l="");l!=""&&n=="httpd/unix-directory"&&a.push({contenttype:n,href:l,name:w,uname:B,shortname:y,online:s,time:o,size:k,ip:u,mac:z,uid:r,type:v,freadonly:t,fhidden:x})}a.sort(sortByName);for(B=0;B<a.length;B++)a[B].type=="usbdisk"&&arraymove(a,B,0);createHostList(e,a)}},null,1)}catch(a){alert("catch error: "+a)}}
...
h.indexOf(":")!=-1&&(h=h.substring(0,h.indexOf(":")));var h="http://"+h+":"+g_storage.get("http_port")+"/",l=a.attr("matadatatitle");g_webdav_client.GSL(this_url,this_url,d,0,0,function(a,e,b){a==200&&(a=parseXml(b),a=$(a).find("sharelink").text(),e="",e="/smb/css/vlc_video.html?v="+h+a+"&u="+this_url,e+="&t="+l,e+="&showbutton=1",g_modal_url=e,g_modal_window_width=655,g_modal_window_height=580,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_videoplayer")),g&&g.jqmShow())})}return}if(c==
...
g_modal_window_height=80;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_newdir"));a&&a.jqmShow()});$("div#btnDownload").click(function(){if($(this).hasClass("disable"))return!1;if(!(g_select_array.length<=0)){for(var a=[],b=0;b<g_select_array.length;b++){var c=g_select_array[b].title,d=g_select_array[b].uhref,g=g_select_array[b].isdir,h=window.location.href,h=d.substring(0,d.lastIndexOf("/")),c=h+"/"+c;g==1?a.push(c):download_file(c)}download_folder(a)}});$("div#btnRename").click(function(){if($(this).hasClass("disable"))return!1;
...
b+"?mobile=1"}else if(a=="favorite")addtoFavorite();else if(a=="config"){var a=parseInt(g_storage.get("http_enable")),b=parseInt(g_storage.get("misc_http_enable")),c=g_storage.get("misc_http_port"),d=g_storage.get("misc_https_port"),g=g_storage.get("lan_https_port"),h=window.location.host,l="http",n=c;b==0&&!isPrivateIP()?alert(m.getString("msg_no_config")):(a==1?(l="https",n=d):(l="http",n=c),isPrivateIP()?(b=l+"://"+h.split(":")[0],a==1&&(b+=":"+g)):(b=l+"://"+h.split(":")[0],n!=""&&(b+=":"+n)),
window.location=b)}else a=="rescan_samba"?confirmCancelUploadFile()!=0&&(a=confirm(m.getString("title_desc_rescan")),a==!0&&doRescanSamba()):a=="sharelink"?(a=$("div#modalWindow"),g=getPageSize(),g_modal_url="/smb/css/setting.html?p=1&s=1",g_modal_window_width=800,g_modal_window_height=g[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),a&&a.jqmShow()):a=="version"?(a=$("div#modalWindow"),g=getPageSize(),g_modal_url="/smb/css/setting.html?p=2&s=1",g_modal_window_width=
800,g_modal_window_height=g[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),a&&a.jqmShow()):a=="crt"?(a=$("div#modalWindow"),g=getPageSize(),g_modal_url="/smb/css/setting.html?p=3&s=1",g_modal_window_width=800,g_modal_window_height=g[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_crt")),a&&a.jqmShow()):a=="community"?(a=$("div#modalWindow"),g=getPageSize(),g_modal_url="/smb/css/setting.html?p=4&s=1",g_modal_window_width=
...
e[g].split("|");c+="<div class='host_item unselectable";h[2]==0&&(c+=" offline");h[8]=="usbdisk"&&(c+=" usbdisk");c+="' uhref='";c+=h[0];c+="' title='";c+=h[1]+" - "+h[3];c+="' online='";c+=h[2];c+="' isdir='1'";c+=" ip='";c+=h[3];c+="' mac='";c+=h[4];c+="' uid='";c+=h[5];c+="' freadonly='";c+=h[6];c+="' fhidden='";c+=h[7];c+=h[8]=="usbdisk"?"' isusb='1'":"' isusb='0'";c+=">";c+="<div id='hosticon' class='sicon "+h[8];h[2]==0&&(c+="off");c+="'/>";if(h[8]=="usbdisk"){var l="usbdisk"+(g+10);c+="<div id='hostinfo' class='unselectable "+
l+"'>";g_usbdisk_space_handler.add(l,h[1])}else c+="<div id='hostinfo' class='unselectable'>";c+="<div id='hostname' class='unselectable'>";c+="<p>";c+=h[1];h[2]==0&&(c+="("+m.getString("title_offline")+")");c+="</p>";c+="</div>";h[8]=="usbdisk"&&(c+="<div id='space'>",c+="<div class='progress-bar'>",c+="<span></span>",c+="</div>",c+="</div>");c+="</div>";c+="</div>"}g_usbdisk_space_handler.refresh();f==1&&(c+="<div class='scan_item unselectable rescan'>",c+="<div id='hosticon' class='sicon sambapcrescan'/>",
...
function get_mp3_url(a,b,c){if(a!=""){var e=g_audio_playlist,f=a.split(","),j=0,d=!1;g_audio_playlist=[];for(a=0;a<e.length;a++)for(var g=0;g<f.length;g++)e[a].source==f[g]&&(g_audio_playlist.push(e[a]),f.splice(g,1),g=-1);if(b)var h=window.location.host,h=window.location.protocol+"//"+h+"/",l=setInterval(function(){if(d==!1)if(j<0||j>f.length-1)clearInterval(l),c(g_audio_playlist);else{var a=f[j],b=a.substring(a.lastIndexOf("/")+1,a.length),e=a.substring(0,a.lastIndexOf("/"));d=!0;g_webdav_client.GSL(e,
...
b!=""&&a.setImage(c,b));a._array.shift();a._onLoading=!1})}},100)},stop:function(){this._array=null;clearInterval(this._timer)}};(function(a,b){function c(a){for(var a=a.split(/\s+/),b=[],c=0,d;d=a[c];c++)d=d[0].toUpperCase(),b.push(d);return b}function e(b){return b.id&&a('label[for="'+b.id+'"]').val()||b.name}function f(c,d,t){t||(t=0);d.each(function(){var d=a(this),v=this,g=this.nodeName.toLowerCase(),k,o;g=="label"&&d.find("input, textarea, select").length&&(k=d.text(),d=d.children().first(),v=d.get(0),g=v.nodeName.toLowerCase());switch(g){case "menu":o={name:d.attr("label"),items:{}};t=f(o.items,d.children(),t);break;
...
name:d.attr("label"),radio:d.attr("radiogroup"),value:d.attr("id"),selected:!!d.attr("checked")};break;default:o=b}break;case "hr":o="-------";break;case "input":switch(d.attr("type")){case "text":o={type:"text",name:k||e(v),disabled:!!d.attr("disabled"),value:d.val()};break;case "checkbox":o={type:"checkbox",name:k||e(v),disabled:!!d.attr("disabled"),selected:!!d.attr("checked")};break;case "radio":o={type:"radio",name:k||e(v),disabled:!!d.attr("disabled"),radio:!!d.attr("name"),value:d.val(),selected:!!d.attr("checked")};
break;default:o=b}break;case "select":o={type:"select",name:k||e(v),disabled:!!d.attr("disabled"),selected:d.val(),options:{}};d.children().each(function(){o.options[this.value]=a(this).text()});break;case "textarea":o={type:"textarea",name:k||e(v),disabled:!!d.attr("disabled"),value:d.val()};break;case "label":break;default:o={type:"html",html:d.clone(!0)}}o&&(t++,c["key"+t]=o)});return t}a.support.htmlMenuitem="HTMLMenuItemElement"in window;a.support.htmlCommand="HTMLCommandElement"in window;a.support.eventSelectstart=
"onselectstart"in document.documentElement;if(!a.ui||!a.ui.widget){var j=a.cleanData;a.cleanData=function(b){for(var c=0,d;(d=b[c])!=null;c++)try{a(d).triggerHandler("remove")}catch(e){}j(b)}}var d=null,g=!1,h=a(window),l=0,n={},r={},w={},y={selector:null,appendTo:null,trigger:"right",autoHide:!1,delay:200,reposition:!0,determinePosition:function(b){if(a.ui&&a.ui.position)b.css("display","block").position({my:"center top",at:"center bottom",of:this,offset:"0 5",collision:"fit"}).css("display","none");
...
u.layer.call(b.$menu,b,g.zIndex);b.$menu.find("ul").css("zIndex",g.zIndex+1);b.$menu.css(g)[b.animation.show](b.animation.duration,function(){f.trigger("contextmenu:visible")});f.data("contextMenu",b).addClass("context-menu-active");a(document).off("keydown.contextMenu").on("keydown.contextMenu",k.key);if(b.autoHide)a(document).on("mousemove.contextMenuAutoHide",function(a){var c=f.offset();c.right=c.left+f.outerWidth();c.bottom=c.top+f.outerHeight();b.$layer&&!b.hovering&&(!(a.pageX>=c.left&&a.pageX<=
...
d){d.commands[b]=f;if(a.isFunction(f.callback))d.callbacks[b]=f.callback}),a("<span></span>").html(f._name||f.name||"").appendTo(g)}if(f.type&&f.type!="sub"&&f.type!="html"&&(h.on("focus",k.focusInput).on("blur",k.blurInput),f.events))h.on(f.events,d);f.icon&&g.addClass("icon icon-"+f.icon)}f.$input=h;f.$label=o;g.appendTo(d.$menu);if(!d.hasTypes&&a.support.eventSelectstart)g.on("selectstart.disableTextSelect",k.abortevent)});d.$node||d.$menu.css("display","none").addClass("context-menu-root");d.$menu.appendTo(d.appendTo||
...
c+'; top:0; left:0; opacity: 0; filter: alpha(opacity=0); background-color: #000;"></div>').css({height:h.height(),width:h.width(),display:"block"}).data("contextMenuRoot",b).insertBefore(this).on("contextmenu",k.abortevent).on("mousedown",k.layerClick);a.support.fixedPosition||d.css({position:"absolute",height:a(document).height()});return d}};a.fn.contextMenu=function(c){c===b?this.first().trigger("contextmenu"):c.x&&c.y?this.first().trigger(a.Event("contextmenu",{pageX:c.x,pageY:c.y})):c==="hide"?
...
e.context=o.get(0),h=e.context!==document);switch(c){case "create":if(!e.selector)throw Error("No selector specified");if(e.selector.match(/.context-menu-(list|item|input)($|\s)/))throw Error('Cannot bind to selector "'+e.selector+'" as it contains a reserved className');if(!e.build&&(!e.items||a.isEmptyObject(e.items)))throw Error("No Items specified");l++;e.ns=".contextMenu"+l;if(!h)n[e.selector]=e.ns;r[e.ns]=e;if(!e.trigger)e.trigger="right";g||(f.on({"contextmenu:hide.contextMenu":k.hideMenu,
...
null}f.off(n[e.selector])}}else f.off(".contextMenu .contextMenuAutoHide"),a.each(r,function(b,c){a(c.context).off(c.ns)}),n={},r={},l=0,g=!1,a("#context-menu-layer, .context-menu-list").remove();break;case "html5":(!a.support.htmlCommand&&!a.support.htmlMenuitem||typeof d=="boolean"&&d)&&a('menu[type="context"]').each(function(){this.id&&a.contextMenu({selector:"[contextmenu="+this.id+"]",items:a.contextMenu.fromMenu(this)})}).css("display","none");break;default:throw Error('Unknown operation "'+
...
height:c?b.height():b.outerHeight()}}};a.fn.position=function(b){if(!b||!b.of)return s.apply(this,arguments);var b=a.extend({},b),k,j,z,v,t,x,B=a(b.of),C=a.position.getWithinInfo(b.within),D=a.position.getScrollInfo(C),q=(b.collision||"flip").split(" "),p={};x=f(B);if(B[0].preventDefault)b.at="left top";j=x.width;z=x.height;v=x.offset;t=a.extend({},v);a.each(["my","at"],function(){var a=(b[this]||"").split(" "),c,d;a.length===1&&(a=l.test(a[0])?a.concat(["center"]):n.test(a[0])?["center"].concat(a):
["center","center"]);a[0]=l.test(a[0])?a[0]:"center";a[1]=n.test(a[1])?a[1]:"center";c=r.exec(a[0]);d=r.exec(a[1]);p[this]=[c?c[0]:0,d?d[0]:0];b[this]=[w.exec(a[0])[0],w.exec(a[1])[0]]});q.length===1&&(q[1]=q[0]);b.at[0]==="right"?t.left+=j:b.at[0]==="center"&&(t.left+=j/2);b.at[1]==="bottom"?t.top+=z:b.at[1]==="center"&&(t.top+=z/2);k=c(p.at,j,z);t.left+=k[0];t.top+=k[1];return this.each(function(){var f,l,n=a(this),x=n.outerWidth(),r=n.outerHeight(),s=e(this,"marginLeft"),w=e(this,"marginTop"),
...
collisionPosition:f,collisionWidth:y,collisionHeight:G,offset:[k[0]+F[0],k[1]+F[1]],my:b.my,at:b.at,within:C,elem:n})});b.using&&(l=function(a){var c=v.left-A.left,e=c+j-x,f=v.top-A.top,h=f+z-r,k={target:{element:B,left:v.left,top:v.top,width:j,height:z},element:{element:n,left:A.left,top:A.top,width:x,height:r},horizontal:e<0?"left":c>0?"right":"center",vertical:h<0?"top":f>0?"bottom":"middle"};if(j<x&&g(c+e)<j)k.horizontal="center";if(z<r&&g(f+h)<z)k.vertical="middle";k.important=d(g(c),g(e))>d(g(f),
g(h))?"horizontal":"vertical";b.using.call(this,a,k)});n.offset(a.extend(A,{using:l}))})};a.ui.position={fit:{left:function(a,b){var c=b.within,e=c.isWindow?c.scrollLeft:c.offset.left,f=c.width,g=a.left-b.collisionPosition.marginLeft,c=e-g,h=g+b.collisionWidth-f-e;b.collisionWidth>f?c>0&&h<=0?(e=a.left+c+b.collisionWidth-f-e,a.left+=c-e):a.left=h>0&&c<=0?e:c>h?e+f-b.collisionWidth:e:c>0?a.left+=c:h>0?a.left-=h:a.left=d(a.left-g,a.left)},top:function(a,b){var c=b.within,e=c.isWindow?c.scrollTop:c.offset.top,
...
0,l=b.at[0]==="left"?b.targetWidth:b.at[0]==="right"?-b.targetWidth:0,n=-2*b.offset[0];if(c<0){if(d=a.left+h+l+n+b.collisionWidth-e-d,d<0||d<g(c))a.left+=h+l+n}else if(j>0&&(d=a.left-b.collisionPosition.marginLeft+h+l+n-f,d>0||g(d)<j))a.left+=h+l+n},top:function(a,b){var c=b.within,d=c.offset.top+c.scrollTop,e=c.height,f=c.isWindow?c.scrollTop:c.offset.top,h=a.top-b.collisionPosition.marginTop,c=h-f,j=h+b.collisionHeight-e-f,h=b.my[1]==="top"?-b.elemHeight:b.my[1]==="bottom"?b.elemHeight:0,l=b.at[1]===
"top"?b.targetHeight:b.at[1]==="bottom"?-b.targetHeight:0,n=-2*b.offset[1];if(c<0){if(d=a.top+h+l+n+b.collisionHeight-e-d,a.top+h+l+n>c&&(d<0||d<g(c)))a.top+=h+l+n}else if(j>0&&(d=a.top-b.collisionPosition.marginTop+h+l+n-f,a.top+h+l+n>j&&(d>0||g(d)<j)))a.top+=h+l+n}},flipfit:{left:function(){a.ui.position.flip.left.apply(this,arguments);a.ui.position.fit.left.apply(this,arguments)},top:function(){a.ui.position.flip.top.apply(this,arguments);a.ui.position.fit.top.apply(this,arguments)}}};(function(){var b,
