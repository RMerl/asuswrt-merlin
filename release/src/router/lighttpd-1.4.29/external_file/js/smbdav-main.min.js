...
25);a.css({width:g_modal_window_width,height:g_modal_window_height,left:c,top:-g_modal_window_height,opacity:0,display:"block"}).jqmShow().animate({width:g_modal_window_width,height:g_modal_window_height,top:0,left:c,marginLeft:0,opacity:1},200,function(){adjustLayout();$(this).css("display","block")})}});$("div#btnDeleteSel").click(function(){if($(this).hasClass("disable"))return!1;if(!(g_select_array.length<=0)){g_selected_files=null;g_selected_files=[];for(var e=0;e<g_select_array.length;e++)g_selected_files.push(g_select_array[e].uhref);
(g_select_array.length==1?confirm(m.getString("del_files_msg")+" - "+decodeURIComponent(g_select_array[0].title)):confirm(m.getString("del_files_msg")))==!0&&g_webdav_client.DELETE(g_selected_files[0],a)}});$("div#btnNewDir").click(function(){if($(this).hasClass("disable"))return!1;var a=$("div#modalWindow");g_modal_url="/smb/css/makedir.html";g_modal_window_width=500;g_modal_window_height=80;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_newdir"));a&&a.jqmShow()});
$("div#btnDownload").click(function(){if($(this).hasClass("disable"))return!1;if(!(g_select_array.length<=0)){for(var a=[],b=0;b<g_select_array.length;b++){var c=g_select_array[b].title,d=g_select_array[b].uhref,g=g_select_array[b].isdir,h=window.location.href,h=d.substring(0,d.lastIndexOf("/")),c=h+"/"+c;g==1?a.push(c):download_file(c)}download_folder(a)}});$("div#btnRename").click(function(){if($(this).hasClass("disable"))return!1;g_select_array.length==1&&open_rename_window(g_select_array[0].title,
g_select_array[0].uhref,g_select_array[0].isdir)});$("div#btnLock").click(function(){if($(this).hasClass("disable"))return!1;g_select_array.length==1&&g_webdav_client.LOCK(g_select_array[0].uhref,"",function(a,b,c){a!="201"?alert("Error unlocking: "+b):(g_current_locktoken=getLockToken(c),alert("locktoken: "+g_current_locktoken))},null,"exclusive","write",0,3)});$("div#btnUnLock").click(function(){if($(this).hasClass("disable"))return!1;g_select_array.length==1&&g_webdav_client.UNLOCK(g_select_array[0].uhref,
g_current_locktoken,function(a){alert(a)})});$("div#btnChangeUser").click(function(){if(confirm(m.getString("msg_changeuser_confirm"))==!0){$("#main_right_container #fileview").empty();var a=g_storage.get("openurl");g_webdav_client.LOGOUT(a,function(b){b==200&&doPROPFIND(a)})}});$("#btnThumbView").click(function(){g_list_view.set(0);$("#btnThumbView").css("display","none");$("#btnListView").css("display","block");var a=g_storage.get("openurl"),a=a==void 0?"/":a,b=isAiModeView();if(b<0)doPROPFIND(a);
else{var c=g_storage.get("data-id")==void 0?"":g_storage.get("data-id"),d=myencodeURI($("div#boxSearch input").val());doPROPFINDMEDIALIST(a,!1,null,b,"0","50",d,"TIMESTAMP","DESC",c)}});$("#btnListView").click(function(){g_list_view.set(1);$("#btnThumbView").css("display","block");$("#btnListView").css("display","none");var a=g_storage.get("openurl"),a=a==void 0?"/":a,b=isAiModeView();if(b<0)doPROPFIND(a);else{var c=g_storage.get("data-id")==void 0?"":g_storage.get("data-id"),d=myencodeURI($("div#boxSearch input").val());
doPROPFINDMEDIALIST(a,!1,null,b,"0","50",d,"TIMESTAMP","DESC",c)}});$("#btnUpload2").click(function(){g_upload_mode=1;$("div#btnNewDir").css("display","none");$("div#btnUpload").css("display","none");$("div#btnPlayImage").css("display","none");$("div#boxSearch").css("display","none");$("#upload_panel").css("display","block");$("#upload_panel").css("left","1999px");$("#upload_panel").animate({left:"0px"},"slow");var a=addPathSlash(g_storage.get("openurl"));$("#upload_panel iframe").attr("src","/smb/css/upload.html?u="+
a);$("#function_help").text(m.getString("msg_uploadmode_help"));adjustLayout()});$("#btnCancelUpload").click(closeUploadPanel);$(".mediaListDiv").mousedown(function(){var a=$(this).attr("qtype"),b=g_storage.get("openurl");g_storage.set("data-id","");$(".mediaListDiv").removeClass("down");$(this).addClass("down");g_ui_mode.set(a);doPROPFINDMEDIALIST(b,!1,function(){},a,"0","50",null,"TIMESTAMP","DESC")});$("div#btnAiMusicPopupMenux").click(function(){var a="<div class='popupmenu' id='popupmenu'>";
a+="<div class='menuitem' id='classifyByAlbum'>";a+="<div class='menuitem-content' style='-webkit-user-select: none;'>";a+="<span class='menuitem-icon a-inline-block' style='-webkit-user-select: none;'>&nbsp;</span>";a+="<span class='menuitem-container a-inline-block' style='-webkit-user-select: none;'>";a+="<span class='menuitem-caption a-inline-block' style='-webkit-user-select: none;'>";a+="<div style='-webkit-user-select: none;'>"+m.getString("title_sort_by_album")+"</div>";a+="</span>";a+="</span>";
a+="</div>";a+="</div>";a+="<div class='menuitem' id='classifyByArtist'>";a+="<div class='menuitem-content' style='-webkit-user-select: none;'>";a+="<span class='menuitem-icon a-inline-block' style='-webkit-user-select: none;'>&nbsp;</span>";a+="<span class='menuitem-container a-inline-block' style='-webkit-user-select: none;'>";a+="<span class='menuitem-caption a-inline-block' style='-webkit-user-select: none;'>";a+="<div style='-webkit-user-select: none;'>"+m.getString("title_sort_by_artist")+"</div>";
a+="</span>";a+="</span>";a+="</div>";a+="</div>";a+="</div>";$(a).appendTo("body");$(".popupmenu").css("left",g_mouse_x-$(".popupmenu").width()+"px");$(".popupmenu").css("top",g_mouse_y-$(".popupmenu").height()+"px");$("#classifyByAlbum").click(function(a){if(g_webdav_client!=null){showHideLoadStatus(!0);var e=g_storage.get("openurl");g_webdav_client.GETMUSICCLASSIFICATION(e==void 0?"/":e,"album",function(a,e,b){a==200?createClassificationView(b,"album"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)});
...
e+='<p class="header">'+a[b].name+"</p>",e+="</div>";e+="</div>";e+="</div>";e+='<div class="barousel_loading" style="position:absolute;display:none;z-index=99;"><img src="/smb/css/load.gif" width="18px" height="18px"/></div>';e+="</div>";$(e).animate({width:"100%",height:"100%",left:"0px",top:"0px"},200,null,null).appendTo("body");$("#image_slide_show").barousel({manualCarousel:1,contentResize:0,startIndex:c});$(".facebook_upload").click(function(){var a=$("div#modalWindow"),b=$(this).attr("file"),
c=myencodeURI(b.substring(b.lastIndexOf("/")+1,b.length)),b=b.substring(0,b.lastIndexOf("/")),e=window.location.host;e.indexOf(":")!=-1&&(e=e.substring(0,e.indexOf(":")));e="http://"+e+":"+g_storage.get("http_port")+"/";g_webdav_client.GSL(b,b,c,0,0,function(b,d,f){b==200&&(b=parseXml(f),b=$(b).find("sharelink").text(),b=e+b,g_modal_url="http://www.efroip.com/efroip/fbtest/fb.html?v="+b+"&b="+mydecodeURI(c)+"&d="+window.location.href,g_modal_window_width=600,g_modal_window_height=320,$("#jqmMsg").css("display",
"none"),$("#jqmTitleText").text("Upload to Facebook"),a&&a.jqmShow(),$("#image_slide_show").remove())})});$(".picassa_upload").click(function(){var a=$("div#modalWindow"),b=$(this).attr("file"),c=myencodeURI(b.substring(b.lastIndexOf("/")+1,b.length)),b=b.substring(0,b.lastIndexOf("/")),e=window.location.host;e.indexOf(":")!=-1&&(e=e.substring(0,e.indexOf(":")));e="http://"+e+":"+g_storage.get("http_port")+"/";g_webdav_client.GSL(b,b,c,0,0,function(b,d,f){b==200&&(b=parseXml(f),b=$(b).find("sharelink").text(),
b=e+b,g_modal_url="http://www.efroip.com/efroip/google/index.html?v="+b+"&b="+mydecodeURI(c)+"&d="+window.location.href,g_modal_window_width=600,g_modal_window_height=320,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text("Upload to Facebook"),a&&a.jqmShow(),$("#image_slide_show").remove())})});a=null}}};var g_audioPlayer=null,g_audio_playlist=[],g_onPlaying=!1;function openAudioPlayer(a){for(var b=[],c=0;c<g_file_array.length;c++)getFileExt(g_file_array[c].href)=="mp3"&&b.push(g_file_array[c]);if(b.length==0)alert(m.getString("msg_no_image_list"));else{for(var e="",f=0,c=0;c<b.length;c++){var j=b[c].href;a==j&&(f=c);e+=j;c!=b.length-1&&(e+=",")}get_mp3_url(e,!0,function(a){g_audioPlayer.showHideAudioPlayerWindow(!0,function(){g_audioPlayer.addPlaylist(a,f)})})}}
