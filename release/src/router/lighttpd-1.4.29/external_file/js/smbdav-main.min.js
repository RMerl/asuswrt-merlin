...
$("#jqmMsg").css("display",c);c="";c+='<table id="table_login" width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="overflow:hidden;table-layout: fixed;">';c+="<tr>";c+="<td>";c+='<form name="form_login">';c+='<fieldset width="120px">';c+="<table>";c+="<tr>";c+='<td><label id="username">'+m.getString("title_username")+'</label></td><td><input name="username" type="text" id="username" autocapitalize="off" style="width:250px"></td>';c+="</tr>";c+="<tr>";c+='<td><label id="password">'+
m.getString("title_password")+'</label></td><td><input name="password" type="password" id="password" style="width:250px"></td>';c+="</tr>";c+="</table>";c+="</fieldset>";c+="</form>";c+="</td>";c+="</tr>";c+='<tr style="height:10px"></tr>';c+="<tr>";c+="<td>";c+='<div class="table_block_footer" style="text-align:right">';c+='<button id="ok" class="btnStyle">'+m.getString("btn_ok")+"</button>";c+='<button id="cancel" class="btnStyle">'+m.getString("btn_cancel")+"</button>";c+="</div>";c+="</td>";c+=
"</tr>";c+="</table>";$("#jqmContent").empty();$(c).appendTo($("#jqmContent"));$("#table_login input#password").keydown(function(a){a.keyCode==13&&e()});$("#table_login #ok").click(function(){e()});$("#table_login #cancel").click(function(){closeJqmWindow(0)});b&&b.jqmShow()}
...
g_webdav_client.UNLOCK(a,h,function(a){a!=204&&alert("Unlock error: "+a)})},null,"F",h)}},null)}function getFileViewHeight(){return $("#fileview").height()-20}function confirmCancelUploadFile(){if(g_storage.get("isOnUploadFile")==1){if(confirm(m.getString("msg_confirm_cancel_upload"))!=!0)return 0;$("#upload_panel iframe")[0].contentWindow.stop_upload()}return 1}function closeJqmWindow(a){g_reload_page=a;a=$("div#modalWindow");$("iframe",a).attr("src","");a&&a.jqmHide();showHideLoadStatus(!1)}
function resizeJqmWindow(a,b){var c=$(".jqmWindow");c&&(c.css("width",a+"px"),c.css("height",b+"px"))}function fullscreenJqmWindow(){var a=$("div#modalWindow");a&&(a.css("left","0px"),a.css("top","0px"),a.css("width",window.width+"px"),a.css("height",window.height+"px"))}function doLOGOUT(){doPROPFIND("/",function(){addPathSlash(g_storage.get("openurl"));g_webdav_client.LOGOUT("/",function(a){a[0]==2&&(g_storage.set("openhostuid","0"),window.location.reload())})},0)}
...
j=k.documentElement.getAttribute("scan_status"),parserPropfindXML(k,a,b));k="";g_ui_mode.get()==6?(l=0,k="goto:music_album"):g_ui_mode.get()==7&&(l=0,k="goto:music_artist");var n=g_list_view.get()==1?"listview":"thumbview";create_ui_view(n,$("#main_right_container #fileview"),l,k,g_folder_array,g_file_array,onMouseDownListDIVHandler);f>o&&(o+=1,l=o+50,l>f&&(l=f),o="<div class='nextDiv' start='"+o+"' end='"+l+"'><span>",k=m.getString("title_next_query"),k=k.replace("%s",l),k=k.replace("%s",f),o+=k,
o+="</span></div>",$("#main_right_container #fileview").append(o),$(".nextDiv").click(function(){doPROPFINDMEDIALIST(a,!0,null,e,$(this).attr("start"),$(this).attr("end"),d,g,h)}));j=="Scanning"?($("#main_right_container #hintbar").text(m.getString("msg_dms_scanning")),$("#main_right_container #hintbar").show()):$("#main_right_container #hintbar").hide();g_storage.set("aimode",e);$("div#btnUpload").css("display","none");$("div#btnNewDir").css("display","none");$("div#btnPlayImage").css("display",
e==1?"block":"none");$("div#boxSearch").css("display","block");g_storage.set("openurl",a);$("div#hostview").scrollTop(g_storage.get("hostviewscrollTop"));$("div#fileview").scrollLeft(g_storage.get("contentscrollLeft"));$("div#fileview").scrollTop(g_storage.get("contentscrollTop"));$("div#boxSearch").attr("uhref",a);$("div#boxSearch").attr("qtype",e);adjustLayout();closeJqmWindow(0);c!=void 0&&c()}else f==501?doPROPFINDMEDIALIST(a):f==503?show_hint_no_mediaserver():f==401?setTimeout(function(){openLoginWindow(a)},
2E3):alert(m.getString(f));showHideLoadStatus(!1)}},null,e,f,j,d,g,h,k),resetTimer()}catch(l){alert("catch error: "+l)}}}
function parserPropfindXML(a,b,c){if(a){c==!1&&(g_file_array=g_folder_array=null);g_folder_array==null&&(g_folder_array=[]);g_file_array==null&&(g_file_array=[]);for(var e,f,j,d=a.documentElement.childNodes,a=0;a<d.length;a++){var g="",h="",k="",l="",q="",x="",y="",s="",o="",n="",u="",z="",w="",t;j="";for(var v="0",B="",C="0",D=d[a].childNodes,c=0;c<D.length;c++)if(D[c].nodeType==1&&D[c].nodeName=="D:propstat"){var r=D[c].childNodes;for(e=0;e<r.length;e++)if(r[e].nodeName=="D:prop"){var p=r[e].childNodes;
...
1,g.length),l!=""?(t=l,q=l=mydecodeURI(l),e=g_list_view.get()==0?12:45,q.length>e&&(q=q.substring(0,e)+"...")):g=""):g="");g!=""&&(h=="httpd/unix-directory"?g_folder_array.push({contenttype:h,href:g,name:l,uname:t,shortname:q,online:x,time:y,size:s,ip:o,mac:n,uid:k,type:u,freadonly:z,fhidden:w,routersyncfolder:v,matadatatitle:B,thumb:C}):g_file_array.push({contenttype:h,href:g,name:l,uname:t,shortname:q,online:x,time:y,size:s,ip:o,mac:n,uid:k,type:u,freadonly:z,fhidden:w,routersyncfolder:v,matadatatitle:B,
thumb:C}))}}}function content2XMLDOM(a){if(a=="")return null;var b=null,b=null;if(window.DOMParser)b=new DOMParser,b=b.parseFromString(a,"text/xml");else if(b=new ActiveXObject("Microsoft.XMLDOM"),b.async="false",b.loadXML(a),!b.documentElement)return alert("Fail to load xml!"),showHideLoadStatus(!1),null;return b}
...
"1"?!0:!1);closeAiMode();$("div#btnThumbView").css("display",g_list_view.get()==1?"block":"none");$("div#btnListView").css("display",g_list_view.get()==1?"none":"block");$("div#btnUpload").css("display",e==0&&g_select_mode==0?"block":"none");$("div#btnNewDir").css("display",e==0&&g_select_mode==0?"block":"none");$("div#btnPlayImage").css("display",e==0&&g_select_mode==0?"block":"none");$("#btnCancelUpload").css("display",g_upload_mode==1?"block":"none");$("#btnChangeUser").css("display",e==1&&d==
0?"block":"none");$("span#username").text(c);g_storage.set("isAidisk",d);g_storage.set("openurl",a);$("div#hostview").scrollTop(g_storage.get("hostviewscrollTop"));$("div#fileview").scrollLeft(g_storage.get("contentscrollLeft"));$("div#fileview").scrollTop(g_storage.get("contentscrollTop"));$("#main_right_container #hintbar").hide();adjustLayout();closeJqmWindow(0);b!=void 0&&b()}}else e==501?doPROPFIND(a):e==401?setTimeout(function(){openLoginWindow(a)},2E3):alert(m.getString(e));showHideLoadStatus(!1)}},
null,1),resetTimer()}catch(e){alert("catch error: "+e)}}}function registerPage(a){if(!(a!="/"||isPrivateIP(g_storage.get("wan_ip"))))a=g_storage.get("ddns_host_name"),a==""?alert("start ddns process"):window.location="http://140.130.25.39/aicloud?v=https://"+a}
function doLOGIN(a,b){doPROPFIND(a,function(){g_opening_uid!=""&&(g_storage.set("openhostuid",g_opening_uid),$("#hostview .host_item").each(function(){$(this).attr("uid")==g_opening_uid?$(this).addClass("select"):$(this).removeClass("select")}),g_opening_uid="")},b)}
...
f.documentElement.getAttribute("computername");f.documentElement.getAttribute("isusb");for(f=0;f<c.length;f++){var k="",l="",q="",x="",y="",s="",o="",n="",u="",z="",w="",t="",v="",B,C=c[f].childNodes;for(j=0;j<C.length;j++)if(C[j].nodeType==1&&C[j].nodeName=="D:propstat"){var D=C[j].childNodes;for(d=0;d<D.length;d++)if(D[d].nodeName=="D:prop"){var r=D[d].childNodes;for(g=0;g<r.length;g++)if(!(r[g].childNodes.length<=0))if(r[g].nodeName=="D:getcontenttype")l=String(r[g].childNodes[0].nodeValue);else if(r[g].nodeName==
"D:getuniqueid")q=String(r[g].childNodes[0].nodeValue);else if(r[g].nodeName=="D:getonline")s=String(r[g].childNodes[0].nodeValue);else if(r[g].nodeName=="D:getlastmodified")o=String(r[g].childNodes[0].nodeValue);else if(r[g].nodeName=="D:getcontentlength")n=String(size_format(parseInt(r[g].childNodes[0].nodeValue)));else if(r[g].nodeName=="D:getmac")z=String(r[g].childNodes[0].nodeValue);else if(r[g].nodeName=="D:getip")u=String(r[g].childNodes[0].nodeValue);else if(r[g].nodeName=="D:gettype")w=
String(r[g].childNodes[0].nodeValue);else if(r[g].nodeName=="D:getattr"){var p=r[g].childNodes;for(h=0;h<p.length;h++)if(p[h].nodeName=="D:readonly")t=p[h].childNodes[0].nodeValue;else if(p[h].nodeName=="D:hidden")v=p[h].childNodes[0].nodeValue}}}else C[j].nodeType==1&&C[j].nodeName=="D:href"&&(k=String(C[j].childNodes[0].nodeValue),d="",k.match(/^http/)&&(d=window.location.protocol+"//"+window.location.host),g=d+addPathSlash("/"),k!=g?(k=k.replace(d,""),x=k.substring(k.lastIndexOf("/")+1,k.length),
x!=""?(B=x,y=x=mydecodeURI(x),d=g_list_view.get()==0?12:45,y.length>d&&(y=y.substring(0,d)+"...")):k=""):k="");k!=""&&l=="httpd/unix-directory"&&a.push({contenttype:l,href:k,name:x,uname:B,shortname:y,online:s,time:o,size:n,ip:u,mac:z,uid:q,type:w,freadonly:t,fhidden:v})}a.sort(sortByName);for(B=0;B<a.length;B++)a[B].type=="usbdisk"&&arraymove(a,B,0);createHostList(e,a)}},null,1)}catch(a){alert("catch error: "+a)}}
...
0){b=window.location.href;b=b.substr(0,b.lastIndexOf("?"));window.location=b+"?mobile=1";return}}document.oncontextmenu=function(){return!1};document.onmousedown=function(){resetTimer()};document.onmousemove=function(a){getMouseXY(a);resetTimer()};$(document).keydown(function(a){if(a.keyCode==27){if(g_select_mode==1)showHideSelectModeUI(!1);else if(g_upload_mode==1){if(confirmCancelUploadFile()==0)return;closeUploadPanel()}closeJqmWindow()}});g_storage.set("stopLogoutTimer","0");g_storage.set("isOpenModalWindow",
"0");g_storage.set("isOnUploadFile","0");createLayout();showHideLoadStatus(!1);adjustLayout();(function(){var a=g_storage.get("openurl");g_webdav_client.GETROUTERINFO(a==void 0?"/":a,function(a,e,d){a==200&&(a=parseXml(d),a=$(a),g_storage.set("webdav_mode",a.find("webdav_mode").text()),g_storage.set("http_port",a.find("http_port").text()),g_storage.set("https_port",a.find("https_port").text()),g_storage.set("http_enable",a.find("http_enable").text()),g_storage.set("misc_http_enable",a.find("misc_http_enable").text()),
...
a.find("modalname").text()),g_storage.set("usbdiskname",a.find("usbdiskname").text()),g_storage.set("dms_enable",a.find("dms_enable").text()),g_storage.set("app_installation_url",a.find("app_installation_url").text()),a=g_storage.get("last_login_info"),a!=""&&a!=void 0&&(a=String(a).split(">"),a=m.getString("title_logininfo")+a[1]+", "+m.getString("title_ip")+a[2],$("#login_info").text(a)))})})();if(g_fileview_only==0){var c=g_storage.get("openurl");g_storage.set("HostList","");doPROPFIND("/",function(){c!=
void 0&&c!="/"&&doPROPFIND(c);if(g_storage.get("openhostuid")==void 0||g_storage.get("openhostuid")==0){var a="<div id='help_1'>";a+="<div id='help_content'>";a+=m.getString("msg_help");a+="</div>";a+="<div id='help_image'>";a+="</div>";a+="</div>";$("div#fileview").append(a)}},0)}else c=g_storage.get("openurl"),doPROPFIND(c);initAudioPlayer();$("#modalWindow").jqm({overlay:70,modal:!0,target:"#jqmContent",onHide:function(a){var b=$(a.w);a.o.remove();b.fadeOut("200",function(){g_show_modal=0;if(g_reload_page==
1){var a=addPathSlash(g_storage.get("openurl"));doPROPFIND(a)}})},onShow:function(a){var a=$(a.w),b=$("#jqmContent",a);$("#jqmTitle",a);var c=(getPageSize()[0]-g_modal_window_width)/2;g_show_modal=1;navigator.userAgent.toLowerCase().indexOf("msie");var d=function(){var a=-1;navigator.appName=="Microsoft Internet Explorer"&&/MSIE ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent)!=null&&(a=parseFloat(RegExp.$1));return a};g_modal_url!=""&&(b.empty(),$("<iframe src='' frameborder='0' width='100%' height='100%'>").appendTo(b),
...
0)&&confirm(m.getString("del_files_msg"))==!0){g_selected_files=null;g_selected_files=[];for(var e=0;e<g_select_array.length;e++)g_selected_files.push(g_select_array[e].uhref);g_webdav_client.DELETE(g_selected_files[0],a)}});$("div#btnNewDir").click(function(){if($(this).hasClass("disable"))return!1;var a=$("div#modalWindow");g_modal_url="/smb/css/makedir.html";g_modal_window_width=500;g_modal_window_height=80;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_newdir"));
a&&a.jqmShow()});$("div#btnShareLinkx").click(function(){if($(this).hasClass("disable"))return!1;var a="<div class='popupmenu' id='popupmenu'>";a+="<div class='menuitem share2web' id='share2facebook' data-service='facebook'>";a+="<div class='menuitem-content' style='-webkit-user-select: none;'>";a+="<span class='menuitem-icon a-inline-block' style='-webkit-user-select: none;'>&nbsp;</span>";a+="<span class='menuitem-container a-inline-block' style='-webkit-user-select: none;'>";a+="<span class='menuitem-caption a-inline-block' style='-webkit-user-select: none;'>";
a+="<div style='-webkit-user-select: none;'>"+m.getString("title_share2facebook")+"</div>";a+="</span>";a+="</span>";a+="</div>";a+="</div>";a+="<div class='menuitem share2web' id='share2flickr' data-service='flickr'>";a+="<div class='menuitem-content' style='-webkit-user-select: none;'>";a+="<span class='menuitem-icon a-inline-block' style='-webkit-user-select: none;'>&nbsp;</span>";a+="<span class='menuitem-container a-inline-block' style='-webkit-user-select: none;'>";a+="<span class='menuitem-caption a-inline-block' style='-webkit-user-select: none;'>";
a+="<div style='-webkit-user-select: none;'>"+m.getString("title_upload2flickr")+"</div>";a+="</span>";a+="</span>";a+="</div>";a+="</div>";a+="<div class='menuitem' id='sharebyemail'>";a+="<div class='menuitem-content' style='-webkit-user-select: none;'>";a+="<span class='menuitem-icon a-inline-block' style='-webkit-user-select: none;'>&nbsp;</span>";a+="<span class='menuitem-container a-inline-block' style='-webkit-user-select: none;'>";a+="<span class='menuitem-caption a-inline-block' style='-webkit-user-select: none;'>";
a+="<div style='-webkit-user-select: none;'>"+m.getString("title_gen_sharelink")+"</div>";a+="</span>";a+="</span>";a+="</div>";a+="</div>";a+="</div>";$(a).appendTo("body");$(".popupmenu").css("left",g_mouse_x-$(".popupmenu").width()+"px");$(".popupmenu").css("top",g_mouse_y-$(".popupmenu").height()+"px");$(".share2web").click(function(){for(var a=$(this).attr("data-service"),e=[],d=0;d<g_select_array.length;d++){var b=g_select_array[d].uhref,c=getFileExt(b);(c=="jpg"||c=="jpeg"||c=="png"||c=="gif")&&
e.push(b)}open_upload2service_window(a,e)});$("#sharebyemail").click(function(){if(!(g_select_array.length<=0)){for(var a=g_storage.get("openurl"),e=[],d=0;d<g_select_array.length;d++)e.push(g_select_array[d].title);open_sharelink_window(a,e)}});return!1});$("div#btnDownload").click(function(){if($(this).hasClass("disable"))return!1;if(!(g_select_array.length<=0)){for(var a=[],b=0;b<g_select_array.length;b++){var c=g_select_array[b].title,d=g_select_array[b].uhref,g=g_select_array[b].isdir,h=window.location.href,
h=d.substring(0,d.lastIndexOf("/")),c=h+"/"+c;g==1?a.push(c):download_file(c)}download_folder(a)}});$("div#btnRename").click(function(){if($(this).hasClass("disable"))return!1;g_select_array.length==1&&open_rename_window(g_select_array[0].title,g_select_array[0].uhref,g_select_array[0].isdir)});$("div#btnLock").click(function(){if($(this).hasClass("disable"))return!1;g_select_array.length==1&&g_webdav_client.LOCK(g_select_array[0].uhref,"",function(a,b,c){a!="201"?alert("Error unlocking: "+b):(g_current_locktoken=
getLockToken(c),alert("locktoken: "+g_current_locktoken))},null,"exclusive","write",0,3)});$("div#btnUnLock").click(function(){if($(this).hasClass("disable"))return!1;g_select_array.length==1&&g_webdav_client.UNLOCK(g_select_array[0].uhref,g_current_locktoken,function(a){alert(a)})});$("div#btnChangeUser").click(function(){if(confirm(m.getString("msg_changeuser_confirm"))==!0){$("#main_right_container #fileview").empty();var a=g_storage.get("openurl");g_webdav_client.LOGOUT(a,function(b){b==200&&
doPROPFIND(a)})}});$("#btnThumbView").click(function(){if(confirmCancelUploadFile()!=0){g_list_view.set(0);$("#btnThumbView").css("display","none");$("#btnListView").css("display","block");var a=g_storage.get("openurl"),a=a==void 0?"/":a,b=isAiModeView();if(b<0)doPROPFIND(a);else{var c=g_storage.get("data-id")==void 0?"":g_storage.get("data-id"),d=myencodeURI($("div#boxSearch input").val());doPROPFINDMEDIALIST(a,!1,null,b,"0","50",d,"TIMESTAMP","DESC",c)}}});$("#btnListView").click(function(){g_list_view.set(1);
$("#btnThumbView").css("display","block");$("#btnListView").css("display","none");var a=g_storage.get("openurl"),a=a==void 0?"/":a,b=isAiModeView();if(b<0)doPROPFIND(a);else{var c=g_storage.get("data-id")==void 0?"":g_storage.get("data-id"),d=myencodeURI($("div#boxSearch input").val());doPROPFINDMEDIALIST(a,!1,null,b,"0","50",d,"TIMESTAMP","DESC",c)}});$("#btnUploadx").click(function(){if($(this).hasClass("disable"))return!1;var a="<div class='popupmenu' id='popupmenu'>";a+="<div class='menuitem' id='uploadfile'>";
a+="<div class='menuitem-content' style='-webkit-user-select: none;'>";a+="<span class='menuitem-icon a-inline-block' style='-webkit-user-select: none;'>&nbsp;</span>";a+="<span class='menuitem-container a-inline-block' style='-webkit-user-select: none;'>";a+="<span class='menuitem-caption a-inline-block' style='-webkit-user-select: none;'>";a+="<div style='-webkit-user-select: none;'>"+m.getString("title_upload_file")+"</div>";a+="</span>";a+="</span>";a+="</div>";a+="</div>";a+="<div class='menuitem' id='uploadfolder'>";
a+="<div class='menuitem-content' style='-webkit-user-select: none;'>";a+="<span class='menuitem-icon a-inline-block' style='-webkit-user-select: none;'>&nbsp;</span>";a+="<span class='menuitem-container a-inline-block' style='-webkit-user-select: none;'>";a+="<span class='menuitem-caption a-inline-block' style='-webkit-user-select: none;'>";a+="<div style='-webkit-user-select: none;'>"+m.getString("title_upload_folder")+"</div>";a+="</span>";a+="</span>";a+="</div>";a+="</div>";a+="</div>";$(a).appendTo("body");
$(".popupmenu").css("left",g_mouse_x-$(".popupmenu").width()+"px");$(".popupmenu").css("top",g_mouse_y+"px");$("#uploadfile").click(function(){if(isBrowser("msie")&&getInternetExplorerVersion()<=9){var a=$("div#modalWindow");g_modal_url="/smb/css/upload_file.html";g_modal_window_width=600;g_modal_window_height=150;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_upload_file"));a&&a.jqmShow()}else g_upload_mode=1,$("div#btnNewDir").css("display","none"),$("div#btnUpload").css("display",
"none"),$("div#btnPlayImage").css("display","none"),$("div#boxSearch").css("display","none"),$("div#btnListView").css("display","none"),$("div#btnThumbView").css("display","none"),$("#upload_panel").css("display","block"),$("#upload_panel").css("left","1999px"),$("#upload_panel").animate({left:"0px"},"slow"),a=addPathSlash(g_storage.get("openurl")),$("#upload_panel iframe").attr("src","/smb/css/upload.html?u="+a+"&d=1"),$("#function_help").text(m.getString("msg_uploadmode_help")),adjustLayout()});
$("#uploadfolder").click(function(){if(isBrowser("chrome")){g_upload_mode=1;$("div#btnNewDir").css("display","none");$("div#btnUpload").css("display","none");$("div#btnPlayImage").css("display","none");$("div#boxSearch").css("display","none");$("div#btnListView").css("display","none");$("div#btnThumbView").css("display","none");$("#upload_panel").css("display","block");$("#upload_panel").css("left","1999px");$("#upload_panel").animate({left:"0px"},"slow");var a=addPathSlash(g_storage.get("openurl"));
$("#upload_panel iframe").attr("src","/smb/css/upload.html?u="+a+"&d=2");$("#function_help").text(m.getString("msg_uploadmode_help"));adjustLayout()}else a=$("div#modalWindow"),g_modal_url="/smb/css/upload_folder.html",g_modal_window_width=600,g_modal_window_height=150,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_upload_folder")),a&&a.jqmShow()});return!1});$("#btnUpload2").click(function(){g_upload_mode=1;$("div#btnNewDir").css("display","none");$("div#btnUpload").css("display",
...
null){showHideLoadStatus(!0);var b=g_storage.get("openurl");g_webdav_client.GETMUSICCLASSIFICATION(b==void 0?"/":b,"album",function(a,b,e){a==200?createClassificationView(e,"album"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)});a.preventDefault();return!1}});$("#classifyByArtist").click(function(){if(g_webdav_client!=null){showHideLoadStatus(!0);var a=g_storage.get("openurl");g_webdav_client.GETMUSICCLASSIFICATION(a==void 0?"/":a,"artist",function(a,d,b){a==200?createClassificationView(b,
...
800,g_modal_window_height=b[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),a&&a.jqmShow()):a=="other_settings"?(a=$("div#modalWindow"),b=getPageSize(),g_modal_url="/smb/css/setting.html?p=3&s=1",g_modal_window_width=800,g_modal_window_height=b[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),a&&a.jqmShow()):a=="test"&&g_webdav_client.GETROUTERINFO("/AICLOUD306106790/AiCloud",function(a,b,d){a==200&&(a=parseXml(d),
a=$(a),g_storage.set("webdav_mode",a.find("webdav_mode").text()),g_storage.set("http_port",a.find("http_port").text()),g_storage.set("https_port",a.find("https_port").text()),g_storage.set("misc_http_enable",a.find("misc_http_enable").text()),g_storage.set("misc_http_port",String(a.find("misc_http_port").text()).replace("\n","")),g_storage.set("last_login_info",a.find("last_login_info").text()),g_storage.set("ddns_host_name",a.find("ddns_host_name").text()),g_storage.set("router_version",a.find("version").text()),
g_storage.set("wan_ip",a.find("wan_ip").text()),a=g_storage.get("last_login_info"),a!=""&&a!=void 0&&(a=String(a).split(">"),a=m.getString("title_logininfo")+a[1]+", "+m.getString("title_ip")+a[2],$("#login_info").text(a)))})});$(".navigation#refresh dt a").click(function(){if(confirmCancelUploadFile()!=0){var a=g_storage.get("openurl");g_storage.set("HostList","");doPROPFIND("/",function(){a=a==void 0?"/":a;a!="/"&&doPROPFIND(a)},0)}});$(".themes_ctrl").click(function(){if(confirmCancelUploadFile()!=
...
b)}}else if(a=="sharelink"&&!(g_select_array.length<=0)){b=g_storage.get("openurl");c=[];for(a=0;a<g_select_array.length;a++)c.push(g_select_array[a].title);open_sharelink_window(b,c)}},items:{upload2facebook:{name:m.getString("title_upload2facebook"),disabled:function(){if(g_storage.get("isAidisk")=="0")return!0;if(g_select_array.length<=0)return!0;for(var a=0;a<g_select_array.length;a++){var b=getFileExt(g_select_array[a].uhref);if(b=="jpg"||b=="jpeg"||b=="png"||b=="gif")return!1}return!0}},upload2flickr:{name:m.getString("title_upload2flickr"),
disabled:function(){if(g_storage.get("isAidisk")=="0")return!0;if(g_select_array.length<=0)return!0;for(var a=0;a<g_select_array.length;a++){var b=getFileExt(g_select_array[a].uhref);if(b=="jpg"||b=="jpeg"||b=="png"||b=="gif")return!1}return!0}},sharelink:{name:m.getString("title_gen_sharelink")}}});$.contextMenu({selector:"div#btnUpload",trigger:"left",callback:function(a){a=="uploadfile"?open_uploadfile_window():a=="uploadfolder"&&open_uploadfolder_window()},items:{uploadfile:{name:m.getString("title_upload_file")},
...
g_webdav_client.GETMUSICCLASSIFICATION(a==void 0?"/":a,"artist",function(a,b,d){a==200?createClassificationView(d,"artist"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)}))},items:{sort_by_album:{name:m.getString("title_sort_by_album")},sort_by_artist:{name:m.getString("title_sort_by_artist")}}});$.contextMenu({selector:".item-menu",trigger:"left",events:{show:function(){},hide:function(){$(this).removeClass("x-view-menu-popup")}},callback:function(a){var b=$(this).parents(".wcb"),c=b.attr("uhref"),
d=b.attr("data-name"),b=b.attr("isdir");a=="delete"?c!=""&&confirm(m.getString("del_files_msg")+" - "+d)==!0&&g_webdav_client.DELETE(c,function(){var a=addPathSlash(g_storage.get("openurl"));doPROPFIND(a)}):a=="rename"?open_rename_window(d,c,b):a=="download"?b=="1"?download_folder(c):download_file(c):a=="upload2facebook"?open_upload2service_window("facebook",c):a=="upload2flickr"?open_upload2service_window("flickr",c):a=="sharelink"&&(a=g_storage.get("openurl"),open_sharelink_window(a,d))},items:{"delete":{name:m.getString("func_delete")},
sep1:"---------",rename:{name:m.getString("func_rename")},download:{name:m.getString("func_download")},sep2:"---------",upload2facebook:{name:m.getString("title_upload2facebook"),disabled:function(){if(g_storage.get("isAidisk")=="0")return!0;if(g_select_array.length<=0)return!0;for(var a=0;a<g_select_array.length;a++){var b=getFileExt(g_select_array[a].uhref);if(b=="jpg"||b=="jpeg"||b=="png"||b=="gif")return!1}return!0}},upload2flickr:{name:m.getString("title_upload2flickr"),disabled:function(){if(g_storage.get("isAidisk")==
"0")return!0;if(g_select_array.length<=0)return!0;for(var a=0;a<g_select_array.length;a++){var b=getFileExt(g_select_array[a].uhref);if(b=="jpg"||b=="jpeg"||b=="png"||b=="gif")return!1}return!0}},sharelink:{name:m.getString("title_gen_sharelink")}}});$(window).resize(adjustLayout)});window.onbeforeunload=function(a){if(g_storage.get("isOnUploadFile")==1){var b=m.getString("msg_confirm_cancel_upload");if(a=a||window.event)a.returnValue=b;return b}};
window.onunload=function(){g_storage.get("isOnUploadFile")==1&&$("#upload_panel iframe")[0].contentWindow.stop_upload()};function doBackgroundPlay(){alert("doBackgroundPlay")};var g_bshowHideAiButton=!0,g_bshowHideEditUIRegion=!1,g_hide_aidisk_name=1,g_list_view={_storage:new myStorage,set:function(a){this._storage.setl("listview",a)},get:function(){return this._storage.getl("listview")}},g_ui_mode={_storage:new myStorage,set:function(a){this._storage.set("uimode",a)},get:function(){return this._storage.get("uimode")}},g_usbdisk_space_handler={_changed:!1,_usbdisk_query_index:0,_usbdisk_current_query_index:-1,_usbdisk_query_timer:0,_array:[],add:function(a,b){if(!this.exist(a,
b)){var c={};c.id=a;c.name=b;c.done=!1;c.diskUsedPercent="0%";c.diskUsed=0;c.diskAvailable=0;this._array.push(c)}},exist:function(a,b){for(var c=0;c<this.len();c++)if(this.item(c).id==a&&this.item(c).name==b)return!0;return!1},len:function(){return this._array.length},item:function(a){return a<0||a>this._array.length-1?null:this._array[a]},refresh:function(){if(!(this.len()<=0)){var a=function(a){if(a!=null){var b="div."+a.id+" .progress-bar span";$("div."+a.id+" p").text(a.name+" "+bytesToSize(a.diskUsed)+
" / "+bytesToSize(a.diskAvailable+a.diskUsed));$(b).css("width",a.diskUsedPercent)}},b=this;this._usbdisk_query_index=0;this._usbdisk_current_query_index=-1;this._usbdisk_query_timer=setInterval(function(){if(b._usbdisk_current_query_index!=b._usbdisk_query_index){var c=b.len(),e=b.item(b._usbdisk_query_index);if(e!=null){var f=e.name,j=e.done;b._usbdisk_current_query_index=b._usbdisk_query_index;j?(a(e),b._usbdisk_query_index==c-1?clearInterval(b._usbdisk_query_timer):b._usbdisk_query_index++):(j=
new davlib.DavClient,j.initialize(),j.GETDISKSPACE("/",f,function(d,f,h){if(d==200)d=parseXml(h),d=$(d),e.diskUsedPercent=d.find("DiskUsedPercent").text()==""?"0%":d.find("DiskUsedPercent").text(),e.diskUsed=parseInt(d.find("DiskUsed").text()==""?"0":d.find("DiskUsed").text())*1024,e.diskAvailable=parseInt(d.find("DiskAvailable").text()==""?"0":d.find("DiskAvailable").text())*1024,e.done=!0,a(e),b._usbdisk_query_index==c-1?clearInterval(b._usbdisk_query_timer):b._usbdisk_query_index++}),j=null)}}},
200)}}};function bytesToSize(a){if(a==0)return"0";var b=parseInt(Math.floor(Math.log(a)/Math.log(1024)));return Math.round(a/Math.pow(1024,b),2)+" "+["Bytes","KB","MB","GB","TB"][b]}
...
b+="</div>";b+="</div>";b+="<div id='hintbar' class='unselectable'></div>";b+="<div id='fileview' class='unselectable context-menu-one'></div>";b+="<div id='upload_panel' class='unselectable'>";b+="<div style='position:absolute;width:98%;height:100%;padding:10px'>";b+="<iframe src='' width='100%' height='100%' frameborder='0'/>";b+="</div>";b+="</div>";b+="</div>";b+="</div>";g_fileview_only==0&&(b+="<div id='button_panel' class='unselectable'>",b+="<div id='ui_region'>",b+="<div class='abbutton toolbar-button-left mediaListDiv' id='btnAiMusic' style='display:none' qtype='2'>",
...
m.getString("title_feedback")+"</a></dt>",b+="<dd><a id='version'>"+m.getString("title_version")+"</a></dt>",b+="<dd><a id='sharelink'>"+m.getString("title_sharelink")+"</a></dt>",b+="<dd><a id='rescan_samba'>"+m.getString("title_rescan")+"</a></dt>",b+="<dd><a id='config'>"+m.getString("btn_config")+"</a></dt>",b+="<dd><a id='favorite'>"+m.getString("btn_favorite")+"</a></dt>",b+="<dd><a id='mobile'>"+m.getString("title_mobile_view")+"</a></dt>",b+="<dd><a id='logout'>"+m.getString("title_logout")+
"</a></dt>",b+="<dt><a>"+m.getString("title_setting")+"</a></dt>",b+="</dl>",b+="</li>",b+="</ul>",b+="<ul class='navigation' id='refresh'>",b+="<li>",b+="<dl>",b+="<dt><a>"+m.getString("btn_refresh")+"</a></dt>",b+="</dl>",b+="</li>",b+="</ul>");b+="<ul class='func_help'>";b+="<span id='function_help'></span>";b+="</ul>";b+="<span id='right_info'>ASUSTeK Computer Inc. All rights reserved</span>";b+="</div>";b+="<div id='modalWindow' class='jqmWindow'>";b+="<div id='jqmTitle'>";b+="<span id='jqmTitleText'></span>";
b+="</div>";b+="<div id='jqmMsg'>";b+="<span id='jqmMsgText'></span>";b+="</div>";b+="<div id='jqmContent' style='padding;0px;margin:0px'>";b+="</div>";b+="</div>";b+="<div id='selectWindow' class='select-window'>";b+="<div class='select-window-panel'>";b+="<table cellspacing='0' class='select-window-toolbar-ct'><tbody><tr>";b+="<td class='select-window-toolbar-left' alight='left' width='100%'>";b+="<table cellspacing='0'><tbody><tr class='toolbar-left-row'><td class='toolbar-cell'>";b+="<label class='selected-desc-text'></label>";
b+="</td></tr></tbody></table>";b+="</td>";b+="<td class='select-window-toolbar-right' alight='right'>";b+="<table cellspacing='0'><tbody><tr class='toolbar-right-row'><td class='toolbar-cell'>";b+="<table cellspacing='0'><tbody><tr>";b+="<td class='toolbar-cell'><button type='button' id='button-select-all' class='x-btn-text'>"+m.getString("btn_select_all")+"</button></td>";b+="<td class='toolbar-cell'></td>";b+="<td class='toolbar-cell'><button type='button' id='button-unselect-all' class='x-btn-text'>"+
...
!0&&doLOGOUT()});$(".navigation li, .navigation li a").mouseenter(function(){$(this).find("dd").fadeIn("fast")});$(".navigation li, .navigation li a").mouseleave(function(){$(this).find("dd").fadeOut("fast")});$("#mainCss").attr("href","/smb/css/style-theme.css");$("#btnHelp").attr("title",m.getString("title_help"));$("#btnLogout").attr("title",m.getString("title_logout"));$("#btnConfig").attr("title",m.getString("btn_config"));$("#btnUpload").attr("title",m.getString("btn_upload"));$("#btnCancelUpload").attr("title",
m.getString("btn_cancelupload"));$("#btnNewDir").attr("title",m.getString("btn_newdir"));$("#btnShareLink").attr("title",m.getString("btn_sharelink"));$("#btnDeleteSel").attr("title",m.getString("btn_delselect"));$("#btnDownload").attr("title",m.getString("func_download"));$("#btnRename").attr("title",m.getString("btn_rename"));$("#btnSetting").attr("title",m.getString("title_setting"));$("#btnRefresh").attr("title",m.getString("btn_refresh"))}
...
e+"'>"+b[d]+"</a>":" / <a id='url_path' uhref='"+e+"'>"+b[d]+"</a>";f=c}$("p#openurl").empty();$("p#openurl").append(c);$("a#url_path").click(function(){confirmCancelUploadFile()!=0&&doPROPFIND($(this).attr("uhref"))})}
function adjustLayout(){var a=getPageSize(),b=a[0],c=a[0],a=a[1]-$("#header_region").height()-$("#bottom_region").height();$("#main_region").css("height",a);$("#main_region #main_right_region").css("width",c-parseInt($("#main_region #main_right_region").css("left")));$("#main_region #main_right_region").css("height",a-parseInt($("#main_region #button_panel").height())+7);$("#main_region #button_panel").css("left",$("#main_region #main_left_region").width()-7);$("#main_region #button_panel").css("width",
$("#main_region #main_right_region").width());c=$("#main_left_region").height()-$("#main_left_region #infobar").height();$("#hostview").css("height",c);var e=0;$("#toolbar .albutton").each(function(){$(this).css("display")=="block"&&(e+=$(this).width())});$("#toolbar .alsearch").css("display")=="block"&&(e+=$("#toolbar .alsearch").width());$("#urlregion-url").css("width",$("#toolbar").width()-e-20);createOpenUrlUI(g_storage.get("openurl"));c=$("#main_right_container").height()-$("#main_right_region #infobar").height();
$("#main_right_container #hintbar").css("display")=="block"&&(c-=$("#main_right_container #hintbar").height());$("#fileview").css("height",c);$("#function_help").css("left",$("#main_left_region").width());if(c=$("div#modalWindow"))a=(b-g_modal_window_width)/2,c.css("left",a);a=(b-$(".select-window").width())/2;$(".select-window").css("left",a);$("#header-fixed").css("width",$("#ntl").width());b=$("#header_region").height()+$("#main_right_region #infobar").height()+2;$("#main_right_container #hintbar").css("display")==
"block"&&(b+=$("#main_right_container #hintbar").height());$("#header-fixed").css("top",b);g_fileview_only==1&&($("#button_panel").css("display","none"),$("#main_right_region").css("left","0px"),$("#main_right_region").css("width","100%"),$("#main_right_region").css("height","100%"));$("#audio_player_panel").css("display","block")}
...
function closeAiMode(){g_storage.set("aimode",-1);$(".mediaListDiv").removeClass("down");$("div#boxSearch").css("display","none");$("div#boxSearch input").val("")}
...
$("#upload_panel").animate({left:"1999px"},"slow",null,function(){$("#upload_panel").css("display","none");adjustLayout()});a==1&&(a=addPathSlash(g_storage.get("openurl")),doPROPFIND(a))}function showHideLoadStatus(a){a?$("#loading").css("display","block"):$("#loading").css("display","none")}
...
b.empty();c!=2&&(a=="thumbview"?createThumbView(b,c,e,f,j,d):a=="listview"&&createListView(b,c,e,f,j,d),$(".item-check").click(function(){var a=$(this).parents(".wcb");h(a)}),$(".item-menu").click(function(){var a=$(this),b=$(this).parents(".wcb");g();a.hasClass("x-view-menu-popup")?(a.removeClass("x-view-menu-popup"),b.css("background-color","")):(a.addClass("x-view-menu-popup"),b.css("background-color","#00C2EB"),a.show());h(b)}),$("#fileview .fcb").mouseover(function(){$(this).find(".item-check").show();
$(this).find(".item-menu").show();$(this).css("background-color","#00C2EB")}),$("#fileview .fcb").mouseleave(function(){var a=$(this).find(".item-check"),b=$(this).find(".item-menu");a.hasClass("x-view-selected")||$(this).find(".item-check").hide();b.hasClass("x-view-menu-popup")||$(this).find(".item-menu").hide();!a.hasClass("x-view-selected")&&!b.hasClass("x-view-menu-popup")&&$(this).css("background-color","")}))}
...
function createListView(a,b,c,e,f,j){var d="";d+='<table id="ntl" class="table-file-list">';d+="<thead>";d+="<tr>";d+='<th style="width:3%"></th>';d+='<th style="width:4%"></th>';d+='<th style="width:58%">'+m.getString("table_filename")+"</th>";d+='<th style="width:25%">'+m.getString("table_time")+"</th>";d+='<th style="width:7%">'+m.getString("table_size")+"</th>";d+='<th style="width:3%"></th>';d+="</tr>";d+="</thead>";d+="<tbody>";b==0&&(d+='<tr class="listDiv fcb cbp" ',d+='qtype="1" isParent="1" isdir="1" uhref="',
...
600,g_modal_window_height=320,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text("Upload to Facebook"),a&&a.jqmShow(),$("#image_slide_show").remove())})});a=null}}};var g_audioPlayer=null,g_audio_playlist=[],g_current_index=0,g_onPlaying=!1;function openAudioPlayer(){for(var a=[],b=0;b<g_file_array.length;b++)getFileExt(g_file_array[b].href)=="mp3"&&a.push(g_file_array[b]);if(a.length==0)alert(m.getString("msg_no_image_list"));else{for(var c="",b=0;b<a.length;b++)c+=a[b].href,b!=a.length-1&&(c+=",");get_mp3_url(c,!0,function(a){g_audioPlayer.addPlaylist(a);g_audioPlayer.showHideAudioPlayerWindow(!0)})}}
function openAudioPlayerByPlayList(a){a!=null&&!(a.length<=0)&&(g_audioPlayer.addPlaylist(a),g_audioPlayer.showHideAudioPlayerWindow(!0))}
...
function get_mp3_url(a,b,c){if(a!=""){var e=[],f=a.split(","),j=0,d=!1;if(b){var g=window.location.host;g.indexOf(":")!=-1&&(g=g.substring(0,g.indexOf(":")));var g="http://"+g+":"+g_storage.get("http_port")+"/",h=setInterval(function(){if(d==!1)if(j<0||j>f.length-1)clearInterval(h),c(e);else{var a=f[j],b=a.substring(a.lastIndexOf("/")+1,a.length),a=a.substring(0,a.lastIndexOf("/"));d=!0;g_webdav_client.GSL(a,a,b,0,0,function(a,c,f){if(a==200)a=parseXml(f),a=$(a).find("sharelink").text(),a=g+a,d=!1,
c=[],c.name=mydecodeURI(b),c.mp3=a,e.push(c),j++})}},100)}else{for(a=0;a<f.length;a++){var b=f[a],k=b.substring(b.lastIndexOf("/")+1,b.length);b.substring(0,b.lastIndexOf("/"));var l=[];l.name=mydecodeURI(k);l.mp3=b;e.push(l)}c(e)}}}
function initAudioPlayer(){var a=function(a,b){var d=this;this.statusMarqueeTimer=this.clsoeAudioPlayerWindowTimer=0;this.instance=a;this.playlist=null;this.options=b;this.playTitle="";this.current=0;this.showAudioList=!1;this.cssId={jPlayer:"jquery_jplayer_","interface":"jp_interface_",playlist:"jp_playlist_",playtitle:"jp_title_"};this.cssSelector={};$.each(this.cssId,function(a,b){d.cssSelector[a]="#"+b+d.instance});this.options.cssSelectorAncestor||(this.options.cssSelectorAncestor=this.cssSelector["interface"]);
$(this.cssSelector.jPlayer).jPlayer(this.options);var c=this.cssSelector["interface"]+" .jp-previous";$(c).click(function(){d.playlistPrev();$(this).blur();return!1});c=this.cssSelector["interface"]+" .jp-next";$(c).click(function(){d.playlistNext();$(this).blur();return!1});$("#audioPlayerWindow").mousemove(function(){d.startStopRunAudioPlayerWindowTimer(!1)});$("#audioPlayerWindow").mouseleave(function(){d.startStopRunAudioPlayerWindowTimer(!0)});$("#audio-player-box-hide").click(function(){d.showHideAudioPlayerWindow(!1);
return!1});$("#audio-player-box-close").click(function(){if(g_onPlaying&&!confirm(m.getString("msg_close_audio_window_warning")))return!1;d.closeAudioPlayWindow();return!1});$("#audio-player-box-playlist").click(function(){d.showHideAudioList(!d.showAudioList)});$("#audioPlayerStatusWindow").click(function(){d.showHideAudioPlayerWindow(!0)});$("#audioPlayerStatusWindow #close-button").click(function(){if(g_onPlaying&&!confirm(m.getString("msg_close_audio_window_warning")))return!1;d.closeAudioPlayWindow();
...
"");$(c).appendTo(a)},start:function(){var a=this;if(!(this._array.length<=0))this._timer=setInterval(function(){if(a._array.length<=0)clearInterval(a._timer);else if(a._onLoading!=!0){a._onLoading=!0;var b=a._array[0],c=b.item_con,e=b.uhref,b=b.filename,f=g_storage.get("openurl")==void 0?"/":g_storage.get("openurl"),e=g_storage.getl(e);e!=void 0&&e!=""?(a.setImage(c,e),a._array.shift(),a._onLoading=!1):g_webdav_client.GETTHUMBIMAGE(f,b,function(b,d,e){b==200&&(b=parseXml(e),b=$(b).find("thumb_image").text(),
b!=""&&a.setImage(c,b));a._array.shift();a._onLoading=!1})}},100)},stop:function(){this._array=null;clearInterval(this._timer)}};(function(a,b){function c(a){for(var a=a.split(/\s+/),b=[],d=0,c;c=a[d];d++)c=c[0].toUpperCase(),b.push(c);return b}function e(b){return b.id&&a('label[for="'+b.id+'"]').val()||b.name}function f(d,c,t){t||(t=0);c.each(function(){var c=a(this),w=this,n=this.nodeName.toLowerCase(),g,h;n=="label"&&c.find("input, textarea, select").length&&(g=c.text(),c=c.children().first(),w=c.get(0),n=w.nodeName.toLowerCase());switch(n){case "menu":h={name:c.attr("label"),items:{}};t=f(h.items,c.children(),t);break;
case "a":case "button":h={name:c.text(),disabled:!!c.attr("disabled"),callback:function(){return function(){c.click()}}()};break;case "menuitem":case "command":switch(c.attr("type")){case b:case "command":case "menuitem":h={name:c.attr("label"),disabled:!!c.attr("disabled"),callback:function(){return function(){c.click()}}()};break;case "checkbox":h={type:"checkbox",disabled:!!c.attr("disabled"),name:c.attr("label"),selected:!!c.attr("checked")};break;case "radio":h={type:"radio",disabled:!!c.attr("disabled"),
name:c.attr("label"),radio:c.attr("radiogroup"),value:c.attr("id"),selected:!!c.attr("checked")};break;default:h=b}break;case "hr":h="-------";break;case "input":switch(c.attr("type")){case "text":h={type:"text",name:g||e(w),disabled:!!c.attr("disabled"),value:c.val()};break;case "checkbox":h={type:"checkbox",name:g||e(w),disabled:!!c.attr("disabled"),selected:!!c.attr("checked")};break;case "radio":h={type:"radio",name:g||e(w),disabled:!!c.attr("disabled"),radio:!!c.attr("name"),value:c.val(),selected:!!c.attr("checked")};
break;default:h=b}break;case "select":h={type:"select",name:g||e(w),disabled:!!c.attr("disabled"),selected:c.val(),options:{}};c.children().each(function(){h.options[this.value]=a(this).text()});break;case "textarea":h={type:"textarea",name:g||e(w),disabled:!!c.attr("disabled"),value:c.val()};break;case "label":break;default:h={type:"html",html:c.clone(!0)}}h&&(t++,d["key"+t]=h)});return t}a.support.htmlMenuitem="HTMLMenuItemElement"in window;a.support.htmlCommand="HTMLCommandElement"in window;a.support.eventSelectstart=
"onselectstart"in document.documentElement;if(!a.ui||!a.ui.widget){var j=a.cleanData;a.cleanData=function(b){for(var c=0,d;(d=b[c])!=null;c++)try{a(d).triggerHandler("remove")}catch(e){}j(b)}}var d=null,g=!1,h=a(window),k=0,l={},q={},x={},y={selector:null,appendTo:null,trigger:"right",autoHide:!1,delay:200,reposition:!0,determinePosition:function(b){if(a.ui&&a.ui.position)b.css("display","block").position({my:"center top",at:"center bottom",of:this,offset:"0 5",collision:"fit"}).css("display","none");
...
b){d[b]={};e[b]||(e[b]={})});e.accesskeys||(e.accesskeys={});a.each(d.items,function(b,f){var g=a('<li class="context-menu-item"></li>').addClass(f.className||""),h=null,o=null;g.on("click",a.noop);f.$node=g.data({contextMenu:d,contextMenuRoot:e,contextMenuKey:b});if(f.accesskey)for(var j=c(f.accesskey),k=0,l;l=j[k];k++)if(!e.accesskeys[l]){e.accesskeys[l]=f;f._name=f.name.replace(RegExp("("+l+")","i"),'<span class="context-menu-accesskey">$1</span>');break}if(typeof f=="string")g.addClass("context-menu-separator not-selectable");
else if(f.type&&x[f.type])x[f.type].call(g,f,d,e),a.each([d,e],function(c,d){d.commands[b]=f;if(a.isFunction(f.callback))d.callbacks[b]=f.callback});else{if(f.type=="html")g.addClass("context-menu-html not-selectable");else if(f.type)h=a("<label></label>").appendTo(g),a("<span></span>").html(f._name||f.name).appendTo(h),g.addClass("context-menu-input"),d.hasTypes=!0,a.each([d,e],function(a,c){c.commands[b]=f;c.inputs[b]=f});else if(f.items)f.type="sub";switch(f.type){case "text":o=a('<input type="text" value="1" name="" value="">').attr("name",
"context-menu-input-"+b).val(f.value||"").appendTo(h);break;case "textarea":o=a('<textarea name=""></textarea>').attr("name","context-menu-input-"+b).val(f.value||"").appendTo(h);f.height&&o.height(f.height);break;case "checkbox":o=a('<input type="checkbox" value="1" name="" value="">').attr("name","context-menu-input-"+b).val(f.value||"").prop("checked",!!f.selected).prependTo(h);break;case "radio":o=a('<input type="radio" value="1" name="" value="">').attr("name","context-menu-input-"+f.radio).val(f.value||
"").prop("checked",!!f.selected).prependTo(h);break;case "select":o=a('<select name="">').attr("name","context-menu-input-"+b).appendTo(h);f.options&&(a.each(f.options,function(b,c){a("<option></option>").val(b).text(c).appendTo(o)}),o.val(f.selected));break;case "sub":a("<span></span>").html(f._name||f.name).appendTo(g);f.appendTo=f.$node;u.create(f,e);g.data("contextMenu",f).addClass("context-menu-submenu");f.callback=null;break;case "html":a(f.html).appendTo(g);break;default:a.each([d,e],function(c,
d){d.commands[b]=f;if(a.isFunction(f.callback))d.callbacks[b]=f.callback}),a("<span></span>").html(f._name||f.name||"").appendTo(g)}if(f.type&&f.type!="sub"&&f.type!="html"&&(o.on("focus",n.focusInput).on("blur",n.blurInput),f.events))o.on(f.events,d);f.icon&&g.addClass("icon icon-"+f.icon)}f.$input=o;f.$label=h;g.appendTo(d.$menu);if(!d.hasTypes&&a.support.eventSelectstart)g.on("selectstart.disableTextSelect",n.abortevent)});d.$node||d.$menu.css("display","none").addClass("context-menu-root");d.$menu.appendTo(d.appendTo||
...
(c=this.data("contextMenu").$menu)&&c.trigger("contextmenu:hide"):c==="destroy"?a.contextMenu("destroy",{context:this}):a.isPlainObject(c)?(c.context=this,a.contextMenu("create",c)):c?this.removeClass("context-menu-disabled"):c||this.addClass("context-menu-disabled");return this};a.contextMenu=function(c,d){typeof c!="string"&&(d=c,c="create");typeof d=="string"?d={selector:d}:d===b&&(d={});var e=a.extend(!0,{},y,d||{}),f=a(document),h=f,o=!1;!e.context||!e.context.length?e.context=document:(h=a(e.context).first(),
e.context=h.get(0),o=e.context!==document);switch(c){case "create":if(!e.selector)throw Error("No selector specified");if(e.selector.match(/.context-menu-(list|item|input)($|\s)/))throw Error('Cannot bind to selector "'+e.selector+'" as it contains a reserved className');if(!e.build&&(!e.items||a.isEmptyObject(e.items)))throw Error("No Items specified");k++;e.ns=".contextMenu"+k;if(!o)l[e.selector]=e.ns;q[e.ns]=e;if(!e.trigger)e.trigger="right";g||(f.on({"contextmenu:hide.contextMenu":n.hideMenu,
...
".context-menu-item"),g=!0);h.on("contextmenu"+e.ns,e.selector,e,n.contextmenu);if(o)h.on("remove"+e.ns,function(){a(this).contextMenu("destroy")});switch(e.trigger){case "hover":h.on("mouseenter"+e.ns,e.selector,e,n.mouseenter).on("mouseleave"+e.ns,e.selector,e,n.mouseleave);break;case "left":h.on("click"+e.ns,e.selector,e,n.click)}e.build||u.create(e);break;case "destroy":var j;if(o){var r=e.context;a.each(q,function(b,c){if(c.context!==r)return!0;j=a(".context-menu-list").filter(":visible");j.length&&
j.data().contextMenuRoot.$trigger.is(a(c.context).find(c.selector))&&j.trigger("contextmenu:hide",{force:!0});try{q[c.ns].$menu&&q[c.ns].$menu.remove(),delete q[c.ns]}catch(d){q[c.ns]=null}a(c.context).off(c.ns);return!0})}else if(e.selector){if(l[e.selector]){j=a(".context-menu-list").filter(":visible");j.length&&j.data().contextMenuRoot.$trigger.is(e.selector)&&j.trigger("contextmenu:hide",{force:!0});try{q[l[e.selector]].$menu&&q[l[e.selector]].$menu.remove(),delete q[l[e.selector]]}catch(p){q[l[e.selector]]=
null}f.off(l[e.selector])}}else f.off(".contextMenu .contextMenuAutoHide"),a.each(q,function(b,c){a(c.context).off(c.ns)}),l={},q={},k=0,g=!1,a("#context-menu-layer, .context-menu-list").remove();break;case "html5":(!a.support.htmlCommand&&!a.support.htmlMenuitem||typeof d=="boolean"&&d)&&a('menu[type="context"]').each(function(){this.id&&a.contextMenu({selector:"[contextmenu="+this.id+"]",items:a.contextMenu.fromMenu(this)})}).css("display","none");break;default:throw Error('Unknown operation "'+
...
height:c?b.height():b.outerHeight()}}};a.fn.position=function(b){if(!b||!b.of)return s.apply(this,arguments);var b=a.extend({},b),n,j,z,w,t,v,B=a(b.of),C=a.position.getWithinInfo(b.within),D=a.position.getScrollInfo(C),r=(b.collision||"flip").split(" "),p={};v=f(B);if(B[0].preventDefault)b.at="left top";j=v.width;z=v.height;w=v.offset;t=a.extend({},w);a.each(["my","at"],function(){var a=(b[this]||"").split(" "),c,d;a.length===1&&(a=k.test(a[0])?a.concat(["center"]):l.test(a[0])?["center"].concat(a):
["center","center"]);a[0]=k.test(a[0])?a[0]:"center";a[1]=l.test(a[1])?a[1]:"center";c=q.exec(a[0]);d=q.exec(a[1]);p[this]=[c?c[0]:0,d?d[0]:0];b[this]=[x.exec(a[0])[0],x.exec(a[1])[0]]});r.length===1&&(r[1]=r[0]);b.at[0]==="right"?t.left+=j:b.at[0]==="center"&&(t.left+=j/2);b.at[1]==="bottom"?t.top+=z:b.at[1]==="center"&&(t.top+=z/2);n=c(p.at,j,z);t.left+=n[0];t.top+=n[1];return this.each(function(){var f,k,l=a(this),v=l.outerWidth(),q=l.outerHeight(),s=e(this,"marginLeft"),x=e(this,"marginTop"),
y=v+s+e(this,"marginRight")+D.width,G=q+x+e(this,"marginBottom")+D.height,A=a.extend({},t),F=c(p.my,l.outerWidth(),l.outerHeight());b.my[0]==="right"?A.left-=v:b.my[0]==="center"&&(A.left-=v/2);b.my[1]==="bottom"?A.top-=q:b.my[1]==="center"&&(A.top-=q/2);A.left+=F[0];A.top+=F[1];if(!a.support.offsetFractions)A.left=h(A.left),A.top=h(A.top);f={marginLeft:s,marginTop:x};a.each(["left","top"],function(c,d){if(a.ui.position[r[c]])a.ui.position[r[c]][d](A,{targetWidth:j,targetHeight:z,elemWidth:v,elemHeight:q,
collisionPosition:f,collisionWidth:y,collisionHeight:G,offset:[n[0]+F[0],n[1]+F[1]],my:b.my,at:b.at,within:C,elem:l})});b.using&&(k=function(a){var c=w.left-A.left,e=c+j-v,f=w.top-A.top,h=f+z-q,n={target:{element:B,left:w.left,top:w.top,width:j,height:z},element:{element:l,left:A.left,top:A.top,width:v,height:q},horizontal:e<0?"left":c>0?"right":"center",vertical:h<0?"top":f>0?"bottom":"middle"};if(j<v&&g(c+e)<j)n.horizontal="center";if(z<q&&g(f+h)<z)n.vertical="middle";n.important=d(g(c),g(e))>d(g(f),
...
0,l=b.at[0]==="left"?b.targetWidth:b.at[0]==="right"?-b.targetWidth:0,k=-2*b.offset[0];if(c<0){if(d=a.left+h+l+k+b.collisionWidth-e-d,d<0||d<g(c))a.left+=h+l+k}else if(j>0&&(d=a.left-b.collisionPosition.marginLeft+h+l+k-f,d>0||g(d)<j))a.left+=h+l+k},top:function(a,b){var c=b.within,d=c.offset.top+c.scrollTop,e=c.height,f=c.isWindow?c.scrollTop:c.offset.top,h=a.top-b.collisionPosition.marginTop,c=h-f,j=h+b.collisionHeight-e-f,h=b.my[1]==="top"?-b.elemHeight:b.my[1]==="bottom"?b.elemHeight:0,l=b.at[1]===
"top"?b.targetHeight:b.at[1]==="bottom"?-b.targetHeight:0,k=-2*b.offset[1];if(c<0){if(d=a.top+h+l+k+b.collisionHeight-e-d,a.top+h+l+k>c&&(d<0||d<g(c)))a.top+=h+l+k}else if(j>0&&(d=a.top-b.collisionPosition.marginTop+h+l+k-f,a.top+h+l+k>j&&(d>0||g(d)<j)))a.top+=h+l+k}},flipfit:{left:function(){a.ui.position.flip.left.apply(this,arguments);a.ui.position.fit.left.apply(this,arguments)},top:function(){a.ui.position.flip.top.apply(this,arguments);a.ui.position.fit.top.apply(this,arguments)}}};(function(){var b,
...
function open_sharelink_window(a,b){var c="",e="";if(b instanceof Array)for(var f=b.length,j=0;j<f;j++)c+=b[j],j!=f-1&&(c+=";");else c=b;if(!(a==""||c=="")){var f=g_storage.get("webdav_mode"),j=g_storage.get("ddns_host_name"),d=j==""?window.location.host:j;d.indexOf(":")!=-1&&(d=d.substring(0,d.indexOf(":")));var g=isPrivateIP(d),d=f==0?"http://"+d+":"+g_storage.get("http_port"):"https://"+d;g_webdav_client.GSL(a,a,c,86400,1,function(a,b,c){if(a==200)if(a=parseXml(c),a=$(a).find("sharelink").text(),
a=="")alert("Fail to parse xml!");else{a=a.split(";");b=a.length;for(c=0;c<b;c++)e+=d+"/"+a[c],c!=b-1&&(e+=";");a=$("div#modalWindow");g_modal_url="/smb/css/sharelink.html?v="+e+"&b="+g;g_modal_window_width=600;g_modal_window_height=530;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_sharelink"));a&&a.jqmShow()}})}}
function open_upload2service_window(a,b){var c="";if(b instanceof Array)for(var e=b.length,f=0;f<e;f++)c+=b[f],f!=e-1&&(c+=";");else c=b;c!=""&&(e=$("div#modalWindow"),f="",a=="facebook"?(g_modal_url="/smb/css/service/facebook.html",f=m.getString("title_share2facebook")):a=="flickr"&&(g_modal_url="/smb/css/service/flickr.html",f=m.getString("title_upload2flickr")),g_modal_url+="?v="+c,g_modal_window_width=600,g_modal_window_height=370,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(f),
e.jqmShow())}function download_file(a){a!=""&&$.fileDownload(a,{successCallback:function(){},failCallback:function(a,c){window.open(c)}})}
...
function open_uploadfile_window(){if(isBrowser("msie")&&getInternetExplorerVersion()<=9){var a=$("div#modalWindow");g_modal_url="/smb/css/upload_file.html";g_modal_window_width=600;g_modal_window_height=150;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_upload_file"));a.jqmShow()}else g_upload_mode=1,$("div#btnNewDir").css("display","none"),$("div#btnUpload").css("display","none"),$("div#btnPlayImage").css("display","none"),$("div#boxSearch").css("display","none"),$("div#btnListView").css("display",
"none"),$("div#btnThumbView").css("display","none"),$("#upload_panel").css("display","block"),$("#upload_panel").css("left","1999px"),$("#upload_panel").animate({left:"0px"},"slow"),a=addPathSlash(g_storage.get("openurl")),$("#upload_panel iframe").attr("src","/smb/css/upload.html?u="+a+"&d=1"),$("#function_help").text(m.getString("msg_uploadmode_help")),adjustLayout()}
function open_uploadfolder_window(){if(isBrowser("chrome")){g_upload_mode=1;$("div#btnNewDir").css("display","none");$("div#btnUpload").css("display","none");$("div#btnPlayImage").css("display","none");$("div#boxSearch").css("display","none");$("div#btnListView").css("display","none");$("div#btnThumbView").css("display","none");$("#upload_panel").css("display","block");$("#upload_panel").css("left","1999px");$("#upload_panel").animate({left:"0px"},"slow");var a=addPathSlash(g_storage.get("openurl"));
$("#upload_panel iframe").attr("src","/smb/css/upload.html?u="+a+"&d=2");$("#function_help").text(m.getString("msg_uploadmode_help"));adjustLayout()}else a=$("div#modalWindow"),g_modal_url="/smb/css/upload_folder.html",g_modal_window_width=600,g_modal_window_height=150,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_upload_folder")),a.jqmShow()};
