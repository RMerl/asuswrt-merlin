...
height:"100%",left:"0px",top:"0px"},200,null,null).appendTo("body");$("#image_slide_show").barousel({navType:2,manualCarousel:1,contentResize:0,startIndex:e})}}
function openAudioPlayer(a){for(var d=[],b=0;b<g_file_array.length;b++)getFileExt(g_file_array[b].href)=="mp3"&&d.push(g_file_array[b]);if(d.length==0)alert(m.getString("msg_no_image_list"));else{if(isBrowser("xxmsie"))var e="",c=0;else{e="";for(b=c=0;b<d.length;b++){var f=d[b].href;a==f&&(c=b);e+=f;b!=d.length-1&&(e+=",")}}d=$("div#modalWindow");g_modal_url="/smb/css/audio.html?a="+a+"&alist="+e+"&index="+c;g_modal_window_width=450;g_modal_window_height=152;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_audioplayer"));
d&&d.jqmShow()}}function doRescanSamba(){var a=addPathSlash(g_storage.get("openurl"));closeJqmWindow(0);showHideLoadStatus(!0);client.RESCANSMBPC(a,function(a){a[0]==2&&(g_storage.set("HostList",""),doPROPFIND("/"))})}
...
function adjustLayout(){var a=getPageSize(),d=a[0],b=a[1]-$("#header_region").height()-$("#bottom_region").height();$("#main_region").css("height",b);a=a[0];$("#main_region #main_right_region").css("width",a-$("#main_region #main_left_region").width());a=$("#main_left_region").height()-$("#infobar").height()-$("#settingbar").height();b=Math.max(Math.floor(a/40),1)*40;$("#hostview").css("height",b);$("#settingbar").css("padding-top",a-b);var e=0;$("#toolbar .albutton").each(function(){$(this).css("display")==
"block"&&(e+=$(this).width())});$("#urlregion-url").css("width",$("#toolbar").width()-e-20);createOpenUrlUI(g_storage.get("openurl"));a=g_select_mode==1?$("#main_right_container").height()-$("#infobar").height()-$("#button_panel").height():$("#main_right_container").height()-$("#infobar").height();$("#fileview").css("height",a);$("#function_help").css("left",$("#main_left_region").width());(a=$("div#modalWindow"))&&a.css("left",(d-g_modal_window_width)/2)}
function closeJqmWindow(a){g_reload_page=a;a=$("div#modalWindow");$("iframe",a).attr("src","");a&&a.jqmHide();showHideLoadStatus(!1)}function resizeJqmWindow(a,d){var b=$(".jqmWindow");b&&(b.css("width",a+"px"),b.css("height",d+"px"))}function fullscreenJqmWindow(){var a=$("div#modalWindow");a&&(a.css("left","0px"),a.css("top","0px"),a.css("width",window.width+"px"),a.css("height",window.height+"px"))}
...
"D:getip")z=String(j[h].childNodes[0].nodeValue);else if(j[h].nodeName=="D:gettype")B=String(j[h].childNodes[0].nodeValue);else if(j[h].nodeName=="D:getattr"){var t=j[h].childNodes;for(q=0;q<t.length;q++)if(t[q].nodeName=="D:readonly")C=t[q].childNodes[0].nodeValue;else if(t[q].nodeName=="D:hidden")D=t[q].childNodes[0].nodeValue}}}else r[l].nodeType==1&&r[l].nodeName=="D:href"&&(n=String(r[l].childNodes[0].nodeValue),i="",n.match(/^http/)&&(i=window.location.protocol+"//"+window.location.host),h=
i+addPathSlash(a),n!=h?(p=a,n=n.replace(i,""),p=n.replace(addPathSlash(p),""),p!=""?(k=p,s=p=mydecodeURI(p),i=g_listview==0?12:45,s.length>i&&(s=s.substring(0,i)+"...")):n=""):n="");n!=""&&(u=="httpd/unix-directory"?g_folder_array.push({contenttype:u,href:n,name:p,uname:k,shortname:s,online:w,time:x,size:y,ip:z,mac:A,uid:v,type:B,freadonly:C,fhidden:D}):g_file_array.push({contenttype:u,href:n,name:p,uname:k,shortname:s,online:w,time:x,size:y,ip:z,mac:A,uid:v,type:B,freadonly:C,fhidden:D}))}g_folder_array.sort(sortByName);
...
a=="wmv"||a=="avi"||a=="rmvb"||a=="rm"||a=="mpg"||a=="mpeg"||a=="mkv"||a=="mov"||a=="flv")if((b==0||b==2)&&isWinOS())if(isBrowser("msie")&&getInternetExplorerVersion()<=7)alert(m.getString("msg_vlcsupport"));else{var o=$("div#modalWindow"),g=encodeURI(g);this_url=f.substring(0,f.lastIndexOf("/"));client.GSL(this_url,this_url,g,86400,0,function(a,b,c){a==200&&(a=parseXml(c),a=$(a).find("sharelink").text(),b="",a=window.location.protocol+"//"+window.location.host+"/"+a,b="/smb/css/vlc_video.html?v="+
a,b+="&showbutton=1",g_modal_url=b,g_modal_window_width=655,g_modal_window_height=480,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_videoplayer")),o&&o.jqmShow())});return}if(a=="mp3")openAudioPlayer(d);else{if(a=="doc"||a=="docx"||a=="ppt"||a=="pptx"||a=="xls"||a=="xlsx"||a=="pdf")if((isWinOS()||isMacOS())&&!isPrivateIP()){g=encodeURI(g);this_url=f.substring(0,f.lastIndexOf("/"));client.GSL(this_url,this_url,g,86400,0,function(a,b,c){a==200&&(a=parseXml(c),a=$(a).find("sharelink").text(),
b="",a=window.location.protocol+"//"+window.location.host+"/"+a,window.open("https://docs.google.com/viewer?url="+a))});return}a=="jpg"||a=="jpeg"||a=="png"||a=="gif"?openImageViewer(d):window.open(d)}}}
function createLayout(){var a=String(window.navigator.userLanguage||window.navigator.language).toLowerCase(),d=g_storage.get("lan")==void 0?a:g_storage.get("lan");m.setLanguage(d);a="";a+="<div id='header_region' class='unselectable' width='100%' border='0'>";a+="<div id='logo'></div>";a+="<div id='user'>Welcome home, <span id='username'>admin</span>";var b=g_storage.get("last_login_info");b!=""&&b!=void 0&&(b=String(b).split(">"),a+="<span id='login_info'>"+m.getString("title_logininfo")+b[1]+", "+
m.getString("title_ip")+b[2]+"</span>");a+="</div>";a+="<div id='loading'><img src='/smb/css/load.gif'/><div><span>Loading...</span></div></div>";a+="<div class='albutton toolbar-button-right' id='btnHelp'><div class='ticon'></div></div>";a+="</div>";a+="<div id='main_region' class='unselectable'>";a+="<div id='main_left_region' class='unselectable'>";a+="<div id='infobar' class='unselectable'></div>";a+="<div id='hostview' class='unselectable'></div>";a+="<div id='settingbar' class='unselectable'>";
a+="<div id='buttonpanel' class='unselectable'>";a+="<div class='toolbar-button-left' style='width:40px;height:40px;background-color:#FFC000'></div>";a+="<div class='albutton toolbar-button-left' id='btnLogout' style='background-color:#0F4373'><div class='ticon'></div></div>";a+="<div class='albutton toolbar-button-left' id='btnConfig' style='background-color:#578EA2'><div class='ticon'></div></div>";a+="<div class='toolbar-button-left' style='width:40px;height:40px;background-color:#008F6D'></div>";
a+="<div class='albutton toolbar-button-left' id='btnSetting' style='background-color:#6A6A6A'><div class='ticon'></div></div>";a+="<div class='albutton toolbar-button-left' id='btnRefresh' style='background-color:#346948'><div class='ticon'></div></div>";a+="</div>";a+="</div>";a+="</div>";a+="<div id='main_right_region' class='unselectable'>";a+="<div id='main_right_container' class='unselectable'>";a+="<div id='infobar' class='unselectable'>";a+="<div id='toolbar' class='unselectable'>";a+="<div id='urlregion-url'>";
a+="<p id='openurl' align='left' width='150' style='padding-left:10px' ></p>";a+="</div>";a+="<div class='albutton toolbar-button-right' id='btnUpload' style='display:none'><div class='ticon'></div></div>";a+="<div class='albutton toolbar-button-right' id='btnPlayImage' style='display:none'><div class='ticon'></div></div>";a+="<div class='albutton toolbar-button-right' id='btnNewDir' style='display:none'><div class='ticon'></div></div>";a+="<div class='albutton toolbar-button-right' id='btnSelect' style='display:none'><div class='ticon'></div></div>";
a+="<div class='albutton toolbar-button-right' id='btnCancelSelect' style='display:none'><div class='ticon'></div></div>";a+="<div class='albutton toolbar-button-right' id='btnCancelUpload' style='display:none'><div class='ticon'></div></div>";a+="<div class='albutton toolbar-button-right' id='btnChangeUser' style='display:none'><div class='ticon'></div></div>";a+="</div>";a+="</div>";a+="<div id='fileview' class='unselectable'></div>";a+="<div id='button_panel' class='unselectable'>";a+="<div class='abbutton toolbar-button-right disable' id='btnShareLink' style='display:block'><div class='ticon'></div></div>";
a+="<div class='abbutton toolbar-button-right disable' id='btnDeleteSel' style='display:block'><div class='ticon'></div></div>";a+="<div class='abbutton toolbar-button-right disable' id='btnDownload' style='display:block'><div class='ticon'></div></div>";a+="<div class='abbutton toolbar-button-right disable' id='btnRename' style='display:block'><div class='ticon'></div></div>";a+="</div>";a+="<div id='upload_panel' class='unselectable'>";a+="<div style='position:absolute;width:98%;height:100%;padding:10px'>";
a+="<iframe src='' width='100%' height='100%' frameborder='0'/>";a+="</div>";a+="</div>";a+="</div>";a+="</div>";a+="</div>";a+="<div id='bottom_region' class='unselectable'>";a+="<span id='function_help'></span>";a+="<div class='lan'>";a+="<span>"+m.getString("title_language")+"</span>";a+="<select id='menu_lan'>";a+="<option value='en-us' selected>"+m.getString("lan_en")+"</option>";a+="<option value='zh-tw'>"+m.getString("lan_zh-tw")+"</option>";a+="</select>";a+="</div>";a+="</div>";a+="<div id='modalWindow' class='jqmWindow'>";
a+="<div id='jqmTitle'>";a+="<span id='jqmTitleText'></span>";a+="</div>";a+="<div id='jqmMsg'>";a+="<span id='jqmMsgText'></span>";a+="</div>";a+="<iframe id='jqmContent' src='' frameborder='0'>";a+="</div>";$("body").empty();$("body").append(a);$("#menu_lan").children().each(function(){$(this).val()==d&&$(this).attr("selected","true")});$("span#username").click(function(){confirm(m.getString("msg_logout_confirm"))==!0&&doLOGOUT()});$("#btnHelp").attr("title",m.getString("title_help"));$("#btnLogout").attr("title",
...
a.find("misc_http_port").text()),g_storage.set("last_login_info",a.find("last_login_info").text()))})})();var d=g_storage.get("openurl");g_storage.set("HostList","");doPROPFIND("/",function(){d!=void 0&&d!="/"&&doPROPFIND(d);if(g_storage.get("openhostuid")==void 0||g_storage.get("openhostuid")==0){var a="<div id='help_1'>";a+="<div id='help_content'>";a+=m.getString("msg_help");a+="</div>";a+="<div id='help_image'>";a+="</div>";a+="</div>";$("div#fileview").append(a)}},0);$("#modalWindow").jqm({overlay:70,
modal:!0,target:"#jqmContent",onHide:function(a){$(a.w).fadeOut("2000",function(){a.o.remove();g_show_modal=0;if(g_reload_page==1){var d=addPathSlash(g_storage.get("openurl"));doPROPFIND(d)}})},onShow:function(a){var a=$(a.w),d=$("iframe",a),c=($(document).width()-g_modal_window_width)/2;g_show_modal=1;d.attr("src",g_modal_url);a.css({width:g_modal_window_width,height:g_modal_window_height,left:c,top:-g_modal_window_height,opacity:0}).jqmShow().animate({width:g_modal_window_width,height:g_modal_window_height,
top:0,left:c,marginLeft:0,opacity:1},200)}});$("div#btnDeleteSel").click(function(){if(!(g_select_array.length<=0)&&confirm(m.getString("del_files_msg"))==!0){g_selected_files=null;g_selected_files=[];for(var b=0;b<g_select_array.length;b++)g_selected_files.push(g_select_array[b].uhref);client.DELETE(g_selected_files[0],a)}});$("div#btnNewDir").click(function(){var a=$("div#modalWindow");g_modal_url="/smb/css/makedir.html";g_modal_window_width=500;g_modal_window_height=100;$("#jqmMsg").css("display",
"none");$("#jqmTitleText").text(m.getString("title_newdir"));a&&a.jqmShow()});$("div#btnRefresh").click(function(){var a=g_storage.get("openurl");g_storage.set("HostList","");doPROPFIND("/",function(){a=a==void 0?"/":a;a!="/"&&doPROPFIND(a)},0)});$("div#btnLogout").click(function(){confirm(m.getString("msg_logout_confirm"))==!0&&doLOGOUT()});$("div#btnSetting").click(function(){var a=$("div#modalWindow");g_modal_url="/smb/css/setting.html";g_modal_window_width=800;g_modal_window_height=600;$("#jqmMsg").css("display",
"none");$("#jqmTitleText").text(m.getString("title_setting"));a&&a.jqmShow()});$("div#btnShareLink").click(function(){if(!(g_select_array.length<=0)){m.getString("email_subject");for(var a="",d="",c="",f=0;f<g_select_array.length;f++){var g=g_select_array[f].title,o=g_select_array[f].uhref,l=window.location.href;g_select_array[f].isdir!=1&&(g=encodeURI(g),d=l=o.substring(0,o.lastIndexOf("/")),c+=g,c+=";")}var f=g_storage.get("webdav_mode"),i=window.location.host;i.indexOf(":")!=-1&&(i=i.substring(0,
i.indexOf(":")));i=f==0?"http://"+i+":"+g_storage.get("http_port"):"https://"+i;client.GSL(d,d,c,86400,1,function(c,d,e){if(c==200)if(c=parseXml(e),c=$(c).find("sharelink").text(),c=="")alert("Fail to parse xml!");else{c=c.split(";");d=c.length;for(e=0;e<d;e++)a+=i+"/"+c[e],e!=d-1&&(a+="<br><br>");c=$("div#modalWindow");g_modal_url="/smb/css/sharelink.html?v="+a;g_modal_window_width=600;g_modal_window_height=500;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_sharelink"));
c&&c.jqmShow()}})}});$("div#btnDownload").click(function(){if(!(g_select_array.length<=0))for(var a=0;a<g_select_array.length;a++){var d=g_select_array[a].title,c=g_select_array[a].uhref,f=window.location.href;g_select_array[a].isdir!=1&&(d=encodeURI(d),f=c.substring(0,c.lastIndexOf("/")),$.fileDownload(f+"/"+d,{successCallback:function(){},failCallback:function(a,b){window.open(b)}}))}});$("div#btnRename").click(function(){if(g_select_array.length==1){var a=g_select_array[0].title,d=g_select_array[0].uhref,
c=g_select_array[0].isdir,f=$("div#modalWindow");g_modal_url="/smb/css/rename.html?o="+a+"&f="+d+"&d="+c;g_modal_window_width=500;g_modal_window_height=100;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_rename"));f&&f.jqmShow()}});$("div#btnChangeUser").click(function(){$("#main_right_container #fileview").empty();var a=g_storage.get("openurl");client.LOGOUT(a,function(d){d==200&&doPROPFIND(a)})});$("div#btnSelect").click(function(){g_select_mode=1;$("div#btnNewDir").css("display",
"none");$("div#btnUpload").css("display","none");$("div#btnSelect").css("display","none");$("#btnPlayImage").css("display","none");var a=$("div#btnNewDir").width()+$("div#btnUpload").width()+5;$("div#btnCancelSelect").css("display","block");$("div#btnCancelSelect").css("right",a);g_on_button_animation=1;$("div#btnCancelSelect").animate({right:5},500,function(){$(".selectHintDiv").css("display","block");$("#fileview #fileviewicon").each(function(){$(this).addClass("select")});adjustLayout();$("#button_panel").css("left",
"1999px");$("#button_panel").css("display","block");$("#button_panel").animate({left:"0px"},"slow",null,function(){$("#function_help").text(m.getString("msg_selectmode_help"))});g_on_button_animation=0})});$("div#btnSelect2").click(function(){g_select_mode=1;$(".selectHintDiv").css("display","block");$("div#btnNewDir").css("display","none");$("div#btnUpload").css("display","none");$("div#btnSelect").css("display","none");$("div#btnCancelSelect").css("display","block");$("#fileview #fileviewicon").each(function(){$(this).addClass("select")});
adjustLayout();$("#button_panel").css("left","1999px");$("#button_panel").css("display","block");$("#button_panel").animate({left:"0px"},"slow",null,function(){$("#function_help").text(m.getString("msg_selectmode_help"))})});$("div#btnCancelSelect").click(function(){$("div#btnCancelSelect").css("display","none");$("div#btnSelect").css("display","block");$("div#btnSelect").css("right",5);g_on_button_animation=1;$("div#btnSelect").animate({right:85},500,function(){cancelSelectMode();$("div#btnSelect").css("right",
5);g_on_button_animation=0})});$("#btnUpload").click(function(){g_upload_mode=1;$("div#btnNewDir").css("display","none");$("div#btnUpload").css("display","none");$("div#btnSelect").css("display","none");$("#btnPlayImage").css("display","none");$("div#btnCancelUpload").css("display","block");$("#upload_panel").css("display","block");$("#upload_panel").css("left","1999px");$("#upload_panel").animate({left:"0px"},"slow");var a=addPathSlash(g_storage.get("openurl"));$("#upload_panel iframe").attr("src",
"/smb/css/upload.html?u="+a);$("#function_help").text(m.getString("msg_uploadmode_help"));adjustLayout()});$("#btnCancelUpload").click(closeUploadPanel);$("div#hostview").scroll(function(){g_storage.set("hostviewscrollTop",$(this).scrollTop())});$("div#fileview").scroll(function(){g_storage.set("contentscrollLeft",$(this).scrollLeft());g_storage.set("contentscrollTop",$(this).scrollTop())});$("#menu_lan").change(function(){var a=$(this).val();g_storage.set("lan",a);window.location.reload()});$("#btnHelp").click(function(){var a=
getPageSize(),d=$("div#modalWindow");g_modal_window_height=a[1]-30;g_modal_window_width=g_modal_window_height*1.28;g_modal_window_width>a[0]&&(g_modal_window_width=a[0],g_modal_window_height=g_modal_window_width*0.78125);g_modal_url="/smb/css/help.html?showbutton=1";$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_help"));d&&d.jqmShow()});$("#btnConfig").click(function(){var a=g_storage.get("misc_http_enable"),d=g_storage.get("misc_http_port"),c=window.location.host;a==
0&&!isPrivateIP()?alert(m.getString("msg_no_config")):(a=isPrivateIP()?"http://"+c.split(":")[0]:"http://"+c.split(":")[0]+":"+d,window.location=a)});$("#btnPlayImage").click(function(){openImageViewer()});$(window).resize(adjustLayout)});
