...
function doRENAME(a,b){var c=0,e=addPathSlash(g_storage.get("openurl")),f=e+b;$(".wcb").each(function(){b==myencodeURI($(this).attr("data-name"))&&(c=1,$(this).attr("isdir")=="1"?alert(m.getString("folder_already_exist_msg")):alert(m.getString("file_already_exist_msg")))});c!=1&&g_webdav_client.LOCK(a,"",function(b,d,c){if(b!="201")alert(m.getString("msg_already_lock"));else{var g=getLockToken(c);g_webdav_client.MOVE(a,f,function(b){b[0]==2?(doPROPFIND(e),closeJqmWindow(0)):alert(m.getString(b));
g_webdav_client.UNLOCK(a,g,function(a){a!=204&&alert("Unlock error: "+a)})},null,"F",g)}},null)}function getFileViewHeight(){return $("#fileview").height()-20}function closeJqmWindow(a){g_reload_page=a;a=$("div#modalWindow");$("iframe",a).attr("src","");a&&a.jqmHide();showHideLoadStatus(!1)}function resizeJqmWindow(a,b){var c=$(".jqmWindow");c&&(c.css("width",a+"px"),c.css("height",b+"px"))}
...
function parserPropfindXML(a,b,c){if(a){c==!1&&(g_file_array=g_folder_array=null);g_folder_array==null&&(g_folder_array=[]);g_file_array==null&&(g_file_array=[]);for(var e,f,j,d=a.documentElement.childNodes,a=0;a<d.length;a++){var h="",g="",n="",o="",r="",x="",y="",s="",k="",l="",u="",z="",w="",t;j="";for(var v="0",B="",C="0",D=d[a].childNodes,c=0;c<D.length;c++)if(D[c].nodeType==1&&D[c].nodeName=="D:propstat"){var q=D[c].childNodes;for(e=0;e<q.length;e++)if(q[e].nodeName=="D:prop"){var p=q[e].childNodes;
for(f=0;f<p.length;f++)if(!(p[f].childNodes.length<=0))if(p[f].nodeName=="D:getcontenttype")g=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getuniqueid")n=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getonline")x=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getlastmodified")y=String(p[f].childNodes[0].nodeValue);else if(p[f].nodeName=="D:getcontentlength")s=String(size_format(parseInt(p[f].childNodes[0].nodeValue)));else if(p[f].nodeName=="D:getmac")l=
...
1,h.length),o!=""?(t=o,r=o=mydecodeURI(o)):h=""):h="");h!=""&&(g=="httpd/unix-directory"?g_folder_array.push({contenttype:g,href:h,name:o,uname:t,shortname:r,online:x,time:y,size:s,ip:k,mac:l,uid:n,type:u,freadonly:z,fhidden:w,routersyncfolder:v,matadatatitle:B,thumb:C}):g_file_array.push({contenttype:g,href:h,name:o,uname:t,shortname:r,online:x,time:y,size:s,ip:k,mac:l,uid:n,type:u,freadonly:z,fhidden:w,routersyncfolder:v,matadatatitle:B,thumb:C}))}}}
...
f.documentElement.getAttribute("computername");f.documentElement.getAttribute("isusb");for(f=0;f<c.length;f++){var n="",o="",r="",x="",y="",s="",k="",l="",u="",z="",w="",t="",v="",B,C=c[f].childNodes;for(j=0;j<C.length;j++)if(C[j].nodeType==1&&C[j].nodeName=="D:propstat"){var D=C[j].childNodes;for(d=0;d<D.length;d++)if(D[d].nodeName=="D:prop"){var q=D[d].childNodes;for(h=0;h<q.length;h++)if(!(q[h].childNodes.length<=0))if(q[h].nodeName=="D:getcontenttype")o=String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName==
"D:getuniqueid")r=String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName=="D:getonline")s=String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName=="D:getlastmodified")k=String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName=="D:getcontentlength")l=String(size_format(parseInt(q[h].childNodes[0].nodeValue)));else if(q[h].nodeName=="D:getmac")z=String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName=="D:getip")u=String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName=="D:gettype")w=
String(q[h].childNodes[0].nodeValue);else if(q[h].nodeName=="D:getattr"){var p=q[h].childNodes;for(g=0;g<p.length;g++)if(p[g].nodeName=="D:readonly")t=p[g].childNodes[0].nodeValue;else if(p[g].nodeName=="D:hidden")v=p[g].childNodes[0].nodeValue}}}else C[j].nodeType==1&&C[j].nodeName=="D:href"&&(n=String(C[j].childNodes[0].nodeValue),d="",n.match(/^http/)&&(d=window.location.protocol+"//"+window.location.host),h=d+addPathSlash("/"),n!=h?(n=n.replace(d,""),x=n.substring(n.lastIndexOf("/")+1,n.length),
x!=""?(B=x,y=x=mydecodeURI(x),d=g_list_view.get()==0?12:45,y.length>d&&(y=y.substring(0,d)+"...")):n=""):n="");n!=""&&o=="httpd/unix-directory"&&a.push({contenttype:o,href:n,name:x,uname:B,shortname:y,online:s,time:k,size:l,ip:u,mac:z,uid:r,type:w,freadonly:t,fhidden:v})}a.sort(sortByName);for(B=0;B<a.length;B++)a[B].type=="usbdisk"&&arraymove(a,B,0);createHostList(e,a)}},null,1)}catch(a){alert("catch error: "+a)}}
...
m.getString("title_sort_by_artist")+"</div>";a+="</span>";a+="</span>";a+="</div>";a+="</div>";a+="</div>";$(a).appendTo("body");$(".popupmenu").css("left",g_mouse_x-$(".popupmenu").width()+"px");$(".popupmenu").css("top",g_mouse_y-$(".popupmenu").height()+"px");$("#classifyByAlbum").click(function(a){if(g_webdav_client!=null){showHideLoadStatus(!0);var b=g_storage.get("openurl");g_webdav_client.GETMUSICCLASSIFICATION(b==void 0?"/":b,"album",function(a,b,e){a==200?createClassificationView(e,"album"):
a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)});a.preventDefault();return!1}});$("#classifyByArtist").click(function(){if(g_webdav_client!=null){showHideLoadStatus(!0);var a=g_storage.get("openurl");g_webdav_client.GETMUSICCLASSIFICATION(a==void 0?"/":a,"artist",function(a,b,e){a==200?createClassificationView(e,"artist"):a==503&&show_hint_no_mediaserver();showHideLoadStatus(!1)})}})});$("div#hostview").scroll(function(){g_storage.set("hostviewscrollTop",$(this).scrollTop())});$("div#fileview").scroll(function(){g_storage.set("contentscrollLeft",
...
b+"?mobile=1"}else if(a=="favorite")addtoFavorite();else if(a=="config"){var b=g_storage.get("http_enable"),c=g_storage.get("misc_http_enable"),d=g_storage.get("misc_http_port"),h=g_storage.get("misc_https_port"),g=window.location.host,n="http",a=d;c==0&&!isPrivateIP()?alert(m.getString("msg_no_config")):(b=="0"?(n="http",a=d):b=="1"&&(n="https",a=h),isPrivateIP()?b=n+"://"+g.split(":")[0]:(b=n+"://"+g.split(":")[0],a!=""&&(b+=":"+a)),window.location=b)}else a=="help"?(a=$("div#modalWindow"),b=getPageSize(),
g_modal_window_height=b[1]-30,g_modal_window_width=g_modal_window_height*1.28,g_modal_window_width>b[0]&&(g_modal_window_width=b[0],g_modal_window_height=g_modal_window_width*0.78125),g_modal_url="/smb/css/help.html?showbutton=1",$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_help")),a&&a.jqmShow()):a=="rescan_samba"?confirmCancelUploadFile()!=0&&(a=confirm(m.getString("title_desc_rescan")),a==!0&&doRescanSamba()):a=="sharelink"?(a=$("div#modalWindow"),b=getPageSize(),
g_modal_url="/smb/css/setting.html?p=1&s=1",g_modal_window_width=800,g_modal_window_height=b[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),a&&a.jqmShow()):a=="version"?(a=$("div#modalWindow"),b=getPageSize(),g_modal_url="/smb/css/setting.html?p=2&s=1",g_modal_window_width=800,g_modal_window_height=b[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_setting")),a&&a.jqmShow()):a=="crt"?(a=$("div#modalWindow"),b=getPageSize(),
g_modal_url="/smb/css/setting.html?p=3&s=1",g_modal_window_width=800,g_modal_window_height=b[1]-30,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_crt")),a&&a.jqmShow()):a!="test_func"&&a=="test_func2"&&g_webdav_client.NVRAMGET("/","rc_support;webdav_last_login_info",function(a,b,e){a==200?(a=parseXml(e),$(a).find("nvram").each(function(){var a=$(this).attr("key"),b=$(this).attr("value");alert("key="+a+", value="+b)})):alert(a)})});$(".navigation#refresh dt a").click(function(){var a=
g_storage.get("openurl");g_storage.set("HostList","");doPROPFIND("/",function(){a=a==void 0?"/":a;a!="/"&&doPROPFIND(a)},0)});$(".themes_ctrl").click(function(){if(confirmCancelUploadFile()!=0){var a=$(this).attr("id");g_storage.setl("skin",a);window.location.reload()}});$("div#btnPlayImage").click(function(){var a=getPageSize();g_image_player.show("",a[0],a[1],g_file_array)});$("div#boxSearch").keyup(function(){var a=myencodeURI($("div#boxSearch input").val()),b=$(this).attr("uhref"),c=$(this).attr("qtype"),
d=g_storage.get("data-id")==void 0?"":g_storage.get("data-id");doPROPFINDMEDIALIST(b,!1,function(){},c,"0","50",a,"TIMESTAMP","DESC",d)});$("div#logo").click(function(){g_fileview_only!=1&&doPROPFIND("/",function(){g_storage.set("openhostuid","");window.location.reload()},0)});$("#button-select-all").click(function(){g_select_array=null;g_select_array=[];g_select_folder_count=g_select_file_count=0;$("#fileview .wcb").each(function(){var a=!1;var b=$(this),a=b.attr("uhref"),c=b.attr("isdir"),b=myencodeURI(b.attr("data-name"));
a==void 0?a=!1:(c==1?g_select_folder_count++:g_select_file_count++,g_select_array.push({isdir:c,uhref:a,title:b}),a=!0);a&&($(this).find(".item-check").addClass("x-view-selected"),$(this).find(".item-check").show(),$(this).css("background-color","#00C2EB"))});refreshSelectWindow()});$("#button-unselect-all").click(function(){g_select_array=null;g_select_folder_count=g_select_file_count=0;$("#fileview .wcb").each(function(){$(this).find(".item-check").removeClass("x-view-selected");$(this).find(".item-check").hide();
$(this).find(".item-menu").removeClass("x-view-menu-popup");$(this).find(".item-menu").hide();$(this).css("background-color","")});refreshSelectWindow()});$.contextMenu({selector:"div#btnShareLink",trigger:"left",callback:function(a){if(a=="upload2facebook"){if(!(g_select_array.length<=0)){for(var b=[],a=0;a<g_select_array.length;a++){var c=g_select_array[a].uhref,d=getFileExt(c);(d=="jpg"||d=="jpeg"||d=="png"||d=="gif")&&b.push(c)}open_upload2service_window("facebook",b)}}else if(a=="upload2flickr"){if(!(g_select_array.length<=
0)){b=[];for(a=0;a<g_select_array.length;a++)c=g_select_array[a].uhref,d=getFileExt(c),(d=="jpg"||d=="jpeg"||d=="png"||d=="gif")&&b.push(c);open_upload2service_window("flickr",b)}}else if(a=="share2facebook"){if(!(g_select_array.length<=0)){b=g_storage.get("openurl");c=[];for(a=0;a<g_select_array.length;a++)d=g_select_array[a].title,c.push(d);open_sharelink_window("facebook",b,c)}}else if(a=="share2googleplus"){if(!(g_select_array.length<=0)){b=g_storage.get("openurl");c=[];for(a=0;a<g_select_array.length;a++)d=
g_select_array[a].title,c.push(d);open_sharelink_window("googleplus",b,c)}}else if(a=="share2twitter"){if(!(g_select_array.length<=0)){b=g_storage.get("openurl");c=[];for(a=0;a<g_select_array.length;a++)d=g_select_array[a].title,c.push(d);open_sharelink_window("twitter",b,c)}}else if(a=="share2plurk"){if(!(g_select_array.length<=0)){b=g_storage.get("openurl");c=[];for(a=0;a<g_select_array.length;a++)d=g_select_array[a].title,c.push(d);open_sharelink_window("plurk",b,c)}}else if(a=="sharelink"&&!(g_select_array.length<=
0)){b=g_storage.get("openurl");c=[];for(a=0;a<g_select_array.length;a++)d=g_select_array[a].title,c.push(d);open_sharelink_window("other",b,c)}},items:{submenu_upload:{name:m.getString("title_upload2"),disabled:function(){if(g_select_array.length<=0)return!0;for(var a=0;a<g_select_array.length;a++){var b=getFileExt(g_select_array[a].uhref);if(b=="jpg"||b=="jpeg"||b=="png"||b=="gif")return!1}return!0},items:{upload2facebook:{name:m.getString("title_facebook")},upload2flickr:{name:m.getString("title_flickr")}}},
submenu_share:{name:m.getString("title_share2"),items:{share2facebook:{name:m.getString("title_facebook")},share2googleplus:{name:m.getString("title_googleplus")},share2twitter:{name:m.getString("title_twitter")},share2plurk:{name:m.getString("title_plurk")}}},sharelink:{name:m.getString("title_gen_sharelink")}}});$.contextMenu({selector:"div#btnUpload",trigger:"left",callback:function(a){a=="uploadfile"?open_uploadfile_window():a=="uploadfolder"&&open_uploadfolder_window()},items:{uploadfile:{name:m.getString("title_upload_file")},
...
manualCarousel:1,contentResize:0,startIndex:c,storage:g_storage,stringTable:m,enableExifFunc:0,enableShareFunc:0,closeHandler:function(){f.file_array=null;f.settings=null},initCompleteHandler:function(a){f.settings=a}});a=null}}};var g_audioPlayer=null,g_audio_playlist=[],g_onPlaying=!1;function openAudioPlayer(a){for(var b=[],c=0;c<g_file_array.length;c++)getFileExt(g_file_array[c].href)=="mp3"&&b.push(g_file_array[c]);if(b.length==0)alert(m.getString("msg_no_image_list"));else{for(var e="",f=0,c=0;c<b.length;c++){var j=b[c].href;a==j&&(f=c);e+=j;c!=b.length-1&&(e+=",")}get_mp3_url(e,!0,function(a){g_audioPlayer.showHideAudioPlayerWindow(!0,function(){g_audioPlayer.addPlaylist(a,f)})})}}
...
b!=""&&a.setImage(c,b));a._array.shift();a._onLoading=!1})}},100)},stop:function(){this._array=null;clearInterval(this._timer)}};(function(a,b){function c(a){for(var a=a.split(/\s+/),b=[],c=0,d;d=a[c];c++)d=d[0].toUpperCase(),b.push(d);return b}function e(b){return b.id&&a('label[for="'+b.id+'"]').val()||b.name}function f(c,d,t){t||(t=0);d.each(function(){var d=a(this),w=this,l=this.nodeName.toLowerCase(),h,k;l=="label"&&d.find("input, textarea, select").length&&(h=d.text(),d=d.children().first(),w=d.get(0),l=w.nodeName.toLowerCase());switch(l){case "menu":k={name:d.attr("label"),items:{}};t=f(k.items,d.children(),t);break;
...
name:d.attr("label"),radio:d.attr("radiogroup"),value:d.attr("id"),selected:!!d.attr("checked")};break;default:k=b}break;case "hr":k="-------";break;case "input":switch(d.attr("type")){case "text":k={type:"text",name:h||e(w),disabled:!!d.attr("disabled"),value:d.val()};break;case "checkbox":k={type:"checkbox",name:h||e(w),disabled:!!d.attr("disabled"),selected:!!d.attr("checked")};break;case "radio":k={type:"radio",name:h||e(w),disabled:!!d.attr("disabled"),radio:!!d.attr("name"),value:d.val(),selected:!!d.attr("checked")};
break;default:k=b}break;case "select":k={type:"select",name:h||e(w),disabled:!!d.attr("disabled"),selected:d.val(),options:{}};d.children().each(function(){k.options[this.value]=a(this).text()});break;case "textarea":k={type:"textarea",name:h||e(w),disabled:!!d.attr("disabled"),value:d.val()};break;case "label":break;default:k={type:"html",html:d.clone(!0)}}k&&(t++,c["key"+t]=k)});return t}a.support.htmlMenuitem="HTMLMenuItemElement"in window;a.support.htmlCommand="HTMLCommandElement"in window;a.support.eventSelectstart=
"onselectstart"in document.documentElement;if(!a.ui||!a.ui.widget){var j=a.cleanData;a.cleanData=function(b){for(var c=0,d;(d=b[c])!=null;c++)try{a(d).triggerHandler("remove")}catch(e){}j(b)}}var d=null,h=!1,g=a(window),n=0,o={},r={},x={},y={selector:null,appendTo:null,trigger:"right",autoHide:!1,delay:200,reposition:!0,determinePosition:function(b){if(a.ui&&a.ui.position)b.css("display","block").position({my:"center top",at:"center bottom",of:this,offset:"0 5",collision:"fit"}).css("display","none");
...
(b.preventDefault(),b.stopImmediatePropagation(),d=c,c.trigger(a.Event("contextmenu",{data:b.data,pageX:b.pageX,pageY:b.pageY})));c.removeData("contextMenuActive")},mouseenter:function(b){var c=a(this),e=a(b.relatedTarget),v=a(document);if(!e.is(".context-menu-list")&&!e.closest(".context-menu-list").length&&(!d||!d.length))s.pageX=b.pageX,s.pageY=b.pageY,s.data=b.data,v.on("mousemove.contextMenuShow",l.mousemove),s.timer=setTimeout(function(){s.timer=null;v.off("mousemove.contextMenuShow");d=c;c.trigger(a.Event("contextmenu",
...
height:c?b.height():b.outerHeight()}}};a.fn.position=function(b){if(!b||!b.of)return s.apply(this,arguments);var b=a.extend({},b),l,j,z,w,t,v,B=a(b.of),C=a.position.getWithinInfo(b.within),D=a.position.getScrollInfo(C),q=(b.collision||"flip").split(" "),p={};v=f(B);if(B[0].preventDefault)b.at="left top";j=v.width;z=v.height;w=v.offset;t=a.extend({},w);a.each(["my","at"],function(){var a=(b[this]||"").split(" "),c,d;a.length===1&&(a=n.test(a[0])?a.concat(["center"]):o.test(a[0])?["center"].concat(a):
["center","center"]);a[0]=n.test(a[0])?a[0]:"center";a[1]=o.test(a[1])?a[1]:"center";c=r.exec(a[0]);d=r.exec(a[1]);p[this]=[c?c[0]:0,d?d[0]:0];b[this]=[x.exec(a[0])[0],x.exec(a[1])[0]]});q.length===1&&(q[1]=q[0]);b.at[0]==="right"?t.left+=j:b.at[0]==="center"&&(t.left+=j/2);b.at[1]==="bottom"?t.top+=z:b.at[1]==="center"&&(t.top+=z/2);l=c(p.at,j,z);t.left+=l[0];t.top+=l[1];return this.each(function(){var f,n,o=a(this),v=o.outerWidth(),r=o.outerHeight(),s=e(this,"marginLeft"),x=e(this,"marginTop"),
y=v+s+e(this,"marginRight")+D.width,G=r+x+e(this,"marginBottom")+D.height,A=a.extend({},t),F=c(p.my,o.outerWidth(),o.outerHeight());b.my[0]==="right"?A.left-=v:b.my[0]==="center"&&(A.left-=v/2);b.my[1]==="bottom"?A.top-=r:b.my[1]==="center"&&(A.top-=r/2);A.left+=F[0];A.top+=F[1];if(!a.support.offsetFractions)A.left=g(A.left),A.top=g(A.top);f={marginLeft:s,marginTop:x};a.each(["left","top"],function(c,d){if(a.ui.position[q[c]])a.ui.position[q[c]][d](A,{targetWidth:j,targetHeight:z,elemWidth:v,elemHeight:r,
collisionPosition:f,collisionWidth:y,collisionHeight:G,offset:[l[0]+F[0],l[1]+F[1]],my:b.my,at:b.at,within:C,elem:o})});b.using&&(n=function(a){var c=w.left-A.left,e=c+j-v,f=w.top-A.top,g=f+z-r,l={target:{element:B,left:w.left,top:w.top,width:j,height:z},element:{element:o,left:A.left,top:A.top,width:v,height:r},horizontal:e<0?"left":c>0?"right":"center",vertical:g<0?"top":f>0?"bottom":"middle"};if(j<v&&h(c+e)<j)l.horizontal="center";if(z<r&&h(f+g)<z)l.vertical="middle";l.important=d(h(c),h(e))>d(h(f),
