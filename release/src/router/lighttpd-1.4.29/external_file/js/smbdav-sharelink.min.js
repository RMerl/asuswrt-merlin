...
a=$("#jqmContent",c);$("#jqmTitle",c);var e=(getPageSize()[0]-g_modal_window_width)/2;g_show_modal=1;navigator.userAgent.toLowerCase();var b=function(){var a=-1;navigator.appName=="Microsoft Internet Explorer"&&/MSIE ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent)!=null&&(a=parseFloat(RegExp.$1));return a};g_modal_url!=""&&(a.empty(),$("<iframe src='' frameborder='0' width='100%' height='100%'>").appendTo(a),$("iframe",c).attr("src",g_modal_url));isBrowser("msie")&&b()<=8&&(g_modal_window_height+=
