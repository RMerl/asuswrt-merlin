...
b+=c,b+='" isdir="1" uhref="',b+=a[d].href,b+='" title="',b+=a[d].name,b+='" online="',b+=a[d].online,b+='" ip="" mac="',b+=a[d].mac,b+='" uid="',b+=a[d].uid,b+='" freadonly="',b+=a[d].freadonly,b+='" fhidden="',b+=a[d].fhidden,b+=a[d].type=="usbdisk"?'" isusb="1"':'" isusb="0"',b+='">',b+=a[d].shortname,a[d].online=="0"&&c=="2"&&(b+="("+m.getString("title_offline")+")"),b+="</a>",b+="</div>",b+="</td></tr>",b+="<tr><td>",b+='<input type="button" class="btnDownload" value="'+m.getString("func_download")+
'">',b+="</td></tr>",b+="</tbody>",b+="</table>",b+="</div>";for(d=0;d<e.length;d++)k=m.getString("table_filename")+": "+e[d].name+"\n"+m.getString("table_time")+": "+e[d].time+"\n"+m.getString("table_size")+": "+e[d].size,b+='<div class="albumDiv"',b+=' title="',b+=k,b+='">',b+='<table class="thumb-table-parent">',b+="<tbody>",a=getFileExt(String(e[d].href)),a.length>5&&(a=""),b+="<tr><td>",b+=c=="0"?'<div class="picDiv" popupmenu="1" uhref="':'<div class="picDiv" popupmenu="0" uhref="',b+=e[d].href,
b+='">',b+=a=="jpg"||a=="jpeg"||a=="png"||a=="gif"||a=="bmp"?'<div id="fileviewicon" class="imgfileDiv bicon">':a=="mp3"||a=="m4a"||a=="m4r"||a=="wav"?'<div id="fileviewicon" class="audiofileDiv bicon">':a=="mp4"||a=="rmvb"||a=="m4v"||a=="wmv"||a=="avi"||a=="mpg"||a=="mpeg"||a=="mkv"||a=="mov"||a=="flv"||a=="3gp"||a=="m2v"||a=="rm"?'<div id="fileviewicon" class="videofileDiv bicon">':a=="doc"||a=="docx"?'<div id="fileviewicon" class="docfileDiv bicon">':a=="ppt"||a=="pptx"?'<div id="fileviewicon" class="pptfileDiv bicon">':
a=="xls"||a=="xlsx"?'<div id="fileviewicon" class="xlsfileDiv bicon">':a=="pdf"?'<div id="fileviewicon" class="pdffileDiv bicon">':'<div id="fileviewicon" class="fileDiv bicon">',b+='<div class="selectDiv sicon"></div>',b+='<div class="selectHintDiv sicon"></div>',b+="</div></div>",b+="</td></tr>",b+="<tr><td>",b+='<div class="albuminfo" style="font-size:80%">',b+='<a id="list_item" qtype="1" isdir="0" uhref="',b+=e[d].href,b+='" title="',b+=e[d].name,b+='" uid="',b+=e[d].uid,b+='" ext="',b+=a,b+=
'" freadonly="',b+=e[d].freadonly,b+='" fhidden="',b+=e[d].fhidden,b+='">',b+=e[d].shortname,b+="</a>",b+="</div>",b+="</td></tr>",b+="<tr><td>",b+='<input type="button" class="btnDownload" value="'+m.getString("func_download")+'">',b+="</td></tr>",b+="</tbody>",b+="</table>",b+="</div>";$("div#fileview").append(b);$(".picDiv").mousedown(onMouseDownPicDIVHandler);$("input.btnDownload").click(function(){var b=$(this).parents(".thumb-table-parent").find("a#list_item"),a=b.attr("isdir"),b=b.attr("uhref");
a==1?(a=$("div#modalWindow"),g_modal_url="/smb/css/download_folder.html?v="+b+"&p=slhp&a=agt&u="+g_storage.get(g_sharelink_openurl_key),g_modal_window_width=600,g_modal_window_height=150,$("#jqmMsg").css("display","none"),$("#jqmTitleText").text(m.getString("title_download_folder")),a&&a.jqmShow()):window.open(b)});$("input.btnDownloadAll").click(function(){var b=$("div#modalWindow"),a=g_root_path,a=a.substr(0,a.lastIndexOf("/"));g_modal_url="/smb/css/download_folder.html?v="+g_root_path+"&p=slhp&a=agt&u="+
a;g_modal_window_width=600;g_modal_window_height=150;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_download_folder"));b&&b.jqmShow()})}}
...
a=$("#jqmContent",c);$("#jqmTitle",c);var e=(getPageSize()[0]-g_modal_window_width)/2;g_show_modal=1;navigator.userAgent.toLowerCase().indexOf("msie");var b=function(){var a=-1;navigator.appName=="Microsoft Internet Explorer"&&/MSIE ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent)!=null&&(a=parseFloat(RegExp.$1));return a};g_modal_url!=""&&(a.empty(),$("<iframe src='' frameborder='0' width='100%' height='100%'>").appendTo(a),$("iframe",c).attr("src",g_modal_url));isBrowser("msie")&&b()<=8&&(g_modal_window_height+=
