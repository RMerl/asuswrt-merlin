...
document.write('<script type="text/javascript" src="'+TOOLS_PATH+'jquery-1.11.1.min.js"></script>');
document.write('<script type="text/javascript" src="'+TOOLS_PATH+'jquery-ui-1.10.3.custom.min.js"></script>');
