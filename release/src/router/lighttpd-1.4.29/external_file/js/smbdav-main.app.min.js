...
function openLoginWindow(a){var c="",b=function(){var b=$("#table_content input#username").val(),c=$("#table_content input#password").val(),b="Basic "+Base64.encode(b+":"+c);closeDialog();doLOGIN(a,b)},c=a=="/"?m.getString("title_login")+" - AiCloud":m.getString("title_login")+" - "+a.substring(0,35);$("#dialog").remove();var d="";d+="<div data-role='dialog' id='dialog' data-theme='a' data-transition='flip'>";d+="<div data-role='header'>";d+="<h1 id='dialog-title'>"+c+"</h1>";d+="</div>";d+="<div data-role='content' id='dialog-content'>";
...
for(var b=0;b<c.length;b++)a+=c[b],a+="\n\n";a+="</textarea>";a+="</td>";a+="</tr>";a+="<tr>";a+="<td>";a+='<div class="table_block_footer" style="text-align:right">';a+='<button id="email-sharelink" class="btnStyle">'+m.getString("title_share_by_email")+"</button>";a+='<button id="cancel" class="btnStyle">'+m.getString("btn_cancel")+"</button>";a+="</div>";a+="</td>";a+="</tr>";a+="</table>";a+="</div>";a+="</div>";$("body").append(a);$("#table_content #email-sharelink").click(function(){var a="mailto:",
b="";b+=m.getString("msg_sharelink_desc1");b+="%0D%0A%0D%0A";for(var i=0;i<c.length;i++)b+=c[i],b+="%0D%0A%0D%0A";b+=m.getString("msg_sharelink_desc2");a+="?subject="+m.getString("email_subject")+"&body="+b;window.open(a)});$("#table_content #sms-sharelink").click(function(){var a="sms:",b="";b+=m.getString("msg_sharelink_desc1");b+="%0D%0A%0D%0A";$("p#share_link").each(function(){b+=$(this).text();b+="%0D%0A%0D%0A"});b+=m.getString("msg_sharelink_desc2");a+="?subject="+m.getString("email_subject")+
"&body="+b;window.open(a)});$("textarea#share_link").click(function(){$(this).select()});$("#table_content #cancel").click(function(){closeDialog()});openDialog("pop","dialog")}
...
c+="<h2>"+m.getString("title_version")+"</h2>";c+="<span id='version'>"+m.getString("title_version")+": "+g_storage.get("router_version")+"</span>";c+="<br><span id='update' style='color:red'></span>";c+="</div>";c+="<div data-role='collapsible'>";c+="<h2>"+m.getString("title_language")+"</h2>";c+="<div data-role='controlgroup'>";for(var b=0;b<g_support_lan.length;b++)c+="<label for='"+g_support_lan[b]+"'>"+m.getString("lan_"+g_support_lan[b])+"</label>",c+="<input type='radio' id='"+g_support_lan[b]+
"' name='group_lan' value='"+g_support_lan[b]+"'",g_support_lan[b]==a&&(c+=" checked"),c+=">";c+="</div>";c+="</div>";c+="</div>";c+="</div>";c+="</div>";$("body").append(c);getLatestVersion();refreshShareLinkList();$("#rescan").click(function(){doRescanSamba()});$("#back").click(function(){closeDialog()});$("input[type=radio]").click(function(){var a=$(this).attr("id");g_storage.set("lan",a);window.location.reload()});openDialog("flip","page")}
function showHideAudioList(a){a?$(".jp-playlist").css("display","block"):$(".jp-playlist").css("display","none");g_showAudioList=a}function showHideAudioInterface(a){a?$("#jp_interface_1").css("display","block"):$("#jp_interface_1").css("display","none")}
...
b+='<tr style="height:80px">';b+="<td>";b+='<div id="container">';b+='<div id="jquery_jplayer_1" class="jp-jplayer"></div>';b+='<div id="jp_container_1" class="jp-audio">';b+='<div class="jp-type-playlist">';b+='<div id="jp_title_1" class="jp-title">';b+="<ul>";b+="<li></li>";b+="</ul>";b+="</div>";b+='<div id="jp_interface_1" class="jp-gui jp-interface">';b+='<ul class="jp-controls">';b+='<li><a href="javascript:;" class="jp-previous" tabindex="1">previous</a></li>';b+='<li><a href="javascript:;" class="jp-play" tabindex="1" style="display: block; ">play</a></li>';
b+='<li><a href="javascript:;" class="jp-pause" tabindex="1" style="display: block; ">pause</a></li>';b+='<li><a href="javascript:;" class="jp-next" tabindex="1">next</a></li>';b+='<li><a href="javascript:;" class="jp-stop" tabindex="1">stop</a></li>';b+='<li><a href="javascript:;" class="jp-mute" tabindex="1" title="mute">mute</a></li>';b+='<li><a href="javascript:;" class="jp-volume-max" tabindex="1" title="max volume">max volume</a></li>';b+="</ul>";b+='<div class="jp-progress">';b+='<div class="jp-seek-bar" style="width: 100%; ">';
b+='<div class="jp-play-bar" style="width: 46.700506341691536%; "></div>';b+="</div>";b+="</div>";b+='<div class="jp-volume-bar">';b+='<div class="jp-volume-bar-value" style="width: 31.979694962501526%; "></div>';b+="</div>";b+='<div class="jp-duration">00:00</div>';b+='<div class="jp-split">/</div>';b+='<div class="jp-current-time">00:00</div>';b+="</div>";b+='<div id="jp_playlist_1" class="jp-playlist">';b+="<ul></ul>";b+="</div>";b+='<div class="jp-no-solution" style="display: none; ">';b+="<span>Update Required</span>";
b+='To play the media you will need to either update your browser to a recent version or update your <a href="http://get.adobe.com/flashplayer/" target="_blank">Flash plugin</a>.';b+="</div>";b+="</div>";b+="</div>";b+="</div>";b+="</td>";b+="</tr>";b+='<tr style="height:10px"></tr>';b+="<tr>";b+="<td>";b+='<div class="table_block_footer" style="text-align:right">';b+='<button id="playlist" class="btnStyle">PlayList</button>';b+='<button id="cancel" class="btnStyle">Close</button>';b+="</div>";b+=
"</td>";b+="</tr>";b+="</table>";b+="</div>";$("body").append(b);$("#jp_title_1 li").text("Loading...");$("#playlist").css("visibility","hidden");$("#audio_dialog #playlist").click(function(){showHideAudioList(!g_showAudioList)});$("#audio_dialog #cancel").click(function(){$("#jquery_jplayer_1").jPlayer("stop");$("#jquery_jplayer_1").jPlayer("clearMedia");$.mobile.changePage("#mainpage","popup",!0,!0)});var i=0,f=!1;generate_sharelink=1;if(generate_sharelink==1){var k=window.location.host;k.indexOf(":")!=
-1&&(k=k.substring(0,k.indexOf(":")));var k="http://"+k+":"+g_storage.get("http_port")+"/",l=setInterval(function(){if(f==!1)if(i<0||i>d.length-1)clearInterval(l),initJPlayer(),showHideLoadStatus(!1),$.mobile.changePage("#audio_dialog",{transition:"pop",role:"dialog"});else{var a=d[i],b=a.substring(a.lastIndexOf("/")+1,a.length),a=a.substring(0,a.lastIndexOf("/"));f=!0;client.GSL(a,a,b,0,0,function(a,c,d){if(a==200)a=parseXml(d),a=$(a).find("sharelink").text(),a=k+a,f=!1,c=[],c.name=mydecodeURI(b),
c.mp3=a,g_audio_playlist.push(c),i++})}},100)}else{for(b=0;b<d.length;b++)e=d[b],a=e.substring(e.lastIndexOf("/")+1,e.length),e.substring(0,e.lastIndexOf("/")),c=[],c.name=mydecodeURI(a),c.mp3=e,g_audio_playlist.push(c);initJPlayer();showHideLoadStatus(!1);$.mobile.changePage("#audio_dialog",{transition:"pop",role:"dialog"})}}}}
...
function createOpenUrlUI(a){a==void 0&&(a="/");var c=mydecodeURI(a),b="",d="",e="",i=$("#urlregion-url").width();if(c!="/")for(var c=c.split("/"),a=a.split("/"),f=0;f<c.length;f++)if(!(c[f]==""||g_enable_aidisk==1&&c[f]==g_aidisk_name)){d+="/"+a[f];e+=" / <a id='url_path' uhref='"+d+"'>"+c[f]+"</a>";if(String(e).width($("p#openurl").css("font"))>i){b+=" / ...";break}b+=c[1]==g_aidisk_name&&g_enable_aidisk==1?" / <a id='url_path' uhref='/"+g_aidisk_name+d+"'>"+c[f]+"</a>":" / <a id='url_path' uhref='"+
d+"'>"+c[f]+"</a>";e=b}$("p#openurl").empty();$("p#openurl").append(b);$("a#url_path").click(function(){doPROPFIND($(this).attr("uhref"))})}
function doPROPFIND(a,c,b){if(client!=null){showHideLoadStatus(!0);try{client.PROPFIND(a,b,function(b,d,f){if(b){if(b==207){cancelSelectMode();closeUploadPanel();g_folder_array=[];g_file_array=[];if(window.DOMParser)b=new DOMParser,d=b.parseFromString(f,"text/xml");else if(d=new ActiveXObject("Microsoft.XMLDOM"),d.async="false",d.loadXML(f),!d.documentElement){alert("Fail to load xml!");showHideLoadStatus(!1);return}var k,l,o,g,p,G=d.documentElement.childNodes,f=d.documentElement.getAttribute("qtype");
d.documentElement.getAttribute("readonly");b=d.documentElement.getAttribute("ruser");d.documentElement.getAttribute("computername");d=d.documentElement.getAttribute("isusb");for(k=0;k<G.length;k++){var n="",t="",u="",q="",v="",w="",x="",y="",z="",A="",B="",C="",D="",j,E="0",r=G[k].childNodes;for(l=0;l<r.length;l++)if(r[l].nodeType==1&&r[l].nodeName=="D:propstat"){var F=r[l].childNodes;for(o=0;o<F.length;o++)if(F[o].nodeName=="D:prop"){var h=F[o].childNodes;for(g=0;g<h.length;g++)if(!(h[g].childNodes.length<=
0))if(h[g].nodeName=="D:getcontenttype")t=String(h[g].childNodes[0].nodeValue);else if(h[g].nodeName=="D:getuniqueid")u=String(h[g].childNodes[0].nodeValue);else if(h[g].nodeName=="D:getonline")w=String(h[g].childNodes[0].nodeValue);else if(h[g].nodeName=="D:getlastmodified")x=String(h[g].childNodes[0].nodeValue);else if(h[g].nodeName=="D:getcontentlength")y=String(size_format(parseInt(h[g].childNodes[0].nodeValue)));else if(h[g].nodeName=="D:getmac")A=String(h[g].childNodes[0].nodeValue);else if(h[g].nodeName==
"D:getip")z=String(h[g].childNodes[0].nodeValue);else if(h[g].nodeName=="D:gettype")B=String(h[g].childNodes[0].nodeValue);else if(h[g].nodeName=="D:getattr"){var s=h[g].childNodes;for(p=0;p<s.length;p++)if(s[p].nodeName=="D:readonly")C=s[p].childNodes[0].nodeValue;else if(s[p].nodeName=="D:hidden")D=s[p].childNodes[0].nodeValue}else h[g].nodeName=="D:getroutersync"&&(E=String(h[g].childNodes[0].nodeValue))}}else r[l].nodeType==1&&r[l].nodeName=="D:href"&&(n=String(r[l].childNodes[0].nodeValue),o=
"",n.match(/^http/)&&(o=window.location.protocol+"//"+window.location.host),g=o+addPathSlash(a),n!=g?(n=n.replace(o,""),q=n.substring(n.lastIndexOf("/")+1,n.length),q!=""?(j=q,v=q=mydecodeURI(q)):n=""):n="");n!=""&&(t=="httpd/unix-directory"?g_folder_array.push({contenttype:t,href:n,name:q,uname:j,shortname:v,online:w,time:x,size:y,ip:z,mac:A,uid:u,type:B,freadonly:C,fhidden:D,routersyncfolder:E}):g_file_array.push({contenttype:t,href:n,name:q,uname:j,shortname:v,online:w,time:x,size:y,ip:z,mac:A,
...
$("ul#list").listview("refresh"),$("ul#list").find("li:last").slideDown(300);var i=0;g_timer_filelist=setInterval(function(){if(i<0||i>d.length-1)clearInterval(g_timer_filelist);else{var a=i;m.getString("table_time");m.getString("table_size");var b=getFileExt(String(d[a].href));b.length>5&&(b="");var c="";c+='<li data-theme="c" id="list_item" qtype="1" isdir="0" uhref="';c+=d[a].href;c+='" title="';c+=d[a].name;c+='" uid="';c+=d[a].uid;c+='" ext="';c+=b;c+='" freadonly="';c+=d[a].freadonly;c+='" fhidden="';
...
function addtoFavorite(){var a="https://"+g_storage.get("ddns_host_name"),c=isBrowser("msie");if(a==""||a==void 0)a="https://www.asusnetwork.net/";if(typeof window.sidebar=="object"&&typeof window.sidebar.addPanel=="function")return window.sidebar.addPanel("AiCloud",a,""),!1;else if(c&&typeof window.external=="object")return window.external.AddFavorite(a,"AiCloud"),!1;else{window.location=a;var a=navigator.userAgent.toLowerCase(),c="",b=a.indexOf("webkit")!=-1,d=a.indexOf("mac")!=-1;if(a.indexOf("konqueror")!=
...
a.find("ddns_host_name").text()),g_storage.set("router_version",a.find("version").text()),a=g_storage.get("last_login_info"),a!=""&&a!=void 0&&(a=String(a).split(">"),a=m.getString("title_logininfo")+a[1]+", "+m.getString("title_ip")+a[2],$("#login_info").text(a)))})}
...
b=f=e.substring(0,e.lastIndexOf("/"));d+=c;d+=";"});if(d=="")alert("Please select files first.");else{var e=g_storage.get("webdav_mode"),i=g_storage.get("ddns_host_name"),f=i==""?window.location.host:i;f.indexOf(":")!=-1&&(f=f.substring(0,f.indexOf(":")));isPrivateIP(f);f=e==0?"http://"+f+":"+g_storage.get("http_port"):"https://"+f;client.GSL(b,b,d,86400,1,function(b,d,e){if(b==200)if(b=parseXml(e),b=a(b).find("sharelink").text(),b=="")alert("Fail to parse xml!");else{b=b.split(";");d=b.length;for(e=
0;e<d;e++)c+=f+"/"+b[e],e!=d-1&&(c+=";");openShareWindow(c)}})}});a("a#btn-delete").live("click",function(){var c=function(a){a&&a[0]!=2?alert(m.getString(a)+" : "+decodeURI(g_selected_files[0])):(g_selected_files.splice(0,1),g_selected_files.length<=0?(a=addPathSlash(g_storage.get("openurl")),doPROPFIND(a)):client.DELETE(g_selected_files[0],c))};g_selected_files=null;g_selected_files=[];a("li#list_item.selected").each(function(){a(this).attr("uhref");g_selected_files.push(a(this).attr("uhref"))});
