...
a+="</div>";a+="</div>";$(a).animate({width:"100%",height:"100%",left:"0px",top:"0px"},200,null,null).appendTo("body");$("#image_slide_show").barousel({navType:2,manualCarousel:1,contentResize:0,startIndex:e})}}function openDialog(a,c){$.mobile.changePage("#dialog",{transition:a,role:c})}function closeDialog(){$.mobile.changePage("#mainpage","popup",!0,!0)}
