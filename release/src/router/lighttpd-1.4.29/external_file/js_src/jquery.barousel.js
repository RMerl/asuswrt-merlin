	        ...
	        settings.contextMenu = $.contextMenu({
				...
				callback: function(key, options) {
					if(key=="upload2facebook"){
						...
						selectFileArray.push(currentImage.attr("file"));
						open_sharelink_window("facebook", settings.storage.get('openurl'), selectFileArray);
						...
						var selectFileArray = new Array(0);
						selectFileArray.push(currentImage.attr("file"));
						open_sharelink_window("googleplus", settings.storage.get('openurl'), selectFileArray);
						selectFileArray = null;
					}
						...
						var selectFileArray = new Array(0);
						selectFileArray.push(currentImage.attr("file"));
						open_sharelink_window("twitter", settings.storage.get('openurl'), selectFileArray);
						selectFileArray = null;
					}
						...
						var selectFileArray = new Array(0);
						selectFileArray.push(currentImage.attr("file"));
						open_sharelink_window("plurk", settings.storage.get('openurl'), selectFileArray);
						selectFileArray = null;
					}
						...
						var selectFileArray = new Array(0);
						selectFileArray.push(currentImage.attr("file"));
						open_sharelink_window("weibo", settings.storage.get('openurl'), selectFileArray);
						selectFileArray = null;
					}
						...
						var selectFileArray = new Array(0);
						selectFileArray.push(currentImage.attr("file"));
						open_sharelink_window("qq", settings.storage.get('openurl'), selectFileArray);
						selectFileArray = null;
					}
		        },
		        items: {
