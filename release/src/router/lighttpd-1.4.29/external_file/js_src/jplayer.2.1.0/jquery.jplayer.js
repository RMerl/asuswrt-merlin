...
*/
		...
		_init: function() {
			...
			this.internal.flash = $.extend({}, {
				...
				//swf: this.options.swfPath + (this.options.swfPath.toLowerCase().slice(-4) !== ".swf" ? (this.options.swfPath && this.options.swfPath.slice(-1) !== "/" ? "/" : "") + "Jplayer_flex.swf" : "")
			});
			...
			if(this.flash.used) {
    			...
    			htmlObj = document.createElement("embed");
					htmlObj.setAttribute("id", this.internal.flash.id);
					htmlObj.setAttribute("name", this.internal.flash.id);
					htmlObj.setAttribute("src", this.internal.flash.swf);
					htmlObj.setAttribute("type", "application/x-shockwave-flash");
					htmlObj.setAttribute("width", "500"); // Non-zero
					htmlObj.setAttribute("height", "100"); // Non-zero
					htmlObj.setAttribute("allowScriptAccess", "always");
					htmlObj.setAttribute("FlashVars", flashVars);
					htmlObj.setAttribute("bgcolor", "#ff0000");
					htmlObj.setAttribute("wmode", this.options.wmode);
					htmlObj.setAttribute("pluginspage", "http://www.adobe.com/go/getflashplayer");
  			}*/
				else {
