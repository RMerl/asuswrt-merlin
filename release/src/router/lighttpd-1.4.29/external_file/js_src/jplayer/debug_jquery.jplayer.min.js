...
*/
		...
		jPlayerFlashEvent: function(eventType, status) { // Called from Flash
			if(eventType === $.jPlayer.event.ready) {				
				if(!this.internal.ready) {
					...
					this.internal.flash.jq.css({'width':'1px', 'height':'1px'}); // Once Flash generates the ready event, minimise to zero as it is not affected by wmode anymore.
		...
		_flash_resetMedia: function() {
			...
			//- Jerry modify
			this.internal.flash.jq.css({'width':'1px', 'height':'1px'}); // Must do via CSS as setting attr() to zero causes a jQuery error in IE.
			
			this._flash_pause(NaN);
		},
		_flash_clearMedia: function() {
			try {
				//alert("_flash_clearMedia");
