...
function initial(){
	...
	if( enable_webdav == "1" ){
		...
		if( ip_type == 1 ){
			...
			$("aicloud_main_text").innerHTML = 'Invalid IP Address! You can set wan ip <a href="Advanced_WAN_Content.asp" style="text-decoration:underline">here</a>, or go to <a href="https://www.asusnetwork.net/" style="text-decoration:underline">aicloud</a>.';
		}
	}
	else{
		process_times = 3;
