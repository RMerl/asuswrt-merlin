...
#define SHELL_FILE    "/tmp/smartsync/sambaclient/script/write_nvram"
#define GET_NVRAM     "/tmp/smartsync/sambaclient/script/sambaclient_get_nvram"
#define TMP_CONFIG    "/tmp/smartsync/sambaclient/config/smb_tmpconfig"
#define CONFIG_PATH   "/tmp/smartsync/sambaclient/config/smbclient.conf"
#define GET_INTERNET  "/tmp/smartsync/sambaclient/script/sambaclient_get_internet"
#define VAL_INTERNET  "/tmp/smartsync/sambaclient/config/smb_val_internet"
#define LOG_DIR       "/tmp/smartsync/.logs/sambaclient"
#define CONFLICT_DIR  "/tmp/smartsync/.logs/sambaclient_errlog"
