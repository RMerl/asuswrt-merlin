...
#define CONFIG_ARC_MUC_MAPPED_SIZE	(RUBY_MAX_DRAM_SIZE - CONFIG_ARC_MUC_MAPPED_BASE)
	...
	#define TOPAZ_HBM_BUF_EMAC_RX_BASE	CONFIG_ARC_AUC_END
	#define TOPAZ_HBM_BUF_EMAC_RX_END	(TOPAZ_HBM_BUF_EMAC_RX_BASE +	\
							TOPAZ_HBM_BUF_EMAC_RX_TOTAL)
	#define TOPAZ_HBM_BUF_WMAC_RX_BASE	TOPAZ_HBM_BUF_EMAC_RX_END
	...
	#define TOPAZ_FWT_MCAST_IPMAP_BASE	TOPAZ_HBM_BUF_WMAC_RX_END
