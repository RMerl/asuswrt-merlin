...
#define QFCAP_WIRELESS2 	0x04       //for to get 5G information
...
{
    PPTP_OPTION_NO=0x00,           //
    PPTP_OPTION_NOENCRYPT,         //­ì¥»¬O PPTP_OPTION_NOENCRYPT =0x00//20100813
    PPTP_OPTION_MPPE40,
    PPTP_OPTION_MPPE56,
    PPTP_OPTION_MPPE128
};
