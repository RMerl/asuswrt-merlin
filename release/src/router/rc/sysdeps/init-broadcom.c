...
#if (defined(RTCONFIG_BCM7)||defined(RTCONFIG_BCM7114)) && defined(BCM_BSD)
...
#endif
#if defined(RTAC3200) || (defined(RTCONFIG_BCMWL6) && defined(RTCONFIG_WIRELESSREPEATER))
#ifdef RTAC3200
	if (is_psta(unit))
#else
	if (is_ure(unit))
