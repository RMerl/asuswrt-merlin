...
/* Define to 1 if you have the declaration of `clear_inode', and to 0 if you
   don't. */
#define HAVE_DECL_CLEAR_INODE 0
...
/* Define to 1 if you have the declaration of `d_make_root', and to 0 if you
   don't. */
#define HAVE_DECL_D_MAKE_ROOT 0
...
#define HAVE_DECL_FST_GETSB_V1 0

/* int (*statfs) (struct dentry *, struct kstatfs *); */
#define HAVE_DECL_FST_GETSB_V2 1
...
/* int generic_permission(struct inode *, int, int (*check_acl)(struct inode
   *, int)); */
#define HAVE_DECL_GENERIC_PERMISSION_V4 1
...
#define HAVE_DECL_INOP_CREATE_V4 0
...
/* Define to 1 if `sync_page' is member of `struct address_space_operations'.
   */
#define HAVE_STRUCT_ADDRESS_SPACE_OPERATIONS_SYNC_PAGE 1
...
#define HAVE_STRUCT_INODE_OPERATIONS_FALLOCATE 1
...
/* #undef HAVE_STRUCT_SUPER_BLOCK_S_D_OP */
