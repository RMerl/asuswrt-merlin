...
__attribute__((section("__versions"))) = {
	...
	{ 0x7d11c268, "jiffies" },
	{ 0x95cd64bd, "truncate_setsize" },
	{ 0x9652aa7b, "mutex_trylock" },
	{ 0xe2d5255a, "strcmp" },
	{ 0x206d8b6, "param_ops_string" },
	{ 0x222f6b96, "set_bh_page" },
	{ 0x6ef68c2d, "invalidate_bdev" },
	...
	{ 0x5a480ea3, "end_buffer_read_sync" },
	{ 0x55db7ab4, "get_sb_bdev" },
	{ 0x9bffe1c3, "sb_set_blocksize" },
	...
	{ 0xf692420c, "writeback_inodes_sb" },
	{ 0x99bb8806, "memmove" },
