...
#          machines. +O4 optimization of the libcrypto-1.0.0q.sl shared library may
...
(cd /usr/local/ssl/lib ; ln -sf libcrypto-1.0.0q.sl.0.9.8 libcrypto-1.0.0q.sl ; ln -sf libssl-1.0.0q.sl.0.9.8 libssl-1.0.0q.sl)
...
make clean
make DIRS="crypto ssl"
chmod 644 libcrypto-1.0.0q.a libssl-1.0.0q.a
cp -p libcrypto-1.0.0q.a libssl-1.0.0q.a /usr/local/ssl/lib
