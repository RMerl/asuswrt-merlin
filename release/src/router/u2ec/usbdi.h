...
}__attribute__((packed)) USBD_VERSION_INFORMATION, *PUSBD_VERSION_INFORMATION;
...
}__attribute__((packed)) USBD_PIPE_TYPE;
...
}__attribute__((packed)) USBD_DEVICE_INFORMATION, *PUSBD_DEVICE_INFORMATION;
...
typedef struct _USBD_PIPE_INFORMATION {
    ...
    ULONG MaximumTransferSize; // Maximum size for a single request
                               // in bytes.
    ULONG PipeFlags;
}__attribute__((packed)) USBD_PIPE_INFORMATION, *PUSBD_PIPE_INFORMATION;
...
#endif    
}__attribute__((packed)) USBD_INTERFACE_INFORMATION, *PUSBD_INTERFACE_INFORMATION;
...
}__attribute__((packed)) USBD_ISO_PACKET_DESCRIPTOR, *PUSBD_ISO_PACKET_DESCRIPTOR;
