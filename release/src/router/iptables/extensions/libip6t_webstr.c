...
static
struct ip6tables_match webstr
= { 
    .next = NULL,
    .name = "webstr",
    .version = IPTABLES_VERSION,
    .size = IP6T_ALIGN(sizeof(struct ipt_webstr_info)),
    .userspacesize = IP6T_ALIGN(sizeof(struct ipt_webstr_info)),
    .help = &help,
    .init = &init,
    .parse = &parse,
