# Broadcom platform
export RT-AC66U := IPV6SUPP=y HTTPS=y MIPS32=r2 BCM57=y NTFS=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=y MEDIASRV=y MODEM=y BECEEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y WEBDAV=n CLOUDSYNC=n USB="USB" GRO=y APP="installed" BUILD_NAME="RT-AC66U" PROXYSTA=y DNSMQ=y LFP=y NVRAM_64K=y RTAC66U=y BCMWL6=y BCMNAND=y SSH=y JFFS2=y DUALWAN=y MODEMPIN=y OPENVPN=n
