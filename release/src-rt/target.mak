...
export RT-AC66U := IPV6SUPP=y HTTPS=y MIPS32=r2 BCM57=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=y \
                   ...
                   FTPCLIENT=y SAMBACLIENT=y SWEBDAVCLIENT=y TOR=y \
                   TFAT=n HFS="none" NTFS="paragon" IPSEC=y REPEATER=y DUALWAN=y YANDEXDNS=n DNSFILTER=y SAMBA36=y
...
export RT-AC68U_BASE := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
                        ...
                        TIMEMACHINE=y MDNS=y VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y BCMFA=y XHCIMODE=y BWDPI=y ADBLOCK=y \
...
export RT-AC56_BASE := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y ROMCCODE=y \
                   SAMBA3=y MEDIASRV=y MODEM=y MODEMPIN=y BECEEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y \
                   WEBDAV=y CLOUDSYNC=y USB="USB" GRO=y APP="nolocaldm" PROXYSTA=y \
                   DNSMQ=y SHP=y NVRAM_64K=y RTAC56U=y BCMWL6=y BCMWL6A=y TUNEK="n" BCM5301X=y DISK_MONITOR=y \
                   BTN_WIFITOG=y TURBO=y BCM4352_5G=y LANWAN_LED=y OPTIMIZE_XBOX=y ODMPID=y DROPBOXCLIENT=y \
                   LED_ALL=y XHCI=y SSH=y JFFS2=y NFS=y OPENVPN=y LINUX_MTD="64" USER_LOW_RSSI=y ROG=y EMAIL=y \
                   TIMEMACHINE=y MDNS=y VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y XHCIMODE=y ADBLOCK=y \
                   TEMPROOTFS=y FTPCLIENT=y SAMBACLIENT=y SWEBDAVCLIENT=y SNMPD=y DEBUGFS=y BWDPI=y TOR=y \
                   TFAT=y HFS="tuxera" NTFS="tuxera" IPSEC=n REPEATER=y DUALWAN=y DNSFILTER=y SAMBA36=y

export RT-AC56U := $(RT-AC56U_BASE)
export RT-AC56U := BUILD_NAME="RT-AC56U" BCMSMP=y BCMFA=y

export RT-AC56S := $(RT-AC56_BASE)
export RT-AC56S := BUILD_NAME="RT-AC56S" ARMCPUSMP=up
...
export RT-AC87U := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y WPS_DUALBAND=y ROG=y \
                   ...
                   QTN=y TFTP=y LINUX_MTD="64" RGMII_BRCM5301X=y BWDPI=y RTAC87U=y EXT_LED_WPS=y DEBUGFS=y ADBLOCK=y \
...
export RT-AC3200 := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=y MEDIASRV=y \
                    ...
                    USB="USB" GRO=y APP="installed" BUILD_NAME="RT-AC3200" PROXYSTA=y DNSMQ=y SHP=y NVRAM_64K=y \
                    ...
                    TEMPROOTFS=y SSH=y DROPBOXCLIENT=y FTPCLIENT=y SAMBACLIENT=y NOWL=y EMAIL=y DISABLE_REPEATER_UI=y \
                    STAINFO=y ADBLOCK=y NFS=y IPSEC=n DNSFILTER=y SAMBA36=y SNMPD=y TOR=y

export RT-N18U 	:= IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
		   SAMBA3=y MEDIASRV=y MODEM=y MODEMPIN=y BECEEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y\
		   WEBDAV=y CLOUDSYNC=y USB="USB" GRO=y APP="installed" PROXYSTA=y FTPCLIENT=y SAMBACLIENT=y \
		   DNSMQ=y SHP=y NVRAM_64K=y RTAC56U=y  BCMWL6=y BCMWL6A=y TUNEK="n" BCM5301X=y DISK_MONITOR=y \
		   LANWAN_LED=y OPTIMIZE_XBOX=y ODMPID=y XHCI=y SSH=y JFFS2=y NFS=y OPENVPN=y USER_LOW_RSSI=y DROPBOXCLIENT=y \
		   TIMEMACHINE=y y MDNS=y  VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y XHCIMODE=y ADBLOCK=y \
		   TEMPROOTFS=y DEBUGFS=y SWEBDAVCLIENT=y SNMPD=y TOR=y \
		   TFAT=y HFS="tuxera" NTFS="tuxera" IPSEC=n REPEATER=y DUALWAN=y DNSFILTER=y SAMBA36=y\
		   BUILD_NAME="RT-N18U" ARMCPUSMP=up
