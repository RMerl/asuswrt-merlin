...
export RT-N66U := IPV6SUPP=y HTTPS=y MIPS32=r2 BCM57=y NTFS=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y FANCTRL=y USB="USB" GRO=y APP="installed" BUILD_NAME="RT-N66U" DNSMQ=y LFP=y RTN66U=y NVRAM_64K=y WEBDAV=n CLOUDSYNC=n SSH=y JFFS2=y DUALWAN=y BECEEM=y MODEMPIN=y OPENVPN=n
