# Broadcom platform
export RT-AC66U := IPV6SUPP=y HTTPS=y MIPS32=r2 BCM57=y NTFS=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y WEBDAV=n CLOUDSYNC=n USB="USB" GRO=n APP="installed" BUILD_NAME="RT-AC66U" DNSMQ=y LFP=y NVRAM_64K=y RTAC66U=y BCMWL6=y BCMNAND=y PROXYSTA=y ODMPID=y SSH=y JFFS2=y DUALWAN=y MODEMPIN=y OPENVPN=y BECEEM=y
export RT-N66U := IPV6SUPP=y HTTPS=y MIPS32=r2 BCM57=y NTFS=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y WEBDAV=n CLOUDSYNC=n FANCTRL=y USB="USB" GRO=n APP="installed" BUILD_NAME="RT-N66U" DNSMQ=y LFP=y NVRAM_64K=y RTN66U=y BECEEM=y ODMPID=y SSH=y JFFS2=y DUALWAN=y MODEMPIN=y OPENVPN=y
...
export RT-N16 := IPV6SUPP=y  HTTPS=y MIPS32=r2 NTFS=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y DNSMQ=y PRINTER=y WEBDAV=n CLOUDSYNC=n USB="USB" APP="installed" BUILD_NAME="RT-N16" BECEEM=y JFFS2="y" SSH=y DUALWAN=y MODEMPIN=y
