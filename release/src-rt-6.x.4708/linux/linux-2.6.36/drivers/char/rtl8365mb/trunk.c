 ...
 *
 * $Revision: 42776 $
 * $Date: 2013-09-12 15:53:58 +0800 (週四, 12 九月 2013) $
 *
...
rtk_api_ret_t rtk_trunk_port_set(rtk_trunk_group_t trk_gid, rtk_portmask_t *pTrunk_member_portmask)
{
    ...
    if (trk_gid > RTK_MAX_TRUNK_GROUP_ID)
    ...
    if ((pmsk | RTL8367C_PORT_TRUNK_GROUP_MASK_MASK(trk_gid)) != RTL8367C_PORT_TRUNK_GROUP_MASK_MASK(trk_gid))
