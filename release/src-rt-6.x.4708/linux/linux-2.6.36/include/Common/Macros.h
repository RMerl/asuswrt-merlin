...
/* Link Up to OS */
#define CONNECT_ON_ULSF		1
#define CONNECT_ON_DLSF		2
#define CONNECT_ON_DL_UL	3
...
typedef enum enLinkStatus {
    ...
    SHUTDOWN_REQ_FRM_FW_STANDBY_TIMER=21,
	SHUTDOWN_REQ_FRM_FW_HIBERNATION_BUTTON_PRESS=22,
...
//config file macros
#define CFGFIL_SZ_MIN	(sizeof (STARGETPARAMS))		// typically 144 (as of config file ver 42)
#define CFGFIL_SZ_MAX	127*1024
#define BCM_DBG_SHOW_CFG_MEMBUF 	0
#define BCM_ACP_TYPE_NEW			0
#define BCM_ACP_TYPE_MAX			((sizeof (STARGETPARAMS))/4)
...
#define HANDSHAKE_PATTERN1 0xDEADDEAD
#define HANDSHAKE_PATTERN2 0xDEADDEAD
#define TIME_TO_RESET 10
#define UDMA_RST_HNDSHK_RETRY_CNT	10
#define FW_UDMA_RESET_DONE			0x02

/*NP SHM Signature Macros for WiMax Driver*/
#define SHM_SIGNATURE_MEM_INTR_WIMAX	(SHM_SIGNATURE_INTR_ADDR_START+4)
#define SHM_SIGNATURE_INTERRUPT_OFF      0xAFBF
