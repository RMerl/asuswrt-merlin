/* 
 * p6032/rtc.h: PC-style real-time clock register definitions
 *
...
unsigned int _rtc_get (int);
unsigned int _rtc_set (int, unsigned int);
unsigned int _rtc_bis (int, unsigned int);
unsigned int _rtc_bic (int, unsigned int);

unsigned int _apc_get (int);
unsigned int _apc_set (int, unsigned int);
unsigned int _apc_bis (int, unsigned int);
unsigned int _apc_bic (int, unsigned int);
#endif
